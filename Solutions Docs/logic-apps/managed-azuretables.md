...
| **Playbooks using** | 1 |
| **Solutions** | 1 |
| **Microsoft Learn** | [View Documentation](https://learn.microsoft.com/en-us/connectors/azuretables/) |

## Playbooks Using This Connector

| Playbook | Solution | Connections | Actions |
|:---------|:---------|------------:|--------:|
| [Google Threat Intelligence - IoC Stream](../content/google-threat-intelligence-google-threat-intelligence-ioc-stream-01fc772a.md) | [Google Threat Intelligence](../solutions/google-threat-intelligence.md) | 1 | 3 |

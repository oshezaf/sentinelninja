# `CheckPointMgmtConnector` — Custom
...
|:---------|:---------|------------:|--------:|
| [checkpoint-add-host-to-group](../content/check-point-checkpoint-add-host-to-group-1a66c770.md) | [Check Point](../solutions/check-point.md) | 1 | 8 |

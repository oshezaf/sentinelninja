...
Azure Diagnostics Settings enable native log collection from Azure resources directly to Log Analytics workspaces. This is the recommended method for collecting logs from Azure services like Azure Firewall, Azure Key Vault, Azure SQL, and other Azure PaaS services.

...
| **Source Product** | Awareness Training *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#mimecast-awareness-training) |

...
| **Source Product** | Exchange Message Tracking *(basis: title)* |
| **Event Type** | Events |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#microsoft-exchange-message-tracking-logs) |

...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-core-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_CORE_CL`](../tables/ipinfo-core-cl.md) | ? | ✓ | ? |
...
1. Click the **Deploy to Azure** button below. 
	...
	[![Deploy To Azure](https://aka.ms/deploytoazurebutton)](https://aka.ms/sentinel-IPinfo-Core-azuredeploy)

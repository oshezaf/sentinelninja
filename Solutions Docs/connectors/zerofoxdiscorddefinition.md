...
| **DCR Definition Files** | [ZeroFoxThreatIntelligence_Discord_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Discord/ZeroFoxThreatIntelligence_Discord_DCR.json) |
| **CCF Configuration** | [ZeroFoxThreatIntelligence_Discord_PollerConfig.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Discord/ZeroFoxThreatIntelligence_Discord_PollerConfig.json) |
| **CCF Capabilities** | `JwtToken`, `Paging` |
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#zerofox-enterprise---discord) |

Collects discord data from the [ZeroFox](https://www.zerofox.com/threat-intelligence/) API into Microsoft Sentinel.
...
|:------|:---------------:|:-------------:|:---------:|
| [`ZeroFoxDiscord_CL`](../tables/zerofoxdiscord-cl.md) | ? | ✓ | ? |

...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/Armis.svg" alt="" width="75" height="75">
...
**4. Option 1 - Azure Resource Manager (ARM) Template**
...
> 📄 *Source: [Armis\Data Connectors\ArmisActivities\README.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Armis\Data Connectors\ArmisActivities\README.md)*

# ArmisActivities Integration for Microsoft Sentinel

## Introduction

This folder contains the Azure function time trigger code for ArmisActivities-Microsoft Sentinel connector. The connector will run periodically and ingest the ArmisActivities data into the Microsoft Sentinel logs custom table `Armis_Activities_CL`.
## Folders

1. `ArmisActivities/` - This contains the package, requirements, ARM JSON file, connector page template JSON, and other dependencies.
2. `ArmisActivitySentinelConnector/` - This contains the Azure function source code along with sample data.
...
ii. Click on the ArmisActivities connector, connector page will open.
...
And need to enter below information to configure Armis Activities data connector.
```Function Name
   Workspace ID
   Workspace Key
   Armis Secret Key
...
iii. Click the “import” button at the top and select the json file `Armis_Activity_API_FunctionApp.json` downloaded on your local machine from Github.
...
ii. Go to Functions -> ArmisActivitySentinelConnector -> Monitor

...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/AristaAwakeSecurity.svg" alt="" width="75" height="75">
...
|-------|:-------------|:--------------|:---------------:|:-------------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | Arista Networks | Awake Security | ✓ | ✓ |

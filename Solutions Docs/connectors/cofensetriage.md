# ⚠️ Cofense Triage Threat Indicators Ingestion

> ⚠️ **Unpublished:** This item is from a solution that is not yet published on Azure Marketplace or not installed in Content Hub.

<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/CofenseTriage.svg" alt="" width="75" height="75">
...
| **Source Product** | Triage *(basis: title)* |
| **Event Type** | IOCs |
...
| [`ThreatIntelligenceIndicator`](../tables/threatintelligenceindicator.md) | `SourceSystem !startswith "Cofense :"`<br>`SourceSystem startswith "Cofense :"` | ✓ | ✓ | ✗ |
...
> 📄 *Source: [CofenseTriage\Data Connectors\CofenseTriageDataConnector\README.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CofenseTriage\Data Connectors\CofenseTriageDataConnector\README.md)*

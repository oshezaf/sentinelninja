...
| **DCR Definition Files** | [ZeroFoxThreatIntelligence_Disruption_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Disruption/ZeroFoxThreatIntelligence_Disruption_DCR.json) |
| **CCF Configuration** | [ZeroFoxThreatIntelligence_Disruption_PollerConfig.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Disruption/ZeroFoxThreatIntelligence_Disruption_PollerConfig.json) |
| **CCF Capabilities** | `JwtToken`, `Paging` |
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#zerofox-enterprise---disruption) |

Collects disruption data from the [ZeroFox](https://www.zerofox.com/threat-intelligence/) API into Microsoft Sentinel.
...
|:------|:---------------:|:-------------:|:---------:|
| [`ZeroFoxDisruption_CL`](../tables/zerofoxdisruption-cl.md) | ? | ✓ | ? |

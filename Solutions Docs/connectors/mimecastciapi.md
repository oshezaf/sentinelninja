...
| **Source Product** | Cloud Integrated *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#mimecast-cloud-integrated) |

...
| **Source Product** | Cloud Platform Resource Manager *(basis: title)* |
...
To access the terraform script for Log Setup [Click here](https://github.com/v-gudivya/GCP-RM/tree/main/GCP-RM).

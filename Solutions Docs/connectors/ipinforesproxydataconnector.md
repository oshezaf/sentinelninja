...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-resproxy-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_RESIDENTIAL_PROXY_CL`](../tables/ipinfo-residential-proxy-cl.md) | ✗ | ✓ | ✗ |
...
1. Click the **Deploy to Azure** button below. 
	...
	[![Deploy To Azure](https://aka.ms/deploytoazurebutton)](https://aka.ms/sentinel-IPinfo-ResProxy-azuredeploy)

...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `ESI-Opt7ExchangeHTTPProxyLogs` |
| **Publisher / Vendor** | Microsoft |
| **Source Product** | Exchange HTTP Proxy *(basis: title)* |
| **Event Type** | Events |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#microsoft-exchange-http-proxy-logs) |

...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `FortinetFortiWebAma` |
| **Publisher** | Microsoft |
| **Source Vendor** | Fortinet *(basis: description_url)* |
| **Source Product** | FortiWeb Web Application Firewall *(basis: title)* |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `Computer contains "Fortiweb"`<br>`DeviceProduct contains "Fortiweb"`<br>`DeviceProduct has "Fortiweb"`<br>`DeviceVendor == "Fortinet"`<br>`DeviceVendor contains "Fortinet"` | ✓ | ✓ | ✓ |

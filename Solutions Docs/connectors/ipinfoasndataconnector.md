...
| **Source Product** | ASN *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-asn-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_ASN_CL`](../tables/ipinfo-asn-cl.md) | ✗ | ✓ | ✗ |

...
| **DCR Definition Files** | [ZeroFoxThreatIntelligence_PhysicalThreats_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Physical%20Threats/ZeroFoxThreatIntelligence_PhysicalThreats_DCR.json) |
| **CCF Configuration** | [ZeroFoxThreatIntelligence_PhysicalThreats_PollerConfig.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Physical%20Threats/ZeroFoxThreatIntelligence_PhysicalThreats_PollerConfig.json) |
| **CCF Capabilities** | `JwtToken`, `Paging` |
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#zerofox-enterprise---physical-threats) |

Collects physical threats data from the [ZeroFox](https://www.zerofox.com/threat-intelligence/) API into Microsoft Sentinel.
...
|:------|:---------------:|:-------------:|:---------:|
| [`ZeroFoxPhysicalThreats_CL`](../tables/zerofoxphysicalthreats-cl.md) | ? | ✓ | ? |

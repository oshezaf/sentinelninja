...
| **DCR Definition Files** | [GCPComputeEngineLog_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Google%20Cloud%20Platform%20Compute%20Engine/Data%20Connectors/GCPComputeEngineLog_CCP/GCPComputeEngineLog_DCR.json) |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#google-cloud-platform-compute-engine-via-codeless-connector-framework) |
...
> 📄 *Source: [Google Cloud Platform Compute Engine\Data Connectors\GCPComputeEngineReadme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Google Cloud Platform Compute Engine\Data Connectors\GCPComputeEngineReadme.md)*

# Integrating Google Cloud Platform Compute Engine into Microsoft Sentinel
## Table of contents
- [Introduction](#intro)
- [Prerequisites](#step2)
...
To access the terraform script for Log Setup [Click here](https://github.com/Azure/Azure-Sentinel/blob/master/DataConnectors/GCP/Terraform/sentinel_resources_creation/GCPComputeEngineLogsSetup/GCPComputeEngineLogSetup.tf).

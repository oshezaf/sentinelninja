...
| **Source Product** | Azure Batch Account *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#azure-batch-account) |

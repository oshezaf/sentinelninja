...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `ForcepointNgfw` |
| **Publisher / Vendor** | Forcepoint |
| **Source Product** | NGFW *(basis: event)* |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `Activity contains "compromise"`<br>`DeviceAction == "Terminate"`<br>`DeviceProduct == "NGFW"`<br>`DeviceVendor == "Forcepoint"` | ✓ | ✓ | ✓ |

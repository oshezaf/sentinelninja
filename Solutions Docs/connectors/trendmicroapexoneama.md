...
| **Source Product** | Apex Central *(basis: event)* |
...
🛠️ **Device Configuration:** [Follow these steps](https://docs.trendmicro.com/en-us/enterprise/trend-micro-apex-central-2019-online-help/detections/logs_001/syslog-forwarding.aspx) to configure Apex Central. On step 6, select log format CEF.

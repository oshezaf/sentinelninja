...
| **Source Product** | WHOIS MNT *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-whois-mnt-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_WHOIS_MNT_CL`](../tables/ipinfo-whois-mnt-cl.md) | ✗ | ✓ | ✗ |

...
|:-----|:------------|:------------|
| [Close Cohesity Helios Incident](../content/close-cohesity-helios-incident-cohesitysecurity.md) | This playbook closes the corresponding Cohesity DataHawk (Helios) ticket. | - |
| [Cohesity Create or Update ServiceNow incident](../content/cohesity-create-or-update-servicenow-incident-cohesitysecurity.md) | This playbook creates and updates the incident in the ServiceNow platform. | - |
| [Cohesity Incident Email](../content/cohesity-incident-email-cohesitysecurity.md) | This playbook sends an email to the recipient with the details related to the incidents. | - |
| [Delete Cohesity incident blobs](../content/delete-cohesity-incident-blobs-cohesitysecurity.md) | This playbook deletes the blobs on Azure storage created by an incident that is generated by Cohesit... | - |
| [Restore From Last Cohesity Snapshot](../content/restore-from-last-cohesity-snapshot-cohesitysecurity.md) | This playbook restores the latest good Data Hawk (Helios) snapshot. | - |

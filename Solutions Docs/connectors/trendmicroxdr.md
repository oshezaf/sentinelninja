...
| **Source Product** | Vision One *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#trend-vision-one-using-azure-functions) |

# 🔗 Akamai Security Events via AMA Integration
...
[Akamai](https://www.akamai.com/us/en/products/security/) is a cloud security platform that provides DDoS protection, web application firewall, bot management, and API security for web applications and APIs.

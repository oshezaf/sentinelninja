...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/KnowBe4-logo.svg" alt="" width="75" height="75">
...
**Custom Permissions:**
- **KnowBe4 API Token**: A KnowBe4 API token is required to ingest audit records to Microsoft Sentinel.

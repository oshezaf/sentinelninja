# 🚫 [DEPRECATED] Atlassian Jira Audit (using Azure Function)
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#atlassian-jira-audit-using-azure-functions) |

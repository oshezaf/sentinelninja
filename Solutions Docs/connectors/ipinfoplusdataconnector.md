...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-plus-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_PLUS_CL`](../tables/ipinfo-plus-cl.md) | ✗ | ✓ | ✗ |
...
1. Click the **Deploy to Azure** button below. 
	...
	[![Deploy To Azure](https://aka.ms/deploytoazurebutton)](https://aka.ms/sentinel-IPinfo-Plus-azuredeploy)

...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/rubrikLogo.svg" alt="" width="75" height="75">
...
| **Source Product** | Security Cloud Protection Status *(basis: title)* |
...
|:------|:---------------:|:-------------:|:---------:|
| [`RubrikProtectionStatus_CL`](../tables/rubrikprotectionstatus-cl.md) | ? | ✓ | ? |
...
> 📄 *Source: [RubrikSecurityCloud\Data Connectors\RubrikSecurityCloud_CCF\README.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/RubrikSecurityCloud\Data Connectors\RubrikSecurityCloud_CCF\README.md)*

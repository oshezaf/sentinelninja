...
| **Source Product** | Tenant-based Microsoft Defender for Cloud |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#tenant-based-microsoft-defender-for-cloud) |

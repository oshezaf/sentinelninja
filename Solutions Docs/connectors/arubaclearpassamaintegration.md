# 🔗 Aruba ClearPass via AMA Integration
...
[Aruba ClearPass](https://www.arubanetworks.com/products/security/network-access-control/secure-access/) is a network access control (NAC) solution that provides role-based and device-based secure access to enterprise networks.

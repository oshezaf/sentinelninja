...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/SecurityScorecard-Cybersecurity-Ratings.svg" alt="" width="75" height="75">
...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `SecurityScorecardIssueAzureFunctions` |
| **Publisher / Vendor** | SecurityScorecard |
| **Source Product** | Issue *(basis: title)* |
...
Use this method for automated deployment of the SecurityScorecard Issue connector.
...
Use the following step-by-step instructions to deploy the SecurityScorecard Issue data connector manually with Azure Functions (Deployment via Visual Studio Code).

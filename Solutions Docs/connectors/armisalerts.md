...
>**NOTE:** This data connector depends on a parser based on a Kusto Function to work as expected. [Follow these steps](https://aka.ms/sentinel-ArmisAlertsAPI-parser) to create the Kusto functions alias, **ArmisAlerts**
...
> 📄 *Source: [Armis\Data Connectors\ArmisAlerts\README.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Armis\Data Connectors\ArmisAlerts\README.md)*

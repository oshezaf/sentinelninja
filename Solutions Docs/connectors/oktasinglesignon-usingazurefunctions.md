...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `OktaSingleSignOn(usingAzureFunctions)` |
| **Publisher** | Okta |
...
| **DCR Definition Files** | [OktaSSOv2_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Okta%20Single%20Sign-On/Data%20Connectors/OktaNativePollerConnectorV2/OktaSSOv2_DCR.json) |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#okta-single-sign-on-using-azure-functions) |

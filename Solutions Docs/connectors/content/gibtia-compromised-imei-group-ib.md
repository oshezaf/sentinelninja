...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_Compromised_imei.json) |

## Tables Used

| Table | Usage |
|:------|:------|
| [`GIBTIACompromisedIMEI_CL`](../tables/gibtiacompromisedimei-cl.md) | write |

...
| **Source Product** | Elements *(basis: title)* |
...
> 2. You must have elevated permissions (sudo) on your machine.
  ...
  - **For python3 use command below:**: `sudo wget -O cef_installer.py https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/DataConnectors/CEF/cef_installer.py&&sudo python3 cef_installer.py {0} {1}`
...
- **For python3 use command below:**: `sudo wget -O cef_troubleshoot.py https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/DataConnectors/CEF/cef_troubleshoot.py&&sudo python3 cef_troubleshoot.py {0}`
...
> 📄 *Source: [WithSecureElementsViaConnector\Data Connectors\WithSecureElementsViaConnnector.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/WithSecureElementsViaConnector\Data Connectors\WithSecureElementsViaConnnector.md)*

...
| **Source Product** | Threat Intelligence Upload API *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#threat-intelligence-upload-api-preview) |

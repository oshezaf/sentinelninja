...
| **Source Product** | Active-Directory Domain Controllers Security *(basis: title)* |
| **Event Type** | Events |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#microsoft-active-directory-domain-controllers-security-event-logs) |

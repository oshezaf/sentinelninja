# 🚫 ⚠️ 🔍 [Deprecated] CrowdStrike Falcon Endpoint Protection via Legacy Agent
...
| **Source Product** | Falcon Endpoint Protection *(basis: title)* |
...
🛠️ **Device Configuration:** [Follow these instructions](https://www.crowdstrike.com/blog/tech-center/integrate-with-your-siem/) to deploy the SIEM Collector and forward syslog.

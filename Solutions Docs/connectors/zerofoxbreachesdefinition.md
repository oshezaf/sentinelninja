...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#zerofox-enterprise---breaches) |

Collects breaches data from the [ZeroFox](https://www.zerofox.com/threat-intelligence/) API into Microsoft Sentinel.
...
|:------|:---------------:|:-------------:|:---------:|
| [`ZeroFoxBreaches_CL`](../tables/zerofoxbreaches-cl.md) | ? | ✓ | ? |

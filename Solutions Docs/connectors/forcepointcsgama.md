# 🚫 🔍 [Deprecated] Forcepoint CSG via AMA
...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `ForcepointCSGAma` |
| **Publisher / Vendor** | Forcepoint |
| **Source Product** | Email, Web *(basis: event)* |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `Activity == "Blocked"`<br>`DeviceProduct in "Email,Web"`<br>`DeviceVendor == "Forcepoint CSG"`<br>`LogSeverity == "6"`<br>`SourceUserID != "Not available"` | ✓ | ✓ | ✓ |

...
| Attribute | Value |
|:----------|:------|
| **Connector ID** | `ZeroFoxIndicatorsDefinition` |
...
| **DCR Definition Files** | [ZeroFoxThreatIntelligence_Indicators_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Indicators/ZeroFoxThreatIntelligence_Indicators_DCR.json) |
| **CCF Configuration** | [ZeroFoxThreatIntelligence_Indicators_PollerConfig.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroFox%20Threat%20Intelligence/Data%20Connectors/Indicators/ZeroFoxThreatIntelligence_Indicators_PollerConfig.json) |
| **CCF Capabilities** | `JwtToken`, `Paging` |
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#zerofox-enterprise---indicators) |

Collects indicators data from the [ZeroFox](https://www.zerofox.com/threat-intelligence/) API into Microsoft Sentinel.
...
|:------|:---------------:|:-------------:|:---------:|
| [`ZeroFoxIndicators_CL`](../tables/zerofoxindicators-cl.md) | ? | ✓ | ? |

...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#windows-firewall-events-via-ama) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`ASimNetworkSessionLogs`](../tables/asimnetworksessionlogs.md) | `EventProduct == "Windows Firewall"` | ✓ | ✓ | ✓ |

...
| **Source Product** | Premium Microsoft Defender Threat Intelligence *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#premium-microsoft-defender-threat-intelligence) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`ThreatIntelligenceIndicator`](../tables/threatintelligenceindicator.md) | `SourceSystem == "Premium Microsoft Defender Threat Intelligence"` | ✓ | ✓ | ✗ |

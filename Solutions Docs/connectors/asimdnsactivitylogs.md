...
<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Logos/DNS.svg" alt="" width="75" height="75">
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`ASimDnsActivityLogs`](../tables/asimdnsactivitylogs.md) | `EventProduct == "DNS Server"`<br>`EventResult == "Failure"`<br>`EventResultDetails == "NXDOMAIN"`<br>`EventType == "Query"`<br>`EventVendor == "Microsoft"` | ✓ | ✓ | ? |

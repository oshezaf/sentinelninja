...
| **Source Product** | Cloud Infrastructure *(basis: title)* |
...
| **DCR Definition Files** | [OCI_DataConnector_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Oracle%20Cloud%20Infrastructure/Data%20Connectors/Oracle_Cloud_Infrastructure_CCP/OCI_DataConnector_DCR.json) |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#oracle-cloud-infrastructure-via-codeless-connector-framework) |
...
- **Partition Id / Group name** (required): Individual Cursor - Partition Id (E.g. 0 or 1 or 2), Group Cursor - Group name
...
- **Pem File Pass Phrase (Optional)** (optional): Just Leave blank If not encrypted)

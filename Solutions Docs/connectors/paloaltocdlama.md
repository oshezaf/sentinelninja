# 🚫 🔍 [Deprecated] Palo Alto Networks Cortex Data Lake (CDL) via AMA

> 🚫 **Deprecated:** This connector has been deprecated and may be removed in future versions.

> 🔍 **Discovered:** This item was discovered by scanning the solution folder but is not listed in the Solution JSON file.

<img src="https://raw.githubusercontent.com/Azure/Azure-Sentinel/master/Solutions/PaloAltoCDL/logo/Palo-alto-logo.png" alt="" width="75" height="75">
...
|-------|:-------------|:--------------|:---------------:|:-------------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | Palo Alto Networks | LF | ✓ | ✓ |

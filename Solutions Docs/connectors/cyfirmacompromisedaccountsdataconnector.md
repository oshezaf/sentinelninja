...
| **Source Product** | Compromised Accounts *(basis: title)* |
...
| **DCR Definition Files** | [CyfirmaCompAcc_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Cyfirma%20Compromised%20Accounts/Data%20Connectors/CyfirmaCompromisedAccounts_ccp/CyfirmaCompAcc_DCR.json) |
| **CCF Configuration** | [CyfirmaCompAcc_PollerConfig.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Cyfirma%20Compromised%20Accounts/Data%20Connectors/CyfirmaCompromisedAccounts_ccp/CyfirmaCompAcc_PollerConfig.json) |
| **CCF Capabilities** | `APIKey` |
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#cyfirma-compromised-accounts) |

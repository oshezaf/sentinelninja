...
| **DCR Definition Files** | [Halcyon_DCR.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Halcyon/Data%20Connectors/Halcyon_ccp/Halcyon_DCR.json) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Halcyon Events`](../tables/halcyon-events.md) | ? | ? | ? |

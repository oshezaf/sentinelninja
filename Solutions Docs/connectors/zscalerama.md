...
🛠️ **Device Configuration:** Set Zscaler product to send syslog messages in CEF format to port 514 TCP. See [Zscaler Microsoft Sentinel integration guide](https://aka.ms/ZscalerCEFInstructions).

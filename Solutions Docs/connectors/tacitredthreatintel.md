...
| **Publisher / Vendor** | TacitRed |
| **Source Product** | Compromised Credentials *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#tacitred-compromised-credentials) |

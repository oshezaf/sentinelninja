...
| **Source Product** | Privacy Extended *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#ipinfo-privacy-extended-data-connector) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Ipinfo_Privacy_extended_CL`](../tables/ipinfo-privacy-extended-cl.md) | ✗ | ✓ | ✗ |

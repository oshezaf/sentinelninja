...
| **Source Product** | Enterprise Browser Admin *(basis: title)* |
| **Event Type** | Events |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#island-enterprise-browser-admin-events-legacy) |

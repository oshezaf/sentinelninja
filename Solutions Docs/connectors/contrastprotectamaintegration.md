# 🔗 Contrast Protect via AMA Integration
...
[Contrast Protect](https://www.contrastsecurity.com/runtime-application-self-protection-rasp) is a runtime application self-protection (RASP) solution that detects and blocks attacks against web applications in production using embedded instrumentation.

...
| **Source Product** | Director Proxy *(basis: title)* |
...
| **Microsoft Learn** | [View on Learn](https://learn.microsoft.com/azure/sentinel/data-connectors-reference#virtualmetric-director-proxy) |

# 🔗 SonicWall Firewall via AMA Integration
...
[SonicWall](https://www.sonicwall.com/) is a network security platform that provides next-generation firewalls, threat prevention, VPN, and secure access solutions for protecting enterprise networks.

...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimRegistryEventMicrosoft365D` |
| **Built-in Parser** | `_Im_RegistryEvent_Microsoft365D` |
...
| **Source File** | [Parsers\ASimRegistryEvent\Parsers\vimRegistryEventMicrosoft365D.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimRegistryEvent/Parsers/vimRegistryEventMicrosoft365D.yaml) |

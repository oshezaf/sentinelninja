# <img src="../images/asim-badge.png" alt="ASIM" height="32"> User Management activity ASIM filtering parser for Microsoft Sentinel native User Management activity table

## Parser Information

| Property | Value |
|:---------|:------|
| **Parser Name** | `vimUserManagementNative` |
| **Built-in Parser** | `_Im_UserManagement_Native` |
...
| **Source File** | [Parsers\ASimUserManagement\Parsers\vimUserManagementNative.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimUserManagement/Parsers/vimUserManagementNative.yaml) |

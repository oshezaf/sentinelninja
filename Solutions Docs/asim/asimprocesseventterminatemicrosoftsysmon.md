# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Process Terminate Event ASIM parser for Microsoft Windows Security Events

...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimAuthenticationOktaSSO` |
| **Built-in Parser** | `_Im_Authentication_OktaSSO` |
...
| **Source File** | [Parsers\ASimAuthentication\Parsers\vimAuthenticationOktaOSS.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuthentication/Parsers/vimAuthenticationOktaOSS.yaml) |

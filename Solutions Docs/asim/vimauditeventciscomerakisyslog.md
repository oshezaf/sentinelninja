...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimAuditEventCiscoMerakiSyslog` |
| **Built-in Parser** | `_Im_AuditEvent_CiscoMerakiSyslog` |
| **Schema** | AuditEvent |
| **Schema Version** | 0.1 |
...
| **Source File** | [Parsers\ASimAuditEvent\Parsers\vimAuditEventCiscoMerakiSyslog.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuditEvent/Parsers/vimAuditEventCiscoMerakiSyslog.yaml) |

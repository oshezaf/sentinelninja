...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimProcessEventCreateMicrosoftSysmon` |
| **Built-in Parser** | `_Im_ProcessEvent_CreateMicrosoftSysmon` |
| **Schema** | ProcessEvent |
...
| **Source File** | [Parsers\ASimProcessEvent\Parsers\vimProcessCreateMicrosoftSysmon.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimProcessEvent/Parsers/vimProcessCreateMicrosoftSysmon.yaml) |

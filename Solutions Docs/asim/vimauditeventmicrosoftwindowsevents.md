...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimAuditEventMicrosoftWindowsEvents` |
| **Built-in Parser** | `_Im_AuditEvent_MicrosoftWindowsEvents` |
| **Schema** | AuditEvent |
| **Schema Version** | 0.1 |
...
| **Source File** | [Parsers\ASimAuditEvent\Parsers\vimAuditEventMicrosoftWindowsEvents.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuditEvent/Parsers/vimAuditEventMicrosoftWindowsEvents.yaml) |

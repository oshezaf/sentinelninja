...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimRegistryEventMicrosoftWindowsEvent` |
| **Built-in Parser** | `_Im_RegistryEvent_MicrosoftWindowsEvent` |
...
| **Source File** | [Parsers\ASimRegistryEvent\Parsers\vimRegistryEventMicrosoftWindowsEvent.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimRegistryEvent/Parsers/vimRegistryEventMicrosoftWindowsEvent.yaml) |

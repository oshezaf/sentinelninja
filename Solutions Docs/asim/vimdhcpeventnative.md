# <img src="../images/asim-badge.png" alt="ASIM" height="32"> Dhcp Event ASIM filtering parser for Microsoft Sentinel native Dhcp Event table

## Parser Information

| Property | Value |
|:---------|:------|
| **Parser Name** | `vimDhcpEventNative` |
| **Built-in Parser** | `_Im_DhcpEvent_Native` |
| **Schema** | DhcpEvent |
| **Schema Version** | 0.1 |
...
| **Source File** | [Parsers\ASimDhcpEvent\Parsers\vimDhcpEventNative.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimDhcpEvent/Parsers/vimDhcpEventNative.yaml) |

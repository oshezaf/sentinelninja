# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Network Session ASIM  parser for Microsoft Windows Firewall Events
...
| Property | Value |
|:---------|:------|
| **Parser Name** | `ASimNetworkSessionMicrosoftWindowsEventFirewall` |
| **Built-in Parser** | `_ASim_NetworkSession_MicrosoftWindowsEventFirewall` |

...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimFileEventMicrosoftSecurityEvents` |
| **Built-in Parser** | `_Im_FileEvent_MicrosoftSecurityEvents` |
| **Schema** | FileEvent |
...
| **Source File** | [Parsers\ASimFileEvent\Parsers\vimFileEventMicrosoftSecurityEvents.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimFileEvent/Parsers/vimFileEventMicrosoftSecurityEvents.yaml) |

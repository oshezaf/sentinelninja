...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimAuthenticationCiscoMerakiSyslog` |
| **Built-in Parser** | `_Im_Authentication_CiscoMerakiSyslog` |
...
| **Source File** | [Parsers\ASimAuthentication\Parsers\vimAuthenticationCiscoMerakiSyslog.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuthentication/Parsers/vimAuthenticationCiscoMerakiSyslog.yaml) |

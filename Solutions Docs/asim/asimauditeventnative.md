# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Audit Event ASIM parser for Microsoft Sentinel native Audit Event table

...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimNetworkSessionBarracudaCEF` |
| **Built-in Parser** | `_Im_NetworkSession_BarracudaCEF` |
...
| **Source File** | [Parsers\ASimNetworkSession\Parsers\vimNetworkSessionBarracudaCEF.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimNetworkSession/Parsers/vimNetworkSessionBarracudaCEF.yaml) |

# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Registry Event ASIM parser for Microsoft Windows Events (registry creation event)

# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> User Management activity ASIM parser for Microsoft Sentinel native User Management activity table

# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> ASIM Authentication parser for VMware Carbon Black Cloud
...
| **Parser Version** | 0.1.0 ([version history](https://github.com/Azure/Azure-Sentinel/tree/master/Parsers/ASimAuthentication/CHANGELOG/ASimAuthenticationVMwareCarbonBlackCloud.md)) |
...
| Connector | Solution |
|:----------|:---------|
| [VMwareCarbonBlack](../connectors/vmwarecarbonblack.md) | [VMware Carbon Black Cloud (legacy connector)](../solutions/vmware-carbon-black-cloud.md) |

**Solutions:** [VMware Carbon Black Cloud (legacy connector)](../solutions/vmware-carbon-black-cloud.md)

# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Process Event ASIM parser
...
| Property | Value |
|:---------|:------|
| **Parser Name** | `ASimProcessEvent` (parameter-less) · `imProcessEvent` (filtering) |
| **Built-in Parser** | `_ASim_ProcessEvent` (parameter-less) · `_Im_ProcessEvent` (filtering) |
| **Schema** | ProcessEvent |
...
|:--------|:--------------|:----------|
| SentinelOne | [_ASim_ProcessCreate_SentinelOne](asimprocesscreatesentinelone.md) | [SentinelOne (legacy connector)](../solutions/sentinelone.md) |
...
| VMware Carbon Black Cloud | [_ASim_ProcessEvent_CreateVMwareCarbonBlackCloud](asimprocesscreatevmwarecarbonblackcloud.md) | [VMware Carbon Black Cloud (legacy connector)](../solutions/vmware-carbon-black-cloud.md) |
...
| Native | [_ASim_ProcessEvent_Native](asimprocesseventnative.md) | [SynqlyIntegrationConnector](../solutions/synqlyintegrationconnector.md) |
...
| VMware Carbon Black Cloud | [_ASim_ProcessEvent_TerminateVMwareCarbonBlackCloud](asimprocessterminatevmwarecarbonblackcloud.md) | [VMware Carbon Black Cloud (legacy connector)](../solutions/vmware-carbon-black-cloud.md) |

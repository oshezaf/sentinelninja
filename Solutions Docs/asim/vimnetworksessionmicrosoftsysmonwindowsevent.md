...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimNetworkSessionMicrosoftSysmonWindowsEvent` |
| **Built-in Parser** | `_Im_NetworkSession_MicrosoftSysmonWindowsEvent` |
...
| **Source File** | [Parsers\ASimNetworkSession\Parsers\vimNetworkSessionMicrosoftSysmonWindowsEvent.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimNetworkSession/Parsers/vimNetworkSessionMicrosoftSysmonWindowsEvent.yaml) |

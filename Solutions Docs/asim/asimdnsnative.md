# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> DNS activity ASIM parser for Microsoft Sentinel native DNS table
...
| **Product** | Native |
| **Parser Version** | 0.8.0 ([version history](https://github.com/Azure/Azure-Sentinel/tree/master/Parsers/ASimDns/CHANGELOG/ASimDnsNative.md)) |

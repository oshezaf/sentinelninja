# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Dhcp Event ASIM parser for Microsoft Sentinel native Dhcp Event table

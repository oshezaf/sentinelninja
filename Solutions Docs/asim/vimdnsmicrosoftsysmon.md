...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimDnsMicrosoftSysmon` |
| **Built-in Parser** | `_Im_Dns_MicrosoftSysmon` |
| **Schema** | Dns |
...
| **Source File** | [Parsers\ASimDns\Parsers\vimDnsMicrosoftSysmon.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimDns/Parsers/vimDnsMicrosoftSysmon.yaml) |

...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimProcessCreateMicrosoftSecurityEvents` |
| **Built-in Parser** | `_Im_ProcessCreate_MicrosoftSecurityEvents` |
| **Schema** | ProcessEvent |
...
| **Source File** | [Parsers\ASimProcessEvent\Parsers\vimProcessCreateMicrosoftSecurityEvents.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimProcessEvent/Parsers/vimProcessCreateMicrosoftSecurityEvents.yaml) |

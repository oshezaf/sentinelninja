# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> DNS activity ASIM parser for Microsoft DNS logs collected using NXlog

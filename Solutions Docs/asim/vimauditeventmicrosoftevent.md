...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimAuditEventMicrosoftEvent` |
| **Built-in Parser** | `_Im_AuditEvent_MicrosoftEvent` |
| **Schema** | AuditEvent |
| **Schema Version** | 0.1 |
...
| **Source File** | [Parsers\ASimAuditEvent\Parsers\vimAuditEventMicrosoftEvent.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuditEvent/Parsers/vimAuditEventMicrosoftEvent.yaml) |

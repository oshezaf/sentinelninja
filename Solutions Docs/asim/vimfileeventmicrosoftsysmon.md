...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimFileEventMicrosoftSysmon` |
| **Built-in Parser** | `_Im_FileEvent_MicrosoftSysmon` |
| **Schema** | FileEvent |
...
| **Source File** | [Parsers\ASimFileEvent\Parsers\vimFileEventMicrosoftSysmon.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimFileEvent/Parsers/vimFileEventMicrosoftSysmon.yaml) |

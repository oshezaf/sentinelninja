...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimNetworkSessionCiscoMerakiSyslog` |
| **Built-in Parser** | `_Im_NetworkSession_CiscoMerakiSyslog` |
...
| **Source File** | [Parsers\ASimNetworkSession\Parsers\vimNetworkSessionCiscoMerakiSyslog.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimNetworkSession/Parsers/vimNetworkSessionCiscoMerakiSyslog.yaml) |

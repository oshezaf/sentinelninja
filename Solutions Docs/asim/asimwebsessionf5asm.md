# <img src="../images/asim-badge.png" alt="ASIM" style="height:32px;width:auto;vertical-align:middle"> Web Session ASIM parser for F5 BIG-IP Application Security Manager (ASM)
...
**Solutions:** [Common Event Format](../solutions/common-event-format.md), [F5 Networks (legacy connector)](../solutions/f5-networks.md), [VirtualMetric DataStream](../solutions/virtualmetric-datastream.md)

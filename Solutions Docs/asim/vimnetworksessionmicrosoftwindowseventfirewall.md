...
| Property | Value |
|:---------|:------|
| **Parser Name** | `vimNetworkSessionMicrosoftWindowsEventFirewall` |
| **Built-in Parser** | `_Im_NetworkSession_MicrosoftWindowsEventFirewall` |
...
| **Source File** | [Parsers\ASimNetworkSession\Parsers\vimNetworkSessionMicrosoftWindowsEventFirewall.yaml](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimNetworkSession/Parsers/vimNetworkSessionMicrosoftWindowsEventFirewall.yaml) |

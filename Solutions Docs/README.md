...
|:---------|------:|:--------|
| [Solutions](solutions-index.md) | 486 | 388 with connectors, 385 with content |
| [Connectors](connectors-index.md) | 530 | Data ingestion methods |
| [Tables](tables-index.md) | 1892 | Log Analytics tables |

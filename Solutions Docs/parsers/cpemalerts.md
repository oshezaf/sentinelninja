...
| Attribute | Value |
|:----------|:------|
| Title | Check Point Exposure Management Alerts with Metadata |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Check%20Point%20Cyberint%20Alerts/Parsers/CPEMAlerts.yaml) |

...
| Attribute | Value |
|:----------|:------|
| Title | Cyjax Threat Indicator |
| Location | Solution |
| Solution | [Cyjax](../solutions/cyjax.md) ⚠️ |
| Version | 1.0.0 |
| Last Updated | 2026-02-28 |
| Category | Microsoft Sentinel Custom Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Cyjax/Parsers/CyjaxThreatIndicator.yaml) |

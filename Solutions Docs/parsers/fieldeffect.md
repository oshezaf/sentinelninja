...
| Attribute | Value |
|:----------|:------|
| Title | Parser for Field Effect MDR AROs |
| Location | Solution |
| Solution | [FieldEffectMDR](../solutions/fieldeffectmdr.md) ⚠️ |
| Version | 1.0.0 |
| Last Updated | 2026-02-15 |
| Category | Microsoft Sentinel Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/FieldEffectMDR/Parsers/FieldEffect.yaml) |

...
| Attribute | Value |
|:----------|:------|
| Title | Parser for CBS DomainInfringement |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Parsers/CBS_DomainInfringement_Parser.yaml) |
...
| [`CBS_DomainInfringement_CL`](../tables/cbs-domaininfringement-cl.md) | ? | ? | ? |

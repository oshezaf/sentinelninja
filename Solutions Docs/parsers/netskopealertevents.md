...
| Attribute | Value |
|:----------|:------|
| Title | Parser for NetskopeAlertEvents |
| Location | Solution |
| Solution | [NetskopeAlertEvents](../solutions/netskopealertevents.md) ⚠️ |
| Version | 1.0.0 |
| Last Updated | 2026-06-25 |
| Category | Microsoft Sentinel Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/NetskopeAlertEvents/Parsers/NetskopeAlertEvents.yaml) |

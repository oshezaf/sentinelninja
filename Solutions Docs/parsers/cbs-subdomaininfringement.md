...
| Attribute | Value |
|:----------|:------|
| Title | Parser for CBS SubdomainInfringement |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Parsers/CBS_SubdomainInfringement_Parser.yaml) |
...
| [`CBS_SubdomainInfringement_CL`](../tables/cbs-subdomaininfringement-cl.md) | ? | ? | ? |

...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Dragos/Parsers/DragosPushNotificationsToSentinel.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `DeviceProduct == "Platform"`<br>`DeviceVendor == "Dragos"` | ✓ | ✓ |

...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Parsers/CBS_BreachedCredentials_Parser.yaml) |
...
| [`CBS_BreachedCredentials_CL`](../tables/cbs-breachedcredentials-cl.md) | ? | ? | ? |

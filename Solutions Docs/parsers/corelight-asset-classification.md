...
| Attribute | Value |
|:----------|:------|
| Title | Corelight Asset Classification Events |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Corelight/Parsers/corelight_asset_classification.yaml) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`Corelight_v2_asset_classification_CL`](../tables/corelight-v2-asset-classification-cl.md) 🔶 | ? | ✓ | ? |

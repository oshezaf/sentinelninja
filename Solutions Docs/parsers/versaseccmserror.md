...
Structured view of Versasec CMS error events
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/VersasecCMS/Parsers/VersasecCmsError.yaml) |

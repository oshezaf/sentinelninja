...
| Attribute | Value |
|:----------|:------|
| Title | Parser for AWSALBAccessLogs |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AWS%20ELB/Parsers/AWSALBAccessLogsData.yaml) |

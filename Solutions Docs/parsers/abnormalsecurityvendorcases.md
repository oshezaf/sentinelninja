...
| Attribute | Value |
|:----------|:------|
| Title | Parser for Abnormal Security Vendor Cases |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AbnormalSecurity/Parsers/AbnormalSecurityVendorCases.yaml) |

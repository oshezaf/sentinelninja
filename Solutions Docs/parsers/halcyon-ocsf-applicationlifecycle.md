# Halcyon_OCSF_ApplicationLifecycle
...
| Attribute | Value |
|:----------|:------|
| Title | Parser for Halcyon Application Lifecycle events |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Halcyon/Parsers/Halcyon_OCSF_ApplicationLifecycle.yaml) |

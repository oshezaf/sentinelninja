...
| Attribute | Value |
|:----------|:------|
| Title | Parser for Halcyon Kernel Activity events |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Halcyon/Parsers/Halcyon_OCSF_KernelActivity.yaml) |

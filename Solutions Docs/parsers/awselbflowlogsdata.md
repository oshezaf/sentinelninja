...
| Attribute | Value |
|:----------|:------|
| Title | Parser for AWSELBFlowLogs |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AWS%20ELB/Parsers/AWSELBFlowLogsData.yaml) |

...
| Attribute | Value |
|:----------|:------|
| Title | Parser for BitSightVulnerabilitiesFindingsSummary |
| Location | Solution |
...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/BitSight/Parsers/BitSightVulnerabilitiesFindingsSummary.yaml) |

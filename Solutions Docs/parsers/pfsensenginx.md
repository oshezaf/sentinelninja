...
| File Type | .txt |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/pfsense/pfsense_nginx.txt) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `DeviceEventClassID == "nginx"`<br>`DeviceProduct == "pfsense"` | ✓ | ✓ | ✓ |

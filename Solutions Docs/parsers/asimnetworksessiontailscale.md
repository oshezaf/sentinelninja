...
| Location | Solution |
| Solution | [Tailscale (CCF)](../solutions/tailscale-ccf.md) ⚠️ |
| Version | 1.0.0 |
| Last Updated | 2026-05-19 |
| Category | Microsoft Sentinel Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tailscale%20%28CCF%29/Parsers/ASimNetworkSessionTailscale.yaml) |

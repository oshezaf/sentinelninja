...
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Parsers/CBS_CompromisedCards_Parser.yaml) |
...
| [`CBS_CompromisedCards_CL`](../tables/cbs-compromisedcards-cl.md) | ? | ? | ? |

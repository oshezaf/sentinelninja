...
| Attribute | Value |
|:----------|:------|
| Title | Parser for MimecastEvents |
| Location | Solution |
| Solution | [MimecastEvents-CCF](../solutions/mimecastevents-ccf.md) ⚠️ |
| Version | 1.0.0 |
| Last Updated | 2026-07-06 |
| Category | Microsoft Sentinel Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/MimecastEvents-CCF/Parsers/MimecastEvents.yaml) |

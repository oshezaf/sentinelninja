...
Standardized parser for Versasec CMS system activities

## Parser Information

| Attribute | Value |
|:----------|:------|
| Title | Parser for vSec:CMS |
| Location | Solution |
| Solution | [VersasecCMS](../solutions/versaseccms.md) |
| Version | 1.0.0 |
| Last Updated | 2026-02-09 |
| Category | VersasecCmsParser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/VersasecCMS/Parsers/VersasecCmsSyslog.yaml) |

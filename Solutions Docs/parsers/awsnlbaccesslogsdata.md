...
| Attribute | Value |
|:----------|:------|
| Title | Parser for AWSNLBAccessLogs |
| Location | Solution |
| Solution | [AWS ELB](../solutions/aws-elb.md) |
| Version | 1.0.0 |
| Last Updated | 2026-03-20 |
| Category | Microsoft Sentinel Parser |
| File Type | .yaml |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AWS%20ELB/Parsers/AWSNLBAccessLogsData.yaml) |

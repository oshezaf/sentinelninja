...
| File Type | .txt |
| Source | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/Duo%20Security/DuoSecurityOfflineEnrollment.txt) |

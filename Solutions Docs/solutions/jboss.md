...
| **Categories** | Platform,Application |
| **Version** | 3.0.1 |
| **Author** | Microsoft - support@microsoft.com |
| **First Published** | 2021-10-20 |
| **Solution Folder** | [JBoss](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/JBoss) |
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-jboss) · Popularity: ⚪ Very Low (0%) |
...
|:-----|:------------|:------------|
| [JBossEvent](../parsers/jbossevent.md) | - | [`JBossLogs_CL`](../tables/jbosslogs-cl.md) *(read)* |

# Microsoft Sysmon For Linux Solution

*Solution: Microsoft Sysmon For Linux*
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-sysmonforlinux) · Popularity: 🔵 Medium (57%) |
...
|-------|-------------------|----------------|
| [`Syslog`](../tables/syslog.md) | [Syslog via AMA](../connectors/syslogama.md) (dependency), [Syslog via Legacy Agent](../connectors/syslog.md) (dependency), [[Deprecated] Microsoft Sysmon For Linux](../connectors/microsoftsysmonforlinux.md) | - |

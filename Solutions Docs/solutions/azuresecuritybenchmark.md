...
| **Categories** | Compliance,Security - Cloud Security,Security - Automation (SOAR) |
| **Version** | 3.0.3 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-azuresecuritybenchmark) · Popularity: 🟢 High (86%) |

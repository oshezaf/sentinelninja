...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-nginx) · Popularity: 🟢 High (89%) |
...
| [`NGINX_CL`](../tables/nginx-cl.md) | [Custom logs via AMA](../connectors/customlogsviaama.md) (dependency), [[Deprecated] NGINX HTTP Server](../connectors/nginxhttpserver.md) | Analytics, Hunting, Workbooks |
...
|:-----|:------------|:------------|
| [NGINXHTTPServer](../parsers/nginxhttpserver.md) | - | [`NGINX_CL`](../tables/nginx-cl.md) *(read)* |

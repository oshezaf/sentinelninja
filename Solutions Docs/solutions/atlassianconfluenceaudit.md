...
| **Categories** | IT Operations,Application |
| **Source Vendor** | Atlassian *(basis: publisher)* |
| **Source Product** | Confluence, Confluence Audit |
| **Version** | 3.0.7 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-atlassianconfluenceaudit) · Popularity: 🔵 Medium (63%) |

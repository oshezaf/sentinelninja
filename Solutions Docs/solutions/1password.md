...
| [1Password - Non-privileged vault user permission change](../content/1password-1password-non-privileged-vault-user-permission-change-327e0579-7c03-4ec7-acf5-a29dcc4a12b6-b42d57cf.md) | Medium | Persistence | - |
...
| [1Password - Privileged vault permission change](../content/1password-1password-privileged-vault-permission-change-76e386eb-f51a-4600-97d1-f0db3b7e41f1-d7bf4cbc.md) | High | Persistence | - |
...
| [1Password - User added to privileged group](../content/1password-1password-user-added-to-privileged-group-849ea271-cd9c-4afe-a13b-ddbbac5fc6d3-de7a1516.md) | Medium | Persistence | - |

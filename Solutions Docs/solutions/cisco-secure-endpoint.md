...
| **Categories** | Security - Threat Protection,Networking |
| **Version** | 3.0.0 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-ciscosecureendpoint) · Rating: ★★★★★ 5.0/5 (1 ratings) · Popularity: 🔵 Medium (66%) |

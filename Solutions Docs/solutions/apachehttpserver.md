...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-apachehttpserver) · Popularity: 🔵 Medium (54%) |
...
|-------|-------------------|----------------|
| [`ApacheHTTPServer_CL`](../tables/apachehttpserver-cl.md) | [Custom logs via AMA](../connectors/customlogsviaama.md) (dependency), [[Deprecated] Apache HTTP Server](../connectors/apachehttpserver.md) | Analytics, Hunting, Workbooks |
...
|:-----|:------------|:------------|
| [ApacheHTTPServer](../parsers/apachehttpserver.md) | - | [`ApacheHTTPServer_CL`](../tables/apachehttpserver-cl.md) *(read)* |

## Release Notes

| **Version** | **Date Modified (DD-MM-YYYY)** | **Change History**                                                 |
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.0.2       | 23-07-2026                     | Fixed **Parser** (ApacheHTTPServer) to correctly parse negative timezone offsets and honor the offset when setting EventStartTime |

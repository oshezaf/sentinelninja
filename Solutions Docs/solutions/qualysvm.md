...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-qualysvm) · Popularity: 🔵 Medium (74%) |
...
| Name | Description | Tables Used |
|:-----|:------------|:------------|
| [QualysHostDetection](../parsers/qualyshostdetection.md) | - | [`QualysHostDetectionV2_CL`](../tables/qualyshostdetectionv2-cl.md) *(read)*<br>[`QualysHostDetectionV3_CL`](../tables/qualyshostdetectionv3-cl.md) *(read)*<br>[`QualysHostDetection_CL`](../tables/qualyshostdetection-cl.md) *(read)* |

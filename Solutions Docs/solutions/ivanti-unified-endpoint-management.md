...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-ivantiuem) · Popularity: ⚪ Very Low (0%) |
...
|:-----|:------------|:------------|
| [IvantiUEMEvent](../parsers/ivantiuemevent.md) | - | [`Syslog`](../tables/syslog.md) *(read)* |

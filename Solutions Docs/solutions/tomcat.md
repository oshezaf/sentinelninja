...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-apachetomcat) · Popularity: ⚪ Very Low (0%) |
...
| [`Tomcat_CL`](../tables/tomcat-cl.md) | [Custom logs via AMA](../connectors/customlogsviaama.md) (dependency), [[Deprecated] Apache Tomcat](../connectors/apachetomcat.md) | Analytics, Hunting, Workbooks |
...
|:-----|:------------|:------------|
| [TomcatEvent](../parsers/tomcatevent.md) | - | [`Tomcat_CL`](../tables/tomcat-cl.md) *(read)* |

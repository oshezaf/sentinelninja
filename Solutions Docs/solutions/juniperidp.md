...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-juniperidp) · Popularity: ⚪ Very Low (4%) |
...
- [[Deprecated] Juniper IDP](../connectors/juniperidp.md) ⚠️
...
| [`JuniperIDP_CL`](../tables/juniperidp-cl.md) | [Custom logs via AMA](../connectors/customlogsviaama.md) (dependency), [[Deprecated] Juniper IDP](../connectors/juniperidp.md) | - |
...
|:-----|:------------|:------------|
| [JuniperIDP](../parsers/juniperidp.md) | - | [`JuniperIDP_CL`](../tables/juniperidp-cl.md) *(read)* |

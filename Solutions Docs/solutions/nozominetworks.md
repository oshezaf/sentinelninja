...
| **Source Vendor** | Nozomi Networks *(basis: publisher)* |
| **Version** | 3.0.3 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-nozominetworks) · Popularity: 🟡 Low (47%) |

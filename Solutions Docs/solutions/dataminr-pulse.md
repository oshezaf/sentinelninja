...
This solution has **30 optional** (ASIM-based) dependencies on other solutions that can provide data through ASIM parsers:

| Solution | Dependency Type | Details |
|:---------|:----------------|:--------|
| [AWS VPC Flow Logs](aws-vpc-flow-logs.md) | ASIM (optional) | ASIM schemas: NetworkSession |
| [Azure Activity](azure-activity.md) | ASIM (optional) | ASIM schemas: AuditEvent |
...
| [Cisco Meraki Events via REST API](cisco-meraki-events-via-rest-api.md) | ASIM (optional) | ASIM schemas: AuditEvent, NetworkSession, WebSession |
...
| [CiscoMeraki](ciscomeraki.md) | ASIM (optional) | ASIM schemas: AuditEvent, NetworkSession, WebSession |
| [CiscoUmbrella](ciscoumbrella.md) | ASIM (optional) | ASIM schemas: Dns |
| [Common Event Format](common-event-format.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, NetworkSession, WebSession |
| [Corelight](corelight.md) | ASIM (optional) | ASIM schemas: Dns, NetworkSession |
| [CrowdStrike Falcon Endpoint Protection](crowdstrike-falcon-endpoint-protection.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, FileEvent, NetworkSession, ProcessEvent |
| [CustomLogsAma](customlogsama.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, NetworkSession, WebSession |
| [Forescout (Legacy)](forescout-legacy.md) | ASIM (optional) | ASIM schemas: WebSession |
| [IllumioSaaS](illumiosaas.md) | ASIM (optional) | ASIM schemas: AuditEvent, NetworkSession |
...
| [MimecastTIRegional](mimecasttiregional.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, FileEvent, NetworkSession, ProcessEvent |
| [NXLogDNSLogs](nxlogdnslogs.md) | ASIM (optional) | ASIM schemas: Dns |
| [SentinelOne](sentinelone.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, FileEvent, NetworkSession, ProcessEvent |
| [SlashNext](slashnext.md) | ASIM (optional) | ASIM schemas: Dns, NetworkSession |
| [Syslog](syslog.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, FileEvent, NetworkSession, ProcessEvent |
| [Trend Micro Vision One](trend-micro-vision-one.md) | ASIM (optional) | ASIM schemas: ProcessEvent |
| [VMware Carbon Black Cloud](vmware-carbon-black-cloud.md) | ASIM (optional) | ASIM schemas: AuditEvent, FileEvent, NetworkSession, ProcessEvent |
| [Vectra AI Stream](vectra-ai-stream.md) | ASIM (optional) | ASIM schemas: Dns, NetworkSession, WebSession |
| [Vectra XDR](vectra-xdr.md) | ASIM (optional) | ASIM schemas: AuditEvent |
| [VirtualMetric DataStream](virtualmetric-datastream.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, NetworkSession, WebSession |
| [Windows Forwarded Events](windows-forwarded-events.md) | ASIM (optional) | ASIM schemas: AuditEvent, Dns, FileEvent, NetworkSession, ProcessEvent |
| [Windows Security Events](windows-security-events.md) | ASIM (optional) | ASIM schemas: AuditEvent, FileEvent, NetworkSession, ProcessEvent |
| [Windows Server DNS](windows-server-dns.md) | ASIM (optional) | ASIM schemas: Dns |
| [Workday](workday.md) | ASIM (optional) | ASIM schemas: AuditEvent |
...
This solution uses **240 table(s)**:
...
| [`AzureDiagnostics`](../tables/azurediagnostics.md) 🔶 | [Azure Firewall](../connectors/azurefirewall.md) (dependency), [SlashNext Function App](../connectors/slashnextfunctionapp.md) (dependency) | - |
| [`AzureMetrics`](../tables/azuremetrics.md) | [Azure Storage Account](../connectors/azurestorageaccount.md) (dependency), [SlashNext Function App](../connectors/slashnextfunctionapp.md) (dependency) | - |

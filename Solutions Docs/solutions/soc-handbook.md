...
| [AnomalyData](../content/anomalydata-soc-handbook.md) | [`uniqueIncidentIdList`](../tables/uniqueincidentidlist.md)<br>*Internal use:*<br>[`Anomalies`](../tables/anomalies.md)<br>[`SecurityIncident`](../tables/securityincident.md) |

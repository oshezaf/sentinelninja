# Cisco Email Threat Defense Sentinel Application
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/cisco.cisco-etd-sentinel) · Popularity: ⚪ Very Low (0%) |

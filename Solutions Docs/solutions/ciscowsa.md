...
| **Source Product** | Web Security Appliance |
| **Version** | 3.0.1 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-ciscowsa) · Rating: ★★★☆☆ 3.0/5 (1 ratings) · Popularity: ⚪ Very Low (8%) |
...
|-------|-------------------|----------------|
| [`Syslog`](../tables/syslog.md) | [Syslog via AMA](../connectors/syslogama.md) (dependency), [Syslog via Legacy Agent](../connectors/syslog.md) (dependency), [[Deprecated] Cisco Web Security Appliance](../connectors/ciscowsa.md) | Analytics, Hunting, Workbooks |

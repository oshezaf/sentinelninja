...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-netwrixauditor) · Popularity: 🔵 Medium (69%) |
...
|-------|-------------------|----------------|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | [Common Event Format (CEF)](../connectors/cef.md) (dependency), [Common Event Format (CEF) via AMA](../connectors/cefama.md) (dependency), [[Deprecated] Netwrix Auditor via AMA](../connectors/netwrixama.md), [[Deprecated] Netwrix Auditor via Legacy Agent](../connectors/netwrix.md) | - |
...
|:-----|:------------|:------------|
| [NetwrixAuditor](../parsers/netwrixauditor.md) | - | [`CommonSecurityLog`](../tables/commonsecuritylog.md) *(read)* |

...
*Solution: VirtualMetric DataStream*
...
| **Source Product** | Director Proxy, DataStream for Microsoft Sentinel, DataStream for Microsoft Sentinel data lake |
| **Version** | 3.0.0 |
...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/virtualmetric.azure-sentinel-solution-virtualmetric-datastream) · Popularity: 🔵 Medium (56%) |

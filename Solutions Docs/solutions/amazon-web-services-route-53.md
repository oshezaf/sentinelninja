...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-amazonwebservicesroute53) · Popularity: 🔵 Medium (56%) |
...
|-------|-------------------|----------------|
| [`AWSRoute53Resolver`](../tables/awsroute53resolver.md) | [Amazon Web Services S3 DNS Route53 (via Codeless Connector Framework)](../connectors/awsroute53resolverccpdefinition.md) | - |

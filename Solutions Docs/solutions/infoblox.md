...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/infoblox.infoblox-app-for-microsoft-sentinel) · Popularity: ⚪ Very Low (2%) |
...
- [[Recommended] Infoblox IQ for Threat Defense Insight Data Connector via AMA](../connectors/infobloxsocinsightsdataconnector-ama.md)
...
|-------|-------------------|----------------|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | [[Deprecated] Infoblox SOC Insight Data Connector via Legacy Agent](../connectors/infobloxsocinsightsdataconnector-legacy.md), [[Recommended] Infoblox Cloud Data Connector via AMA](../connectors/infobloxclouddataconnectorama.md), [[Recommended] Infoblox IQ for Threat Defense Insight Data Connector via AMA](../connectors/infobloxsocinsightsdataconnector-ama.md) | Analytics, Playbooks, Workbooks |
...
| Table | Used By Connectors | Used By Content |
|-------|-------------------|----------------|
| [`InfobloxInsightAssets_CL`](../tables/infobloxinsightassets-cl.md) | - | Workbooks |
| [`InfobloxInsightEvents_CL`](../tables/infobloxinsightevents-cl.md) | - | Workbooks |
| [`InfobloxInsightIndicators_CL`](../tables/infobloxinsightindicators-cl.md) | - | Workbooks |
| [`InfobloxInsight_CL`](../tables/infobloxinsight-cl.md) | [Infoblox IQ for Threat Defense Insight Data Connector via REST API](../connectors/infobloxsocinsightsdataconnector-api.md) | Analytics, Workbooks |
...
|:-----|:---------|:--------|:------------|
| [Infoblox - IQ for TD Detected Insights - API Source](../content/infoblox-infoblox-iq-for-td-detected-insights-api-source-a5e2df87-f0c9-4540-8715-96e71b608986-05b6cca0.md) | Medium | Impact | *Internal use:*<br>[`InfobloxInsight_CL`](../tables/infobloxinsight-cl.md) |
| [Infoblox - IQ for TD Insight Detected - CDC Source](../content/infoblox-infoblox-iq-for-td-insight-detected-cdc-source-d04f1963-df27-4127-b1ec-3d37148d65be-66a8b02e.md) | Medium | Impact | [`CommonSecurityLog`](../tables/commonsecuritylog.md) |
...
| [Infoblox-IQ-for-TD-Get-Insight-Details-API](../content/infoblox-infoblox-iq-for-td-get-insight-details-api-1bdff011.md) | Leverages the Infoblox IQ for TD API to enrich a Microsoft Sentinel Incident triggered by an Infoblo... | - |
| [Infoblox-IQ-for-TD-Get-Insights-API](../content/infoblox-infoblox-iq-for-td-get-insights-api-6d522794.md) | Leverages the Infoblox IQ for Threat Defense Insights API to ingest IQ for TD Insights at time of ru... | - |
| [Infoblox-IQ-for-TD-Import-Indicators-TI](../content/infoblox-infoblox-iq-for-td-import-indicators-ti-4737c54d.md) | Imports each Indicator of a Microsoft Sentinel Incident triggered by an Infoblox IQ for TD Insight i... | - |
| [Infoblox-IQ-for-TD-Take-Action-API](../content/infoblox-infoblox-iq-for-td-take-action-api-5af3c01a.md) | Leverages the Infoblox IQ for Threat Defense Insights API to take action on an Insight by applying t... | - |
...
| 3.0.2       |   19-06-2025                   | Added flags for Asset, Indicator, Event and Comment in InfobloxSOCGetInsightDetails playbook. Updated Workbook, Parser and Analytic rule.<br> Migrated checkpoint from file share to azure tables.           |

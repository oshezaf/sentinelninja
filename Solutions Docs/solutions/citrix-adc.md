...
| **Marketplace** | [Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/azuresentinel.azure-sentinel-solution-citrixadc) · Rating: ★★★★★ 4.6/5 (85 ratings) · Popularity: 🟢 High (93%) |
...
|-------|-------------------|----------------|
| [`Syslog`](../tables/syslog.md) | [Syslog via AMA](../connectors/syslogama.md) (dependency), [Syslog via Legacy Agent](../connectors/syslog.md) (dependency), [[Deprecated] Citrix ADC (former NetScaler)](../connectors/citrixadc.md) | - |
...
|:-----|:------------|:------------|
| [CitrixADCEvent](../parsers/citrixadcevent.md) | - | [`Syslog`](../tables/syslog.md) *(read)* |
| [CitrixADCEventOld](../parsers/citrixadceventold.md) ⚠️ | - | [`CommonSecurityLog`](../tables/commonsecuritylog.md) *(read)* |

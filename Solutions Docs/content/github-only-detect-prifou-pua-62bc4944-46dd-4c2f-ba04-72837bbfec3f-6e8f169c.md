...
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine has "/mds"`<br>`ProcessCommandLine has "/mhp"`<br>`ProcessCommandLine has "/mnl"`<br>`ProcessCommandLine has "/mnt"`<br>`ProcessCommandLine has "bundlename=chromium"`<br>`ProcessCommandLine has "rsf"` | ✓ | ✗ | ? |

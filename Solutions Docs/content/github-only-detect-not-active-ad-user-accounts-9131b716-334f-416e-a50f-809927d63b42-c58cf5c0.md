...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Discovery/Detect-Not-Active-AD-User-Accounts.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`IdentityLogonEvents`](../tables/identitylogonevents.md) | `AccountName startswith "XXX"` | ✓ | ✗ | ? |

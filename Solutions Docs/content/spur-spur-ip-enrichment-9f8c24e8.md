...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/azuredeploy.json) |
...
> 📄 *Source: [Spur-Get-IP-Context-Data-Incident-Trigger/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/readme.md)*
...
![Incident Comments](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/images/comments.png)
![Incident Comments](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/images/custom_table.png)
...
- Fill in the required parameters for deploying the playbook.
  ![deployment](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/images/deployment.png)
...
- Logic App prompts any missing connections, please update the connections.
  ![postdeployment](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Spur/Playbooks/Spur-Get-IP-Context-Data-Incident-Trigger/images/post_deployment_connections.png)

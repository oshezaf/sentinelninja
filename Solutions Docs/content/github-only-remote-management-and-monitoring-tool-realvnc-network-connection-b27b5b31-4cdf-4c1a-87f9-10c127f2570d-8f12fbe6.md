...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/RemoteManagementMonitoring/rmm_RealVNC_netconn.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceNetworkEvents`](../tables/devicenetworkevents.md) | `InitiatingProcessVersionInfoCompanyName has "realvnc"`<br>`RemoteUrl has_any "update-check.realvnc.com"` | ✓ | ✗ | ? |

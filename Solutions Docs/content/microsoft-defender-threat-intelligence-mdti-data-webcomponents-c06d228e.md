...
**`http`** (builtin):
- *Get_components_for_host*: method=`GET`, uri=`@{parameters('MDTI-BaseUrl')}/@{parameters('Api-Version')}/security/threatIntelligence/hosts('@{items('For_each_Host')?['HostName']}.@{items('For_each_Host')?['DnsDomain']}')/components`
- *Get_components*: method=`GET`, uri=`@{parameters('MDTI-BaseUrl')}/@{parameters('Api-Version')}/security/threatIntelligence/hosts('@{items('For_each_IP_Address')?['Address']}')/components`

</details>

## Additional Documentation

> 📄 *Source: [MDTI-Data-WebComponents/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20Defender%20Threat%20Intelligence/Playbooks/MDTI-Data-WebComponents/readme.md)*

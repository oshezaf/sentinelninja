...
| **Techniques** | T1556.006, T1098 |
| **Required Connectors** | [AzureActiveDirectory](../connectors/azureactivedirectory.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/AuditLogs/TemporaryAccessPassCreatedForUser.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AuditLogs`](../tables/auditlogs.md) | `OperationName in "Admin registered security info,Create Temporary Access Pass method for user,Update user"` | ✓ | ✗ | ✓ |

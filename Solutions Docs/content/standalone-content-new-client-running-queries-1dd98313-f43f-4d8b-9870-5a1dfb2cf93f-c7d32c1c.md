...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/LAQueryLogs/NewClientRunningQueries.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`LAQueryLogs`](../tables/laquerylogs.md) | `ResponseCode == "200"` | ✓ | ✗ | ? |

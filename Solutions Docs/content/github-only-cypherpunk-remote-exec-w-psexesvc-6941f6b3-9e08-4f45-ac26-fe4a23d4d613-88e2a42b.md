...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `InitiatingProcessCommandLine has ".bat"`<br>`InitiatingProcessParentFileName startswith "psexe"`<br>`ProcessCommandLine has "DisableIOAVProtection"` | ✓ | ✗ | ? |

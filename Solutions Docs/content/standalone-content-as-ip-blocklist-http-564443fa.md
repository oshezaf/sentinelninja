...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Playbooks/Playbooks/AS-IAM-Entra-ID-Master-Playbook/AS-IP-Blocklist-HTTP/azuredeploy.json) |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/MultipleDataSources/PrivilegedAccountsLockedOut.yaml) |
...
| [`SigninLogs`](../tables/signinlogs.md) | `ResultType == "50053"` | ✓ | ✗ | ✓ |

...
**`function`** (builtin):
- *GetUser*: method=`GET`, functionId=`[concat(variables('aws_iam_functionapp_id'), '/functions/GetUser')]`
- *ListGroupsForUser*: method=`GET`, functionId=`[concat(variables('aws_iam_functionapp_id'), '/functions/ListGroupsForUser')]`

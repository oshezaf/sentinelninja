...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/AS-Edgescan-Integration/AS-Edgescan-Integration-Vulnerabilities/azuredeploy.json) |
...
**`http`** (builtin):
- *Send_HTTP_GET_Vulnerabilities_Request*: method=`GET`, uri=`[concat('https://', parameters('EdgescanURL'), '/api/v1/vulnerabilities.json')]`

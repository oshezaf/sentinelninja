...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`PurviewDataSensitivityLogs`](../tables/purviewdatasensitivitylogs.md) | `Classification contains "Social Security Number"`<br>`SourceRegion == "westeurope"`<br>`SourceType contains "Amazon"` | ✓ | ✗ | ? |

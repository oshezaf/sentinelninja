...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Persistence/qakbot-campaign-registry-edit.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceRegistryEvents`](../tables/deviceregistryevents.md) | `ActionType == "RegistryValueSet"`<br>`InitiatingProcessFileName == "explorer.exe"`<br>`RegistryValueData has "$windowsupdate"` | ✓ | ✗ | ? |

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `InitiatingProcessFileName == "explorer.exe"`<br>`ProcessCommandLine has_all "-ExecutionPolicy"`<br>`ProcessCommandLine has_all "-WindowStyle"` | ✓ | ✗ | ? |

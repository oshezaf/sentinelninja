...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`OfficeActivity`](../tables/officeactivity.md) | `Operation in "Add-MailboxFolderPermission,Add-MailboxPermission,New-InboxRule,New-ManagementRoleAssignment,Set-InboxRule,Set-Mailbox,Set-TransportRule"` | ✓ | ✗ | ✓ |
| [`SigninLogs`](../tables/signinlogs.md) | `ResultType in "0,50057"` | ✓ | ✗ | ✓ |

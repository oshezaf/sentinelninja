...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/MimecastTTP/Workbooks/MimecastTTPWorkbook.json) |
...
↑ [Back to Workbooks](workbooks.md) · [Back to MimecastTTP](../solutions/mimecastttp.md)

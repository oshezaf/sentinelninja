...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/RemoteManagementMonitoring/rmm_parsec.app_createproc.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessVersionInfoCompanyName has "Parsec"`<br>`ProcessVersionInfoProductName has "Parsec"` | ✓ | ✗ | ? |

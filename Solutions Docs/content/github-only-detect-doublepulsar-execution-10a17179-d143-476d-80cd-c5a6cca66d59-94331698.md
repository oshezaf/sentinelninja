...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Execution/detect-doublepulsar-execution.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine contains "payload"`<br>`ProcessCommandLine contains "targetip"`<br>`ProcessCommandLine contains "targetport"`<br>`ProcessCommandLine contains "verifybackdoor"` | ✓ | ✗ | ? |

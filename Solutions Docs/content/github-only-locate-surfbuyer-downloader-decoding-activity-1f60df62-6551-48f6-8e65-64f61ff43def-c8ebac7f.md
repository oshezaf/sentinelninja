...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Execution/locate-surfbuyer-downloader-decoding-activity.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine has "/tmp/e_"`<br>`ProcessCommandLine has "base64"` | ✓ | ✗ | ? |

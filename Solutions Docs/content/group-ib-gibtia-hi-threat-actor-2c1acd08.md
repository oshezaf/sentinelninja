...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_HI_Threat_Actor.json) |
...
| Table | Usage |
|:------|:------|
| [`GIBTIAHIThreatActor_CL`](../tables/gibtiahithreatactor-cl.md) | write |

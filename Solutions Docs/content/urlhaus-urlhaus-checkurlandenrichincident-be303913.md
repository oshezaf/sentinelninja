...
| [`URLhausAPI`](../logic-apps/custom-urlhausapi.md) | Custom | 1 | 1 |
...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| Query_URL_information | post | `/url/` | — |

</details>

## Additional Documentation

> 📄 *Source: [URLhaus-CheckURLAndEnrichIncident/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/URLhaus/Playbooks/URLhaus-CheckURLAndEnrichIncident/readme.md)*
...
<img src="https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/URLhaus/Playbooks/URLhaus-CheckURLAndEnrichIncident/playbook_screenshot.png" width="80%"/><br>
### Prerequisites 

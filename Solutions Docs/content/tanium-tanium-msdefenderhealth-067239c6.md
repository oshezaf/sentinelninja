...
- *Get_MS_Defender_Status*: method=`POST`, uri=`@parameters('TaniumApiGatewayApi')`
...
> 📄 *Source: [Tanium-MSDefenderHealth/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tanium/Playbooks/Tanium-MSDefenderHealth/readme.md)*

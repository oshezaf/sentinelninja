...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks/Entrust-EnrichIncidentWithIPDetails/azuredeploy.json) |
...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| HTTP_-_Get_IP_details_from_audit_events | POST | `https://@{parameters('Host End Point')}/api/web/v2/reports/auditeventspaged` | — |
...
> 📄 *Source: [EntrustPlaybooks/Entrust-EnrichIncidentWithIPDetails/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks/Entrust-EnrichIncidentWithIPDetails/readme.md)*

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`Event`](../tables/event.md) | `EventID == "33205"`<br>`EventLog == "Application"`<br>`RenderedDescription has_all "database_name:AdfsConfigurationV4"`<br>`Source == "MSSQL$MICROSOFT##WID"` | ✓ | ✓ | ? |

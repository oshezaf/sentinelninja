...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Censys/Playbooks/CensysEntityEnrichmentCertificate/azuredeploy.json) |
...
- *Ingest_Censys_Cert_Data*: method=`post`, path=`/api/logs`
...
**`http`** (builtin):
- *HTTP_Call_to_Fetch_Cert_Data*: method=`GET`, uri=`@{variables('base_url')}/@{variables('api_version')}/global/asset/certificate/@{variables('EntityData')}`
...
> 📄 *Source: [CensysEntityEnrichmentCertificate/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Censys/Playbooks/CensysEntityEnrichmentCertificate/readme.md)*

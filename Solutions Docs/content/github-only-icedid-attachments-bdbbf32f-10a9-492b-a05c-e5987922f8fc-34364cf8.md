...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Ransomware/IcedId%20attachments.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`EmailEvents`](../tables/emailevents.md) | `AttachmentCount == "1"`<br>`EmailDirection == "Inbound"` | ✓ | ✗ | ? |

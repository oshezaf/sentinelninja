...
| **Severity** | Medium |
| **Kind** | Scheduled |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ForescoutHostPropertyMonitor/Analytic%20Rules/ForeScout-DNSSniffEventMonitor.yaml) |
...
↑ [Back to Analytic Rules](analytic-rules.md) · [Back to ForescoutHostPropertyMonitor](../solutions/forescouthostpropertymonitor.md)

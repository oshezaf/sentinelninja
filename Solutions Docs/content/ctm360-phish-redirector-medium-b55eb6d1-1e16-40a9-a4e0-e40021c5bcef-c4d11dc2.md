...
New Phish Redirector with severity Medium found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `b55eb6d1-1e16-40a9-a4e0-e40021c5bcef` |
| **Severity** | Medium |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/phish_redirector_medium.yaml) |

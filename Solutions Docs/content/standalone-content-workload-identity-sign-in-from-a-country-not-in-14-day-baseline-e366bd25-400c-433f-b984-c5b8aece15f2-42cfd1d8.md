...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/MultipleDataSources/WorkloadIdentitySignInFromNewCountry.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AADServicePrincipalSignInLogs`](../tables/aadserviceprincipalsigninlogs.md) | `ResultType == "0"` | ✓ | ✗ | ✓ |

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`SecurityEvent`](../tables/securityevent.md) | `Account !endswith "$"`<br>`EventID in "4624,4688,4697,4698,4699,4700,4701,4702,5145"`<br>`LogonType == "3"`<br>`RelativeTargetName in "atsvc,svcctl"` | ✓ | ✓ | ? |

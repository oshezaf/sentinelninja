...
Identifies STS AssumeRole operations for IAM roles not historically seen from the calling identity, which may indicate credential abuse or lateral movement.
...
| **Severity** | Medium |
| **Tactics** | InitialAccess, DefenseEvasion, PrivilegeEscalation |

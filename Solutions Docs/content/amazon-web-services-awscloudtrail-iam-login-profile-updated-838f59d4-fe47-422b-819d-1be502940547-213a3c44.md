...
Identifies UpdateLoginProfile activity that may indicate unauthorized password changes used for persistence or privilege escalation.
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AWSCloudTrail`](../tables/awscloudtrail.md) | `EventName == "UpdateLoginProfile"` | ✓ | ✓ | ✓ |

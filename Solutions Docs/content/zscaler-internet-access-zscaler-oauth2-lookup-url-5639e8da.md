...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2LookupURL/azuredeploy.json) |
...
**`http`** (builtin):
- *HTTP_Lookup_URL*: method=`POST`, uri=`https://api.zsapi.net/zia/api/v1/urlLookup`
...
> 📄 *Source: [Oauth2LookupURL/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2LookupURL/readme.md)*

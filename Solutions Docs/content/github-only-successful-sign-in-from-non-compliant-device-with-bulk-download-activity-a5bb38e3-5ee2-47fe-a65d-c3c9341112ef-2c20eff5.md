...
| [`SigninLogs`](../tables/signinlogs.md) | `ConditionalAccessStatus == "success"`<br>`OperationName has_any "Download group members,Download groups,Download user registeration details,Download users"` | ✓ | ✗ | ✓ |

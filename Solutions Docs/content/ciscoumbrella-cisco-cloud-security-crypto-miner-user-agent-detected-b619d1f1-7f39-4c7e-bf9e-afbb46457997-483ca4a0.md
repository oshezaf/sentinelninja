...
| **Status** | Available |
| **Kind** | Scheduled |
| **Tactics** | Impact, CommandAndControl, Exfiltration |
| **Techniques** | T1496, T1071.001, T1041 |
| **Required Connectors** | [CiscoUmbrellaDataConnector](../connectors/ciscoumbrelladataconnector.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoUmbrella/Analytic%20Rules/CiscoUmbrellaCryptoMinerUserAgentDetected.yaml) |

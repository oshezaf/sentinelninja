...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/SigninLogs/multipleAADAdminRemovals.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AuditLogs`](../tables/auditlogs.md) | `Identity !has "MS-PIM"`<br>`OperationName in "Remove eligible member from role,Remove member from role"` | ✓ | ✗ | ? |

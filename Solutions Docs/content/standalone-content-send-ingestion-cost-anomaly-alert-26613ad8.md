...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/Send-IngestionCostAnomalyAlert/azuredeploy.json) |
...
- *Run_query_and_visualize_results*: method=`post`, path=`/visualizeQuery`

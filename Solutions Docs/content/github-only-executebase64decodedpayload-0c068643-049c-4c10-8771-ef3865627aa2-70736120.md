...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Execution/ExecuteBase64DecodedPayload.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine contains ".b64decode("`<br>`ProcessCommandLine contains ".decode("`<br>`ProcessCommandLine contains ".decode64("`<br>`ProcessCommandLine contains "base64 --decode"` | ✓ | ✗ | ? |

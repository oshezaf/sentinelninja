...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| HTTP_-_Get_Token_Initial | POST | `[concat(parameters('CheckmarxIAMBaseUrl'), '/auth/realms/', parameters('CheckmarxTenant'), '/protocol/openid-connect/token')]` | — |
...
| HTTP_-_Get_SAST_Results_Page | GET | `[concat(parameters('CheckmarxASTBaseUrl'), '/api/sast-results/?scan-id=@{items(''For_Each_-_Scan'')?[''id'']}&limit=@{variables(''ResultPageSize'')}&offset=@{variables(''ResultOffset'')}')]` | — |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Snowflake/Workbooks/Snowflake.json) |
...
↑ [Back to Workbooks](workbooks.md) · [Back to Snowflake](../solutions/snowflake.md)

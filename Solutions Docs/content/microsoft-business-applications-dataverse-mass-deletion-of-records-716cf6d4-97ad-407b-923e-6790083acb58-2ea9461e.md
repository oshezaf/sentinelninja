...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20Business%20Applications/Analytic%20Rules/Dataverse%20-%20Mass%20deletion%20of%20records.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DataverseActivity`](../tables/dataverseactivity.md) | `Message == "BulkDelete"` | ✓ | ✗ | ? |

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceFileEvents`](../tables/devicefileevents.md) | `FileOriginReferrerUrl has "/account"`<br>`FileOriginReferrerUrl has "/case"`<br>`FileOriginUrl has "/cancel.php"`<br>`FileOriginUrl has "/download.php"` | ✓ | ✗ | ? |

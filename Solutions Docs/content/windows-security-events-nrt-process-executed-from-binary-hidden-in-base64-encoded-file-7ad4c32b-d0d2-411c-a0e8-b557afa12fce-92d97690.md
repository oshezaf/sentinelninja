...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Windows%20Security%20Events/Analytic%20Rules/NRT_execute_base64_decodedpayload.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`SecurityEvent`](../tables/securityevent.md) | `CommandLine contains ".decode("`<br>`CommandLine contains ".decode64("`<br>`CommandLine contains "base64 --decode"`<br>`EventID == "4688"` | ✓ | ✓ | ✓ |

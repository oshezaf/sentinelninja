...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Playbooks/Playbooks/Add-IP-Entity-To-Named-Location/azuredeploy.json) |

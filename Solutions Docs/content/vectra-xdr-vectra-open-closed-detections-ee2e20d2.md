...
| Get_Access_Token_For_Opening_Detections | get | `/secrets/@{encodeURIComponent('Vectra-Access-Token')}/value` | — |
...
| HTTP_Request_To_Open_Detections | PATCH | `@{variables('base_url')}/api/@{variables('api_version')}/detections/open` | — |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_OSI_GitLeak.json) |
...
| Table | Usage |
|:------|:------|
| [`GIBTIAOSIGitLeak_CL`](../tables/gibtiaosigitleak-cl.md) | write |

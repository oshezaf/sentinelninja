...
New User Credentials Web App with severity Informational found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `577acdce-665c-468a-af78-9cf1561ec234` |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/user_credentials_web_app_informational.yaml) |

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceFileEvents`](../tables/devicefileevents.md) | `InitiatingProcessCommandLine has_all "IEX"`<br>`InitiatingProcessCommandLine has_any "Unrestricted"`<br>`InitiatingProcessFileName == "powershell.exe"` | ✓ | ✗ | ? |

...
| **Tactics** | Discovery |
| **Techniques** | T1082 |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroTrust%28TIC3.0%29/Analytic%20Rules/Zero_Trust_TIC3.0_ControlAssessmentPostureChange.yaml) |
...
↑ [Back to Analytic Rules](analytic-rules.md) · [Back to ZeroTrust(TIC3.0)](../solutions/zerotrust-tic3.0.md)

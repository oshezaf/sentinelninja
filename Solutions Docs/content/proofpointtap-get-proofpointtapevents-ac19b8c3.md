...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ProofPointTap/Playbooks/Get-ProofPointTapEvents/Azuredeploy.json) |

## Tables Used

| Table | Usage |
|:------|:------|
| [`ProofPointData_CL`](../tables/proofpointdata-cl.md) | write |

## Additional Documentation

> 📄 *Source: [Get-ProofPointTapEvents/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ProofPointTap/Playbooks/Get-ProofPointTapEvents/readme.md)*
...
↑ [Back to Playbooks](playbooks.md) · [Back to ProofPointTap](../solutions/proofpointtap.md)

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Playbooks/Playbooks/Block-AADUserOrAdmin/incident-trigger/azuredeploy.json) |

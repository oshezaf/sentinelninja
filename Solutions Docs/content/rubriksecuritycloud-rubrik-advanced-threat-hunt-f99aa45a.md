...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/RubrikSecurityCloud/Playbooks/RubrikAdvanceThreatHunt/azuredeploy.json) |
...
**`http`** (builtin):
- *Start_Advance_Threat_Hunt*: method=`POST`, uri=`@{variables('Base_URL')}/api/graphql`
- *Check_Advance_Threat_Hunt_Status*: method=`POST`, uri=`@{variables('Base_URL')}/api/graphql`

</details>

## Additional Documentation

> 📄 *Source: [RubrikAdvanceThreatHunt/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/RubrikSecurityCloud/Playbooks/RubrikAdvanceThreatHunt/readme.md)*

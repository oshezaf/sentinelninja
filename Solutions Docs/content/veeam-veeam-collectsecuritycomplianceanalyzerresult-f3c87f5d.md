...
**`function`** (builtin):
- *Collect_Best_Practice_Analysis_into_VeeamBestPracticeAnalysisTable_CL*: functionId=`[concat(variables('functionAppId'), '/functions/GetSecurityComplianceAnalyzerResultsAsync')]`

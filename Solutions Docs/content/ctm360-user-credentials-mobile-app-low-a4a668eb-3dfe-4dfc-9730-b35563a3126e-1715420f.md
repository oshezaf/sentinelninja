...
New User Credentials Mobile App with severity Low found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `a4a668eb-3dfe-4dfc-9730-b35563a3126e` |
| **Severity** | Low |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/user_credentials_mobile_app_low.yaml) |

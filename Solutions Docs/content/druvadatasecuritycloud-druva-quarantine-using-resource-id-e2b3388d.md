...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| Quarantine_Resource_API | POST | `@{parameters('api_host')}/realize/ransomwarerecovery/v1/quarantineranges/resource/@{triggerBody()?['resourceID']}` | — |
...
# Druva Quarantine Device using Resource ID

...
|:-------------------|:-----|:-----------:|:-------:|
| [`azureloganalyticsdatacollector`](../logic-apps/managed-azureloganalyticsdatacollector.md) | Managed | 1 | 21 |
...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| TeamCymruScoutCreateIncidentAndNotifyForFirstRun | — | — | workflowId=`[concat('/subscriptions/', subscription().subscriptionId, '/resourceGroups/',resourceGroup().name,'/providers/Microsoft.Logic/workflows/',trim(parameters('CreateIncidentAndNotifyPlaybookName')))]`<br>triggerName=`manual` |
| TeamCymruScoutCreateIncidentAndNotify | — | — | workflowId=`[concat('/subscriptions/', subscription().subscriptionId, '/resourceGroups/',resourceGroup().name,'/providers/Microsoft.Logic/workflows/',trim(parameters('CreateIncidentAndNotifyPlaybookName')))]`<br>triggerName=`manual` |

...
| [`AzureActivity`](../tables/azureactivity.md) | `ActivityStatus == "Succeeded"` | ? | ✗ | ? |
| [`SigninLogs`](../tables/signinlogs.md) | `AppDisplayName !in "Office 365 Exchange Online,Skype for Business Online,Office 365 SharePoint Online"` | ✓ | ✗ | ? |

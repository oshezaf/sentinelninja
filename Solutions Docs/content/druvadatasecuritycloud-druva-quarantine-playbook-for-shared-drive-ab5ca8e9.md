...
This playbook uses Druva-Ransomware-Response capabilities to stop the spread of ransomware and avoid reinfection or contamination spread to your shared drives.

| Attribute | Value |
|:----------|:------|
| **Type** | Playbook |
| **Solution** | [DruvaDataSecurityCloud](../solutions/druvadatasecuritycloud.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/DruvaDataSecurityCloud/Playbooks/DruvaQuarantineSharedDrive/azuredeploy.json) |

## Additional Documentation

> 📄 *Source: [DruvaQuarantineSharedDrive/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/DruvaDataSecurityCloud/Playbooks/DruvaQuarantineSharedDrive/readme.md)*

# Druva Quarantine Shared Drive Resource

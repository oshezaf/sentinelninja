...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`CommonSecurityLog`](../tables/commonsecuritylog.md) | `DeviceEventClassID == "globalprotect"`<br>`DeviceVendor == "Palo Alto Networks"`<br>`Message has "GlobalProtect gateway user authentication succeeded"` | ✓ | ✓ | ? |

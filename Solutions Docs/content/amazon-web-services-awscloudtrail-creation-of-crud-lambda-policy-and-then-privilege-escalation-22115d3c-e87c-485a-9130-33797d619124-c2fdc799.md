...
Identifies creation of IAM policies that grant broad AWS Lambda CRUD permissions and subsequent policy attachment activity to a principal. This behavior may indicate an attempt to add capabilities that support privilege escalation or unauthorized execution pathways.
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Amazon%20Web%20Services/Analytic%20Rules/AWS_CreatedCRUDLambdaPolicytoPrivilegEscalation.yaml) |

...
New Compromised Cards with severity Low found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `970a9ae9-2e9b-4a51-a1f0-b76acd28f62f` |
| **Severity** | Low |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/compromised_cards_low.yaml) |

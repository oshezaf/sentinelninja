...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/SpyCloud%20Enterprise%20Protection/Playbooks/SpyCloud-Get-Domain-Breach-Data-Playbook/azuredeploy.json) |
...
- *Get_Breach_Data_by_Domain_Search*: method=`get`, path=`/breach/data/domains/@{encodeURIComponent(items('For_Each_Incident_DNS_Domain')?['DomainName'])}`

</details>

## Additional Documentation

> 📄 *Source: [SpyCloud-Get-Domain-Breach-Data-Playbook/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/SpyCloud%20Enterprise%20Protection/Playbooks/SpyCloud-Get-Domain-Breach-Data-Playbook/readme.md)*

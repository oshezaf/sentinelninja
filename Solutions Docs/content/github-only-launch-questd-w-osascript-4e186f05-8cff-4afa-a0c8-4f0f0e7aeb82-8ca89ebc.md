...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Execution/launch-questd-w-osascript.yaml) |
...
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine contains "questd"`<br>`ProcessCommandLine has "osascript -e do shell script \"` | ✓ | ✗ | ? |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Impact/backup-deletion.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AlertInfo`](../tables/alertinfo.md) | `Title == "File backups were deleted"` | ✓ | ✗ | ? |

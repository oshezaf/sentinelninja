...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/AI%20Agents/Copilot%20Studio%20Connector/AIAgentsOrganizationWideShared.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AIAgentsInfo`](../tables/aiagentsinfo.md) | `AccessControlPolicy == "Any"`<br>`AgentStatus != "Deleted"`<br>`RegistrySource != "A365"` | ? | ✗ | ? |

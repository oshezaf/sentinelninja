...
| [`SigninLogs`](../tables/signinlogs.md) | `NetworkLocationDetails == "[]"`<br>`OperationName in "Register device,User registered security info"`<br>`RiskLevelDuringSignIn == "high"` | ✓ | ✗ | ✓ |

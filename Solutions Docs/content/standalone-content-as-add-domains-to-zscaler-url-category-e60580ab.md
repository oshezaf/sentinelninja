...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/Zscaler-add-Domains-to-URL-Category/azuredeploy.json) |
...
- *HTTP-_Update_URL_Category*: method=`PUT`, uri=`[concat(parameters('ZscalerURL'), '/api/v1/urlCategories/@{variables(''URL Category Id'')}?action=ADD_TO_LIST')]`

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Censys/Playbooks/CensysIncidentEnrichment/azuredeploy.json) |
...
|:------|:---------------:|:-------------:|:---------:|
| [`CensysCertificate_CL`](../tables/censyscertificate-cl.md) 🔶 | ? | ✓ | ? |

...
- *Get_Linux_unquarantine_package*: method=`GET`, uri=`@{concat(parameters('TaniumPackagesByNameUrlFragment'), uriComponent(variables('linuxPackageName')))}`
- *Issue_Linux_unquarantine_action*: method=`POST`, uri=`@parameters('TaniumActionsApi')`
- *Get_Windows_unquarantine_package*: method=`GET`, uri=`@{concat(parameters('TaniumPackagesByNameUrlFragment'), uriComponent(variables('windowsPackageName')))}`
- *Issue_Windows_unquarantine_action*: method=`POST`, uri=`@parameters('TaniumActionsApi')`
- *Get_macOS_unquarantine_package*: method=`GET`, uri=`@{concat(parameters('TaniumPackagesByNameUrlFragment'), uriComponent(variables('macOsPackageName')))}`
- *Issue_macOS_unquarantine_action*: method=`POST`, uri=`@parameters('TaniumActionsApi')`
...
> 📄 *Source: [Tanium-UnquarantineHosts/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tanium/Playbooks/Tanium-UnquarantineHosts/readme.md)*
...
![Tanium-UnquarantineHosts screenshot](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tanium/Playbooks/Tanium-UnquarantineHosts/images/Tanium-UnquarantineHosts.png)

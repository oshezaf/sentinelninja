...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Persistence/localAdminAccountLogon.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceLogonEvents`](../tables/devicelogonevents.md) | `IsLocalAdmin == "1"` | ✓ | ✗ | ? |

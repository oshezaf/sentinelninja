...
- *iam.projects.serviceAccounts.keys.disable*: method=`post`, path=`/v1/projects/@{encodeURIComponent(outputs('parse_project_id'))}/serviceAccounts/@{encodeURIComponent(items('For_each_service_account'))}/keys/@{encodeURIComponent(items('For_each_key'))}:disable`

</details>

## Additional Documentation

> 📄 *Source: [GCP-DisableServiceAccountKey/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/GoogleCloudPlatformIAM/Playbooks/GCP-DisableServiceAccountKey/readme.md)*

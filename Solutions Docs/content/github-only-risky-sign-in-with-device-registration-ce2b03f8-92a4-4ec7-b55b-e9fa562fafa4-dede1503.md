...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Persistence/riskySignInToDeviceRegistration.yaml) |
...
| [`CloudAppEvents`](../tables/cloudappevents.md) | `ActionType == "Add registered owner to device."` | ✓ | ✗ |

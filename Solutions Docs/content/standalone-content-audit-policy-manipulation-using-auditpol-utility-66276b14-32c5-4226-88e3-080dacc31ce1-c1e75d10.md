...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `InitiatingProcessFileName == "auditpol.exe"` | ✓ | ✗ | ? |
| [`Event`](../tables/event.md) | `Source == "Microsoft-Windows-Sysmon"` | ✓ | ✓ | ✗ |
| [`SecurityEvent`](../tables/securityevent.md) | `AccountType != "Machine"`<br>`EventID == "1"`<br>`Process == "auditpol.exe"` | ✓ | ✓ | ✓ |

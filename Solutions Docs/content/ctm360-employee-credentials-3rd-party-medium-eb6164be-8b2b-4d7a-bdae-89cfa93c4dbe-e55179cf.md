...
New Employee Credentials 3Rd Party with severity Medium found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `eb6164be-8b2b-4d7a-bdae-89cfa93c4dbe` |
| **Severity** | Medium |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/employee_credentials_3rd_party_medium.yaml) |

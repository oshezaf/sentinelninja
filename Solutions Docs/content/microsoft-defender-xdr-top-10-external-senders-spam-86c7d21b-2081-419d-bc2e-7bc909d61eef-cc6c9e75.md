...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20Defender%20XDR/Hunting%20Queries/Email%20and%20Collaboration%20Queries/General/Top%2010%20External%20Senders%20%28Spam%29.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`EmailEvents`](../tables/emailevents.md) | `EmailDirection == "Inbound"`<br>`SenderFromAddress !contains ".yourdomain.com"`<br>`ThreatTypes has "Spam"` | ✓ | ✗ | ✓ |

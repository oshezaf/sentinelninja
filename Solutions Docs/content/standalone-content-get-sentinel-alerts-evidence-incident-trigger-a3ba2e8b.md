...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Playbooks/Playbooks/Get-SentinelAlertsEvidence/incident-trigger/azuredeploy.json) |

...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| Cookies_by_Hostname | GET | `@{parameters('MDTI-BaseUrl')}/@{parameters('Api-Version')}/security/threatIntelligence/hosts('@{items('For_each_Host')?['HostName']}.@{items('For_each_Host')?['DnsDomain']}')/cookies?$count=true` | — |
| Cookies_by_IP_Address | GET | `@{parameters('MDTI-BaseUrl')}/@{parameters('Api-Version')}/security/threatIntelligence/hosts('@{items('For_each_IP_Address')?['Address']}')/cookies?$count=true` | — |

...
New Spam with severity High found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `d865948f-a322-4057-bcfa-b409dac5b78f` |
| **Severity** | High |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/spam_high.yaml) |

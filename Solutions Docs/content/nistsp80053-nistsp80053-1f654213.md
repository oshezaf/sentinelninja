...
| [`OfficeActivity`](../tables/officeactivity.md) | `OperationName contains "Delete"`<br>`OperationName contains "PIM"`<br>`OperationName contains "Remove"` | ✓ | ✗ | ✓ |
...
| [`SecurityRegulatoryCompliance`](../tables/securityregulatorycompliance.md) | `ComplianceStandard == "NIST-SP-800-53-R4"` | ✓ | ✗ | ✗ |

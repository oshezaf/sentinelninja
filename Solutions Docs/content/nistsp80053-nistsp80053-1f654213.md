...
| [`OfficeActivity`](../tables/officeactivity.md) | `Operation contains "file"`<br>`OperationName contains "Delete"`<br>`OperationName contains "PIM"`<br>`OperationName contains "Remove"` | ✓ | ✗ | ? |

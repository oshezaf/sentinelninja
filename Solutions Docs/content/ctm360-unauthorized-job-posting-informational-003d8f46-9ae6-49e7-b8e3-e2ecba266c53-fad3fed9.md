...
New Unauthorized Job Posting with severity Informational found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `003d8f46-9ae6-49e7-b8e3-e2ecba266c53` |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/unauthorized_job_posting_informational.yaml) |

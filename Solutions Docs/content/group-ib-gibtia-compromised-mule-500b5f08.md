...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_Compromised_mule.json) |
...
| Table | Usage |
|:------|:------|
| [`GIBTIACompromisedMule_CL`](../tables/gibtiacompromisedmule-cl.md) | write |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20Defender%20XDR/Hunting%20Queries/Email%20and%20Collaboration%20Queries/General/Local%20time%20to%20UTC%20time%20conversion.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`EmailEvents`](../tables/emailevents.md) | `DeliveryAction == "Delivered"`<br>`LatestDeliveryLocation == "Quarantine"` | ✓ | ✗ | ? |

...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceFileCertificateInfo`](../tables/devicefilecertificateinfo.md) | `IsRootSignerMicrosoft == "1"`<br>`IsSigned == "1"`<br>`IsTrusted == "1"`<br>`Issuer !startswith "Microsoft"`<br>`Issuer !startswith "Windows"`<br>`SignatureType == "Embedded"` | ✓ | ✗ | ? |

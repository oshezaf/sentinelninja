...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/General%20queries/Events%20surrounding%20alert%20%283%29.yaml) |
...
| [`DeviceLogonEvents`](../tables/devicelogonevents.md) | `LogonType == "Network"` | ✓ | ✗ | ? |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Playbooks/Playbooks/Netskope/Add-Url-to-netskope-url-list/azuredeploy.json) |

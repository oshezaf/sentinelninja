...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceEvents`](../tables/deviceevents.md) | `AccountName != "administrator"`<br>`AccountName endswith "or"`<br>`AccountName startswith "ad"`<br>`ActionType == "UserAccountCreated"` | ✓ | ✗ | ✓ |

...
New Ransomware with severity High found
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/ransomware_high.yaml) |

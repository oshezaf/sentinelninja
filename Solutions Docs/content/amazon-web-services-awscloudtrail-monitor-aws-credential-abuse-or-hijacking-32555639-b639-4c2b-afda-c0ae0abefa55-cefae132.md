...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AWSCloudTrail`](../tables/awscloudtrail.md) | `EventName == "GetCallerIdentity"`<br>`UserIdentityType == "AssumedRole"` | ✓ | ✓ | ✓ |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2UnblacklistURL/azuredeploy.json) |
...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| Zscaler-Oauth2-Authentication | — | — | workflowId=`[concat('/subscriptions/', subscription().subscriptionId, '/resourceGroups/', resourceGroup().name, '/providers/Microsoft.Logic/workflows/Zscaler-Oauth2-Authentication')]`<br>triggerName=`manual` |

</details>

## Additional Documentation

> 📄 *Source: [Oauth2UnblacklistURL/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2UnblacklistURL/readme.md)*

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/azuredeploy.json) |

## Additional Documentation

> 📄 *Source: [CiscoASA-CreateInboundAccessRuleOnInterface/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/readme.md)*
...
2. An adaptive card is sent to a Teams channel with information about the incident and giving the option to ignore an IP, or depdening on it's current status block it by adding an access rule or unblock it by removing an access rule
    ![Adaptive card](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/images/CreateInboundAccessRuleOnInterface-AdaptiveCard.png)
3. Comment is added to Microsoft Sentinel incident.
![playbook overview](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/images/CreateInboundAccessRuleOnInterface-AzureSentinel-Comments.png)

**Inbound access rule is added in Cisco ASA:**
![playbook overview](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/images/CreateInboundAccessRuleOnInterface-CiscoASA.png)

**Playbook overview:**

![playbook overview](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoASA/Playbooks/CiscoASA-CreateInboundAccessRuleOnInterface/images/CreateInboundAccessRuleOnInterface-LogicApp.png)
...
↑ [Back to Playbooks](playbooks.md) · [Back to CiscoASA](../solutions/ciscoasa.md)

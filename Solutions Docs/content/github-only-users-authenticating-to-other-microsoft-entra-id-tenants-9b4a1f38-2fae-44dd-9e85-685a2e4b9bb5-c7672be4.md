...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/AuditLogs/UsersAuthenticatingtoOtherAzureADTenants.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`SigninLogs`](../tables/signinlogs.md) | `ResultType == "0"`<br>`RiskLevelAggregated != "none"` | ✓ | ✗ | ✓ |

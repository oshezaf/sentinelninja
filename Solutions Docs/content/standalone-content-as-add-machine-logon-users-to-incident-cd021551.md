...
**`http`** (builtin):
- *HTTP_-_Get_machine_logon_users*: method=`GET`, uri=`https://api.securitycenter.microsoft.com/api/machines/@{items('For_each_-_Host')?['additionalData']?['MdatpDeviceId']}/logonusers`

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroNetworks/Playbooks/ZeroNetworksSegment-AddAssettoProtection/azuredeploy.json) |
...
- *Add_asset_to_protection*: method=`post`, path=`/assets/protect`
- *Search_for_an_Asset*: method=`get`, path=`/assets`

</details>

## Additional Documentation

> 📄 *Source: [ZeroNetworksSegment-AddAssettoProtection/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ZeroNetworks/Playbooks/ZeroNetworksSegment-AddAssettoProtection/readme.md)*
...
↑ [Back to Playbooks](playbooks.md) · [Back to ZeroNetworks](../solutions/zeronetworks.md)

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/AI%20Agents/Copilot%20Studio%20Connector/AIAgentsGenerativeOrchestrationNoInstructions.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AIAgentsInfo`](../tables/aiagentsinfo.md) | `AgentStatus == "Published"`<br>`RegistrySource != "A365"` | ? | ✗ | ? |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Command%20and%20Control/reverse-shell-ransomware-macos.yaml) |
...
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine has "bash -i >& /dev/tcp/"` | ✓ | ✗ | ? |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Campaigns/compromised-certificate%5BNobelium%5D.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceFileCertificateInfo`](../tables/devicefilecertificateinfo.md) | `Signer == "Solarwinds Worldwide, LLC"`<br>`SignerHash == "47d92d49e6f7f296260da1af355f941eb25360c4"` | ✓ | ✗ | ? |

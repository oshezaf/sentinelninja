...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/QualysVM/Workbooks/QualysVMv2.json) |
...
↑ [Back to Workbooks](workbooks.md) · [Back to QualysVM](../solutions/qualysvm.md)

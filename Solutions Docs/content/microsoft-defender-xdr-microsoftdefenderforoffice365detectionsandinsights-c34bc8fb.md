...
| [`EmailEvents`](../tables/emailevents.md) | `ActionType in "AdminSubmissionSubmitted,Redelivery,Spam ZAP"`<br>`DeliveryAction == "Delivered"`<br>`DeliveryAction != "Delivered"`<br>`OrgLevelAction in "Allow,Block"`<br>`OrgLevelPolicy != "Phishing simulation"`<br>`OrgLevelPolicy != "SecOps Mailbox"`<br>`UserLevelAction in "Allow,Block"` | ✓ | ✗ | ✓ |

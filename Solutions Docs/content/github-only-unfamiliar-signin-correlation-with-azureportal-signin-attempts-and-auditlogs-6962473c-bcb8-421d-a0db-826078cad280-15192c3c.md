...
| [`SecurityAlert`](../tables/securityalert.md) | `AlertName == "Unfamiliar sign-in properties"` | ✓ | ✗ | ✓ |
| [`SigninLogs`](../tables/signinlogs.md) | `AppDisplayName == "Azure Portal"`<br>`OperationName has_any "Add member to role"` | ✓ | ✗ | ✓ |

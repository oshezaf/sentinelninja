...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Dynatrace/Playbooks/Enrich-DynatraceAppSecAttackMSDefenderXDR/azuredeploy.json) |
...
- *Get_MSDefender365_Security_Alerts*: method=`post`, path=`/queryData`
...
> 📄 *Source: [Enrich-DynatraceAppSecAttackMSDefenderXDR/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Dynatrace/Playbooks/Enrich-DynatraceAppSecAttackMSDefenderXDR/readme.md)*

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_Compromised_account.json) |
...
| Table | Usage |
|:------|:------|
| [`GIBTIABPPhishingKit_CL`](../tables/gibtiabpphishingkit-cl.md) | write |

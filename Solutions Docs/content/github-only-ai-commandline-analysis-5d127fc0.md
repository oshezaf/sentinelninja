...
| [`openaiip`](../logic-apps/managed-openaiip.md) | Managed | 1 | 1 |
...
#### [`openaiip`](../logic-apps/managed-openaiip.md) (Managed)

| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| GPT3_Completes_your_prompt | post | `/v1/engines/text-davinci-003/completions` | — |

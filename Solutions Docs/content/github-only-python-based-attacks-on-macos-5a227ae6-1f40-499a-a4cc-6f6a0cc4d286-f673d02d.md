...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Execution/python-based-attacks-on-macos.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `InitiatingProcessParentFileName in "Microsoft Excel,Microsoft Word"`<br>`ProcessCommandLine matchesregex "[A-Za-z0-9]{50}"` | ✓ | ✗ | ? |

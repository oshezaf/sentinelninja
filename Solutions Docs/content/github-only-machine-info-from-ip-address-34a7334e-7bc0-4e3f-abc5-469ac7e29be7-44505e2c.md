...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/General%20queries/Machine%20info%20from%20IP%20address.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceNetworkInfo`](../tables/devicenetworkinfo.md) | `ConnectedNetworks contains "corp.contoso.com"`<br>`DefaultGateways contains "\"`<br>`IPv4Dhcp == "10.164.3.12"`<br>`NetworkAdapterStatus == "Up"` | ✓ | ✗ | ? |

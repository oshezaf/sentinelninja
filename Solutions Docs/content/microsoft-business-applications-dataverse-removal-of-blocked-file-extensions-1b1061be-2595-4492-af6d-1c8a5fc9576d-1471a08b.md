...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20Business%20Applications/Analytic%20Rules/Dataverse%20-%20Removal%20of%20blocked%20file%20extensions.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DataverseActivity`](../tables/dataverseactivity.md) | `EntityName == "organization"`<br>`Message == "Update"` | ✓ | ✗ | ? |

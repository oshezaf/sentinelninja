...
The policy detects shadow admin users in AWS or Azure.
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Authomize/Analytic%20Rules/IaaS_shadow_admin_detected.yaml) |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/RemoteManagementMonitoring/rmm_TeamViewer_netconn.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceNetworkEvents`](../tables/devicenetworkevents.md) | `InitiatingProcessVersionInfoCompanyName has "TeamViewer"`<br>`RemoteUrl has_any "teamviewer.com"` | ✓ | ✗ | ? |

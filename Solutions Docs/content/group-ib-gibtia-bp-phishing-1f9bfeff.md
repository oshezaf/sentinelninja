...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Group-IB/Playbooks/azuredeploy-GIBTIA_BP_phishing.json) |
...
| Table | Usage |
|:------|:------|
| [`GIBTIABPPhishing_CL`](../tables/gibtiabpphishing-cl.md) | write |

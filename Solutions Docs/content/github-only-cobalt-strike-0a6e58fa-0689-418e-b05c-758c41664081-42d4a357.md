...
| **Tactics** | Initial access, Credential Access, Malware, component |
| **Required Connectors** | [MicrosoftThreatProtection](../connectors/microsoftthreatprotection.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Credential%20Access/cobalt-strike.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AlertInfo`](../tables/alertinfo.md) | `Title in "Event log was cleared,File backups were deleted,Suspicious decoded content,\,malware was detected"` | ✓ | ✗ | ? |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/Get-ASCRecommendations/alert-trigger/azuredeploy.json) |
...
**`http`** (builtin):
- *HTTP*: method=`GET`, uri=`https://management.azure.com/@{items('For_each')?['AzureID']}/providers/Microsoft.Security/assessments?api-version=2020-01-01`

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Campaigns/StrRAT%20malware/StrRAT-AV-Discovery.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `InitiatingProcessCommandLine has "roaming"`<br>`InitiatingProcessFileName in "java.exe,javaw.exe"`<br>`ProcessCommandLine has "path antivirusproduct get displayname"` | ✓ | ✗ | ? |

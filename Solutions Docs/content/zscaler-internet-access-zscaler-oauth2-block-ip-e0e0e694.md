...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2BlockIP/azuredeploy.json) |
...
**`http`** (builtin):
- *HTTP_Add_IP*: method=`PUT`, uri=`https://api.zsapi.net/zia/api/v1/urlCategories/@{variables('Category')}?action=ADD_TO_LIST`
...
> 📄 *Source: [Oauth2BlockIP/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Zscaler%20Internet%20Access/Playbooks/Oauth2BlockIP/readme.md)*

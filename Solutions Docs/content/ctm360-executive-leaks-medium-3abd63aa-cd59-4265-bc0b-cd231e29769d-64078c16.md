...
New Executive Leaks with severity Medium found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `3abd63aa-cd59-4265-bc0b-cd231e29769d` |
| **Severity** | Medium |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/executive_leaks_medium.yaml) |

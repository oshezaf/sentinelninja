...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Detections/AuditLogs/ApplicationIDURIChanged.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AuditLogs`](../tables/auditlogs.md) | `OperationName has_any "Update Application,Update Service principal"`<br>`TargetResources has "AppIdentifierUri"` | ✓ | ✗ | ✓ |

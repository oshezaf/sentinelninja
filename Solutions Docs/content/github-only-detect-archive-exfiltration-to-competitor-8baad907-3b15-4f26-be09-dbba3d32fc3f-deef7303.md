...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceFileEvents`](../tables/devicefileevents.md) | `InitiatingProcessFileName in "7z.exe,7zG.exe,AxCrypt.exe,BitLocker.exe,Diskcryptor.exe,GNUPrivacyGuard.exe,GPG4Win.exe,PeaZip.exe,VeraCrypt.exe,WinRAR.exe,WinZip.exe"` | ✓ | ✗ | ? |

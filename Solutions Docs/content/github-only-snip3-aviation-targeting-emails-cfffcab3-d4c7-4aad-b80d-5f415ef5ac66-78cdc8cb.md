...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Campaigns/snip3-aviation-targeting-emails.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`EmailEvents`](../tables/emailevents.md) | `EmailDirection == "Inbound"`<br>`SenderIPv4 == "192.145.239.18"` | ✓ | ✗ | ? |

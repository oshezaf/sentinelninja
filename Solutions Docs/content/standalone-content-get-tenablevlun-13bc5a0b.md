...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| HTTP_2 | GET | `https://cloud.tenable.com/workbenches/assets/@{items('For_each')?['id']}/vulnerabilities` | — |
| HTTP | GET | `https://cloud.tenable.com/workbenches/assets/vulnerabilities` | — |

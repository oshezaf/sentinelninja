...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Hybrid%20Attack%20-%20Cloud%20%26%20Identity/Hunting%20Queries/Persistence/service-principal-conditional-access-anomaly.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`AADServicePrincipalSignInLogs`](../tables/aadserviceprincipalsigninlogs.md) | `ConditionalAccessStatus in "failure,notApplied"`<br>`ResultType in "0,Success"` | ✓ | ✗ | ✓ |

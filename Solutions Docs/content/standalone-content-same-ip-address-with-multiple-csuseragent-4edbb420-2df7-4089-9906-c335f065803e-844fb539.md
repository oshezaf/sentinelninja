...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`W3CIISLog`](../tables/w3ciislog.md) | `cIP != "::1"`<br>`cIP !startswith "127."`<br>`cIP !startswith "192.168."`<br>`cIP !startswith "::"`<br>`cIP !startswith "fe80"`<br>`scStatus !startswith "20"`<br>`scStatus !startswith "30"` | ✓ | ✗ | ✗ |

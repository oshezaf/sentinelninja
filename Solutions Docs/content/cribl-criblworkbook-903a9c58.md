...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Cribl/Workbooks/CriblWorkbook.json) |
...
↑ [Back to Workbooks](workbooks.md) · [Back to Cribl](../solutions/cribl.md)

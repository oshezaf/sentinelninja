...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessCommandLine contains "New-MailboxExportRequest"`<br>`ProcessCommandLine contains "Remove-MailboxExportRequest"` | ✓ | ✗ | ? |

...
- *Get_CVE_Findings*: method=`POST`, uri=`@parameters('TaniumApiGatewayApi')`
...
> 📄 *Source: [Tanium-ComplyFindings/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tanium/Playbooks/Tanium-ComplyFindings/readme.md)*

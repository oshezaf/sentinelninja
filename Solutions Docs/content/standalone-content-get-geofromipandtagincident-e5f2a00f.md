...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/Get-GeoFromIpAndTagIncident/alert-trigger/azuredeploy.json) |
...
| [`IP-API`](../logic-apps/custom-ip-api.md) | Custom | 1 | 1 |
...
#### [`IP-API`](../logic-apps/custom-ip-api.md) (Custom)

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox%20Cloud%20Data%20Connector/Playbooks/Infoblox-Import-URLs-Hourly/azuredeploy.json) |
...
- *Get_TIDE_Data*: method=`GET`, uri=`https://csp.infoblox.com/tide/api/data/threats/url/hourly`

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Playbooks/AS-MDE-Unisolate-Machine/azuredeploy.json) |
...
**`http`** (builtin):
- *HTTP_-_Unisolate_Machine*: method=`POST`, uri=`https://api.securitycenter.microsoft.com/api/machines/@{items('For_each_-_Host')?['additionalData']?['MdatpDeviceId']}/unisolate`

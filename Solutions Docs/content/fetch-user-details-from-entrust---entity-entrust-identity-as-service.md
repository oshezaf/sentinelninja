...
This playbook provides the user essential details in comments section of incident so that SOC analysts can directly take corrective measure to stop the attack from unknown/compromised entity

| Attribute | Value |
|:----------|:------|
| **Type** | Playbook |
| **Solution** | [Entrust identity as Service](../solutions/entrust-identity-as-service.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks/Entrust-EnrichUser-EntityTrigger/azuredeploy.json) |

## Additional Documentation

> 📄 *Source: [EntrustPlaybooks/Entrust-EnrichUser-EntityTrigger/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks/Entrust-EnrichUser-EntityTrigger/readme.md)*
...
# Entrust-Enrichment of User Details Playbook - entity
 ...
 2. Adds a rich comment to the incident associated with entity with all the collected information
    ![Comment example](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks%5CEntrust-EnrichUser-EntityTrigger/Images/Entrust-EnrichUser-EntityTrigger_incident_comment.png)

![Playbook Designer view](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Entrust%20identity%20as%20Service/Playbooks/EntrustPlaybooks%5CEntrust-EnrichUser-EntityTrigger/Images/Entrust-EnrichUser-EntityTrigger.png)<br>
...
- [← Back to Entrust identity as Service](../solutions/entrust-identity-as-service.md)

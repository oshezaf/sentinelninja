...
Identifies STS token usage from an EKS-hosted EC2 instance that originates outside AWS IP ranges, which may indicate token hijacking via SSRF or credential theft.
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Amazon%20Web%20Services/Hunting%20Queries/AWS_STStoKWN.yaml) |

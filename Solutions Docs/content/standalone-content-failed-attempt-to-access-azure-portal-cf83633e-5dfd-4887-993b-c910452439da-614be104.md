...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/SigninLogs/UnauthUser_AzurePortal.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`SigninLogs`](../tables/signinlogs.md) | `AppDisplayName contains "Azure Portal"`<br>`ResultType in "50020,50126"` | ✓ | ✗ | ? |

...
This alert creates an incident when Blocks specific strings of text Policy Violation detected from the Guardian.

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [AIShield AI Security Monitoring](../solutions/aishield-ai-security-monitoring.md) |
| **ID** | `9c63e0b5-bb83-4873-947a-4385386a6c21` |
| **Severity** | Low |
| **Status** | Available |
| **Kind** | Scheduled |
| **Required Connectors** | [BoschAIShield](../connectors/boschaishield.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AIShield%20AI%20Security%20Monitoring/Analytic%20Rules/BlockSubstringVulDetection.yaml) |

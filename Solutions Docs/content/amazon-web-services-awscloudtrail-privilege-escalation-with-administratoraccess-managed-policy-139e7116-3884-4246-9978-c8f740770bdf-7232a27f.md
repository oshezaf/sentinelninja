...
Detects successful attachment of the AWS managed AdministratorAccess policy to users, roles, or groups. This action can immediately grant full administrative permissions and is a high-risk privilege escalation pattern that should be validated against approved administrative activity.

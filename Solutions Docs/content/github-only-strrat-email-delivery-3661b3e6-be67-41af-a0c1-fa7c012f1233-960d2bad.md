...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/Campaigns/StrRAT%20malware/StrRAT-Email-Delivery.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`EmailUrlInfo`](../tables/emailurlinfo.md) | `UrlDomain has_any "metroscaffingltg.co.uk"` | ✓ | ✗ | ? |

...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| Get_Network_Appliance_Content_Filtering | get | `/networks/@{encodeURIComponent(outputs('Compose_Network_Id'))}/appliance/contentFiltering` | — |
| Update_Network_Appliance_Content_Filtering | put | `/networks/@{encodeURIComponent(outputs('Compose_Network_Id'))}/appliance/contentFiltering` | — |

...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Oracle%20Cloud%20Infrastructure/Hunting%20Queries/OCIUserTerminatedInstances.yaml) |
...
↑ [Back to Hunting Queries](hunting-queries.md) · [Back to Oracle Cloud Infrastructure](../solutions/oracle-cloud-infrastructure.md)

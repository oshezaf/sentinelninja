...
This playbook uses Druva-Ransomware-Response capabilities to stop the spread of ransomware and avoid reinfection or contamination spread in your enterprise workload

| Attribute | Value |
|:----------|:------|
| **Type** | Playbook |
| **Solution** | [DruvaDataSecurityCloud](../solutions/druvadatasecuritycloud.md) |
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/DruvaDataSecurityCloud/Playbooks/DruvaQuarantineEnterpriseWorkload/azuredeploy.json) |
...
- *Find_Device*: method=`GET`, uri=`@{parameters('api_host')}/realize/ransomwarerecovery/v1/search/backupset`
- *Find_VM_Device*: method=`GET`, uri=`@{parameters('api_host')}/realize/ransomwarerecovery/v1/search/backupset`
- *Quarantine_VM_API*: method=`POST`, uri=`@{parameters('api_host')}/realize/ransomwarerecovery/v1/quarantineranges/resource/@{item()?['resourceID']}`

</details>

## Additional Documentation

> 📄 *Source: [DruvaQuarantineEnterpriseWorkload/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/DruvaDataSecurityCloud/Playbooks/DruvaQuarantineEnterpriseWorkload/readme.md)*

# Druva Quarantine Enterprise Workload Resource
...
↑ [Back to Playbooks](playbooks.md) · [Back to DruvaDataSecurityCloud](../solutions/druvadatasecuritycloud.md)

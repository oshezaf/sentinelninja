...
| Find_Device | GET | `@{parameters('api_host')}/realize/ransomwarerecovery/v1/search/backupset` | — |
| Find_VM_Device | GET | `@{parameters('api_host')}/realize/ransomwarerecovery/v1/search/backupset` | — |
| Quarantine_VM_API | POST | `@{parameters('api_host')}/realize/ransomwarerecovery/v1/quarantineranges/resource/@{item()?['resourceID']}` | — |

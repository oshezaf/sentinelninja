...
New Survey Scam with severity Low found

| Attribute | Value |
|:----------|:------|
| **Type** | Analytic Rule |
| **Solution** | [CTM360](../solutions/ctm360.md) |
| **ID** | `9aa3493b-3f9c-44a4-acb8-455de0523924` |
| **Severity** | Low |
| **Status** | Available |
| **Kind** | Scheduled |
...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CTM360/Analytic%20Rules/survey_scam_low.yaml) |

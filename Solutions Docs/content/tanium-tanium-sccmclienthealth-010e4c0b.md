...
- *Get_SCCM_Client_Health*: method=`POST`, uri=`@parameters('TaniumApiGatewayApi')`
...
> 📄 *Source: [Tanium-SCCMClientHealth/readme.md](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Tanium/Playbooks/Tanium-SCCMClientHealth/readme.md)*

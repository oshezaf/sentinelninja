...
This playbook can be triggered manually from an IP Address Entity context to fetch geo location and running services details from Shodan.io.
...
| [`ShodanCustomConnector`](../logic-apps/custom-shodancustomconnector.md) | Custom | 1 | 1 |
...
| Action | Method | Endpoint | Other |
|:-------|:-------|:---------|:------|
| GetServiceDetailsForIP | get | `/shodan/host/@{encodeURIComponent(triggerBody()?['Entity']?['properties']?['Address'])}` | — |

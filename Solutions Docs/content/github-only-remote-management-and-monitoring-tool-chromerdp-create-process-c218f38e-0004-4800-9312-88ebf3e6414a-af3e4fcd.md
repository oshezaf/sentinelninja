...
| **Source** | [View on GitHub](https://github.com/Azure/Azure-Sentinel/blob/master/Hunting Queries/Microsoft%20365%20Defender/RemoteManagementMonitoring/rmm_ChromeRDP_createproc.yaml) |
...
|:------|:-------------|:---------------:|:-------------:|:---------:|
| [`DeviceProcessEvents`](../tables/deviceprocessevents.md) | `ProcessVersionInfoCompanyName has "Google"`<br>`ProcessVersionInfoProductName has "Chrome Remote Desktop"` | ✓ | ✗ | ? |

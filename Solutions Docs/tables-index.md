...
This page lists **1695 unique tables** (815 ingested by connectors, 880 referenced by content only).
...
| [`AADServicePrincipalSignInLogs`](tables/aadserviceprincipalsigninlogs.md) | [CybersecurityMaturityModelCertification(CMMC)2.0](solutions/cybersecuritymaturitymodelcertification-cmmc-2.0.md)<br>[Lumen Defender Threat Feed](solutions/lumen-defender-threat-feed.md)<br>[MaturityModelForEventLogManagementM2131](solutions/maturitymodelforeventlogmanagementm2131.md)<br>[+2 more](tables/aadserviceprincipalsigninlogs.md) | [Microsoft Entra ID](connectors/azureactivedirectory.md) |
...
| [`ALERT`](tables/alert.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[GreyNoiseThreatIntelligence](solutions/greynoisethreatintelligence.md)<br>[+7 more](tables/alert.md) |  |
...
| [`ASimNetworkSessionLogs`](tables/asimnetworksessionlogs.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Cisco Meraki Events via REST API](solutions/cisco-meraki-events-via-rest-api.md)<br>[CrowdStrike Falcon Endpoint Protection](solutions/crowdstrike-falcon-endpoint-protection.md)<br>[+12 more](tables/asimnetworksessionlogs.md) | [Cisco Meraki (using REST API)](connectors/ciscomerakimultirule.md)<br>[CrowdStrike Falcon Data Replicator (CrowdStrike Managed AWS-S3)](connectors/crowdstrikereplicatorv2.md)<br>[Windows Firewall Events via AMA](connectors/windowsfirewallama.md)<br>[VMware Carbon Black Cloud via AWS S3](connectors/carbonblackawss3.md) |
| [`ASimProcessEventLogs`](tables/asimprocesseventlogs.md) | [CrowdStrike Falcon Endpoint Protection](solutions/crowdstrike-falcon-endpoint-protection.md)<br>[Endpoint Threat Protection Essentials](solutions/endpoint-threat-protection-essentials.md)<br>[Lumen Defender Threat Feed](solutions/lumen-defender-threat-feed.md)<br>[+3 more](tables/asimprocesseventlogs.md) | [CrowdStrike Falcon Data Replicator (CrowdStrike Managed AWS-S3)](connectors/crowdstrikereplicatorv2.md)<br>[VMware Carbon Black Cloud via AWS S3](connectors/carbonblackawss3.md) |
...
| [`AWSVPCFlow`](tables/awsvpcflow.md) | [AWS VPC Flow Logs](solutions/aws-vpc-flow-logs.md)<br>[Amazon Web Services](solutions/amazon-web-services.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[+11 more](tables/awsvpcflow.md) | [Amazon Web Services S3 VPC Flow Logs](connectors/awss3vpcflowlogsparquetdefinition.md)<br>[Amazon Web Services S3](connectors/awss3.md) |
...
| [`AZFWApplicationRule`](tables/azfwapplicationrule.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Azure Firewall](solutions/azure-firewall.md)<br>[GDPR Compliance & Data Security](solutions/gdpr-compliance-&-data-security.md)<br>[+7 more](tables/azfwapplicationrule.md) | [Azure Firewall](connectors/azurefirewall.md) |
...
| [`AZFWIdpsSignature`](tables/azfwidpssignature.md) | [Azure Firewall](solutions/azure-firewall.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+8 more](tables/azfwidpssignature.md) | [Azure Firewall](connectors/azurefirewall.md) |
...
| [`AZFWNatRule`](tables/azfwnatrule.md) | [Azure Firewall](solutions/azure-firewall.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+8 more](tables/azfwnatrule.md) | [Azure Firewall](connectors/azurefirewall.md) |
| [`AZFWNatRuleAggregation`](tables/azfwnatruleaggregation.md) |  |  |
| [`AZFWNetworkRule`](tables/azfwnetworkrule.md) | [Azure Firewall](solutions/azure-firewall.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+8 more](tables/azfwnetworkrule.md) | [Azure Firewall](connectors/azurefirewall.md) |
| [`AZFWNetworkRuleAggregation`](tables/azfwnetworkruleaggregation.md) |  |  |
| [`AZFWThreatIntel`](tables/azfwthreatintel.md) | [Azure Firewall](solutions/azure-firewall.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+8 more](tables/azfwthreatintel.md) | [Azure Firewall](connectors/azurefirewall.md) |
...
| [`Anomalies`](tables/anomalies.md) | [Microsoft Entra ID](solutions/microsoft-entra-id.md)<br>[PCI DSS Compliance](solutions/pci-dss-compliance.md)<br>[SOC Handbook](solutions/soc-handbook.md)<br>[+1 more](tables/anomalies.md) |  |
...
| [`ApacheHTTPServer_CL`](tables/apachehttpserver-cl.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[ApacheHTTPServer](solutions/apachehttpserver.md)<br>[CustomLogsAma](solutions/customlogsama.md)<br>[+8 more](tables/apachehttpserver-cl.md) | [[Deprecated] Apache HTTP Server](connectors/apachehttpserver.md)<br>[Custom logs via AMA](connectors/customlogsviaama.md) |
...
| [`AzureActivity`](tables/azureactivity.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Azure Activity](solutions/azure-activity.md)<br>[Azure SQL Database solution for sentinel](solutions/azure-sql-database-solution-for-sentinel.md)<br>[+14 more](tables/azureactivity.md) | [Azure Activity](connectors/azureactivity.md) |
...
| [`AzureDiagnostics`](tables/azurediagnostics.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Azure Batch Account](solutions/azure-batch-account.md)<br>[Azure Cognitive Search](solutions/azure-cognitive-search.md)<br>[+38 more](tables/azurediagnostics.md) | [Azure Batch Account](connectors/azurebatchaccount-ccp.md)<br>[Azure Cognitive Search](connectors/azurecognitivesearch-ccp.md)<br>[Azure Data Lake Storage Gen1](connectors/azuredatalakestoragegen1-ccp.md)<br>[Azure Event Hub](connectors/azureeventhub-ccp.md)<br>[Azure Firewall](connectors/azurefirewall.md)<br>[+10 more](tables/azurediagnostics.md) |
...
| [`AzureNetworkAnalytics_CL`](tables/azurenetworkanalytics-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Cloud Service Threat Protection Essentials](solutions/cloud-service-threat-protection-essentials.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+9 more](tables/azurenetworkanalytics-cl.md) |  |
...
| [`alert`](tables/alert.md) | [Azure Cloud NGFW By Palo Alto Networks](solutions/azure-cloud-ngfw-by-palo-alto-networks.md)<br>[NISTSP80053](solutions/nistsp80053.md)<br>[PaloAlto-PAN-OS](solutions/paloalto-pan-os.md)<br>[+3 more](tables/alert.md) |  |
...
| [`anomalies`](tables/anomalies.md) | [DNS Essentials](solutions/dns-essentials.md)<br>[GDPR Compliance & Data Security](solutions/gdpr-compliance-&-data-security.md)<br>[Microsoft Entra ID](solutions/microsoft-entra-id.md)<br>[+4 more](tables/anomalies.md) |  |
...
| [`barracuda_CL`](tables/barracuda-cl.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Barracuda WAF](solutions/barracuda-waf.md)<br>[+13 more](tables/barracuda-cl.md) | [[Deprecated] Barracuda Web Application Firewall via Legacy Agent](connectors/barracuda.md) |
...
| [`CarbonBlackEvents_CL`](tables/carbonblackevents-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Endpoint Threat Protection Essentials](solutions/endpoint-threat-protection-essentials.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+10 more](tables/carbonblackevents-cl.md) | [VMware Carbon Black Cloud](connectors/vmwarecarbonblack.md) |
| [`CarbonBlackNotifications_CL`](tables/carbonblacknotifications-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Endpoint Threat Protection Essentials](solutions/endpoint-threat-protection-essentials.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+10 more](tables/carbonblacknotifications-cl.md) | [VMware Carbon Black Cloud](connectors/vmwarecarbonblack.md) |
...
| [`Corelight_CL`](tables/corelight-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Corelight](solutions/corelight.md)<br>[DNS Essentials](solutions/dns-essentials.md)<br>[+9 more](tables/corelight-cl.md) | [Corelight Connector Exporter](connectors/corelightconnectorexporter.md) |
...
| [`DeviceLogonEvents`](tables/devicelogonevents.md) | [ContinuousDiagnostics&Mitigation](solutions/continuousdiagnostics&mitigation.md)<br>[FalconFriday](solutions/falconfriday.md)<br>[Microsoft Defender XDR](solutions/microsoft-defender-xdr.md)<br>[+1 more](tables/devicelogonevents.md) | [Microsoft Defender XDR](connectors/microsoftthreatprotection.md) |
| [`DeviceNetworkEvents`](tables/devicenetworkevents.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Cyware](solutions/cyware.md)<br>[+15 more](tables/devicenetworkevents.md) | [Microsoft Defender XDR](connectors/microsoftthreatprotection.md) |
...
| [`DeviceProcessEvents`](tables/deviceprocessevents.md) | [Attacker Tools Threat Protection Essentials](solutions/attacker-tools-threat-protection-essentials.md)<br>[Cyware](solutions/cyware.md)<br>[Dev 0270 Detection and Hunting](solutions/dev-0270-detection-and-hunting.md)<br>[+10 more](tables/deviceprocessevents.md) | [Microsoft Defender XDR](connectors/microsoftthreatprotection.md) |
| [`DeviceRegistryEvents`](tables/deviceregistryevents.md) | [FalconFriday](solutions/falconfriday.md)<br>[Malware Protection Essentials](solutions/malware-protection-essentials.md)<br>[Microsoft Defender XDR](solutions/microsoft-defender-xdr.md)<br>[+2 more](tables/deviceregistryevents.md) | [Microsoft Defender XDR](connectors/microsoftthreatprotection.md) |
...
| [`DnsEvents`](tables/dnsevents.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Attacker Tools Threat Protection Essentials](solutions/attacker-tools-threat-protection-essentials.md)<br>[DNS Essentials](solutions/dns-essentials.md)<br>[+13 more](tables/dnsevents.md) | [DNS](connectors/dns.md) |
...
| [`Dynamics365Activity`](tables/dynamics365activity.md) | [Dynamics 365](solutions/dynamics-365.md)<br>[MaturityModelForEventLogManagementM2131](solutions/maturitymodelforeventlogmanagementm2131.md)<br>[NISTSP80053](solutions/nistsp80053.md)<br>[+1 more](tables/dynamics365activity.md) | [Dynamics 365](connectors/dynamics365.md) |
...
| [`Heartbeat`](tables/heartbeat.md) | [CiscoASA](solutions/ciscoasa.md)<br>[DORA Compliance](solutions/dora-compliance.md)<br>[Forcepoint NGFW](solutions/forcepoint-ngfw.md)<br>[+6 more](tables/heartbeat.md) | [Cisco ASA/FTD via AMA](connectors/ciscoasaama.md) |
...
| [`IdentityInfo`](tables/identityinfo.md) | [Azure Activity](solutions/azure-activity.md)<br>[Business Email Compromise - Financial Fraud](solutions/business-email-compromise-financial-fraud.md)<br>[Cloud Identity Threat Protection Essentials](solutions/cloud-identity-threat-protection-essentials.md)<br>[+13 more](tables/identityinfo.md) |  |
...
| [`Illumio_Flow_Events_CL`](tables/illumio-flow-events-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[GreyNoiseThreatIntelligence](solutions/greynoisethreatintelligence.md)<br>[+8 more](tables/illumio-flow-events-cl.md) | [Illumio SaaS](connectors/illumiosaasdataconnector.md) |
...
| [`InsightsMetrics`](tables/insightsmetrics.md) | [MaturityModelForEventLogManagementM2131](solutions/maturitymodelforeventlogmanagementm2131.md) |  |
...
| [`meraki_CL`](tables/meraki-cl.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[CiscoMeraki](solutions/ciscomeraki.md)<br>[+14 more](tables/meraki-cl.md) | [[Deprecated] Cisco Meraki](connectors/ciscomeraki.md)<br>[Cisco Meraki (using REST API)](connectors/ciscomeraki-usingrestapi.md)<br>[Cisco Meraki (using REST API)](connectors/ciscomerakinativepoller.md)<br>[Custom logs via AMA](connectors/customlogsviaama.md) |
...
| [`NTANetAnalytics`](tables/ntanetanalytics.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[GreyNoiseThreatIntelligence](solutions/greynoisethreatintelligence.md)<br>[+7 more](tables/ntanetanalytics.md) |  |
...
| [`Operation`](tables/operation.md) | [Azure SQL Database solution for sentinel](solutions/azure-sql-database-solution-for-sentinel.md)<br>[GDPR Compliance & Data Security](solutions/gdpr-compliance-&-data-security.md)<br>[Global Secure Access](solutions/global-secure-access.md)<br>[+10 more](tables/operation.md) |  |
...
| [`SQLSecurityAuditEvents`](tables/sqlsecurityauditevents.md) | [Azure SQL Database solution for sentinel](solutions/azure-sql-database-solution-for-sentinel.md)<br>[GDPR Compliance & Data Security](solutions/gdpr-compliance-&-data-security.md) |  |
...
| [`SecurityAlert`](tables/securityalert.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Azure Key Vault](solutions/azure-key-vault.md)<br>[Azure SQL Database solution for sentinel](solutions/azure-sql-database-solution-for-sentinel.md)<br>[+42 more](tables/securityalert.md) | [Microsoft Entra ID Protection](connectors/azureactivedirectoryidentityprotection.md)<br>[Microsoft Defender for Identity](connectors/azureadvancedthreatprotection.md)<br>[Subscription-based Microsoft Defender for Cloud (Legacy)](connectors/azuresecuritycenter.md)<br>[Microsoft Defender for IoT](connectors/iot.md)<br>[Microsoft Defender for Cloud Apps](connectors/microsoftcloudappsecurity.md)<br>[+5 more](tables/securityalert.md) |
...
| [`SecurityIoTRawEvent`](tables/securityiotrawevent.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Endpoint Threat Protection Essentials](solutions/endpoint-threat-protection-essentials.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[+9 more](tables/securityiotrawevent.md) |  |
...
| [`SentinelOne_CL`](tables/sentinelone-cl.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[DNS Essentials](solutions/dns-essentials.md)<br>[Endpoint Threat Protection Essentials](solutions/endpoint-threat-protection-essentials.md)<br>[+11 more](tables/sentinelone-cl.md) | [SentinelOne](connectors/sentinelone.md) |
...
| [`SquidProxy_CL`](tables/squidproxy-cl.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[CustomLogsAma](solutions/customlogsama.md)<br>[GDPR Compliance & Data Security](solutions/gdpr-compliance-&-data-security.md)<br>[+8 more](tables/squidproxy-cl.md) | [Custom logs via AMA](connectors/customlogsviaama.md)<br>[[Deprecated] Squid Proxy](connectors/squidproxy.md) |
| [`StorageBlobLogs`](tables/storagebloblogs.md) | [Azure Storage](solutions/azure-storage.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[Malware Protection Essentials](solutions/malware-protection-essentials.md)<br>[+3 more](tables/storagebloblogs.md) | [Azure Storage Account](connectors/azurestorageaccount.md) |
...
| [`StorageFileLogs`](tables/storagefilelogs.md) | [Azure Storage](solutions/azure-storage.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[Malware Protection Essentials](solutions/malware-protection-essentials.md)<br>[+2 more](tables/storagefilelogs.md) | [Azure Storage Account](connectors/azurestorageaccount.md) |
...
| [`StorageTableLogs`](tables/storagetablelogs.md) | [Azure Storage](solutions/azure-storage.md)<br>[Google Threat Intelligence](solutions/google-threat-intelligence.md)<br>[Malware Protection Essentials](solutions/malware-protection-essentials.md)<br>[+1 more](tables/storagetablelogs.md) | [Azure Storage Account](connectors/azurestorageaccount.md) |
...
| [`Syslog`](tables/syslog.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[Barracuda CloudGen Firewall](solutions/barracuda-cloudgen-firewall.md)<br>[+61 more](tables/syslog.md) | [[Deprecated] Barracuda CloudGen Firewall](connectors/barracudacloudfirewall.md)<br>[[Deprecated] Blackberry CylancePROTECT](connectors/blackberrycylanceprotect.md)<br>[CTERA Syslog](connectors/ctera.md)<br>[[Deprecated] Cisco Application Centric Infrastructure](connectors/ciscoaci.md)<br>[[Deprecated] Cisco Identity Services Engine](connectors/ciscoise.md)<br>[+33 more](tables/syslog.md) |
...
| [`UPDATE`](tables/update.md) | [Infoblox](solutions/infoblox.md)<br>[Infoblox Cloud Data Connector](solutions/infoblox-cloud-data-connector.md) |  |
...
| [`Update`](tables/update.md) | [Azure Activity](solutions/azure-activity.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[CybersecurityMaturityModelCertification(CMMC)2.0](solutions/cybersecuritymaturitymodelcertification-cmmc-2.0.md)<br>[+17 more](tables/update.md) |  |
...
| [`update`](tables/update.md) | [AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[CybersecurityMaturityModelCertification(CMMC)2.0](solutions/cybersecuritymaturitymodelcertification-cmmc-2.0.md)<br>[MaturityModelForEventLogManagementM2131](solutions/maturitymodelforeventlogmanagementm2131.md)<br>[+2 more](tables/update.md) |  |
...
| [`VMConnection`](tables/vmconnection.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[Attacker Tools Threat Protection Essentials](solutions/attacker-tools-threat-protection-essentials.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[+14 more](tables/vmconnection.md) |  |
...
| [`VectraStream_CL`](tables/vectrastream-cl.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[CustomLogsAma](solutions/customlogsama.md)<br>[+15 more](tables/vectrastream-cl.md) | [AI Vectra Stream via Legacy Agent](connectors/aivectrastream.md)<br>[Custom logs via AMA](connectors/customlogsviaama.md) |
...
| [`Watchlist`](tables/watchlist.md) | [Apache Log4j Vulnerability Detection](solutions/apache-log4j-vulnerability-detection.md)<br>[MicrosoftPurviewInsiderRiskManagement](solutions/microsoftpurviewinsiderriskmanagement.md)<br>[Web Session Essentials](solutions/web-session-essentials.md) |  |
...
| [`WindowsEvent`](tables/windowsevent.md) | [Attacker Tools Threat Protection Essentials](solutions/attacker-tools-threat-protection-essentials.md)<br>[AzureSecurityBenchmark](solutions/azuresecuritybenchmark.md)<br>[DNS Essentials](solutions/dns-essentials.md)<br>[+16 more](tables/windowsevent.md) | [Windows Forwarded Events](connectors/windowsforwardedevents.md) |
| [`WindowsFirewall`](tables/windowsfirewall.md) | [Malware Protection Essentials](solutions/malware-protection-essentials.md)<br>[MaturityModelForEventLogManagementM2131](solutions/maturitymodelforeventlogmanagementm2131.md)<br>[NISTSP80053](solutions/nistsp80053.md)<br>[+3 more](tables/windowsfirewall.md) | [Windows Firewall](connectors/windowsfirewall.md) |
...
| [`watchlist`](tables/watchlist.md) | [HIPAA Compliance](solutions/hipaa-compliance.md)<br>[PCI DSS Compliance](solutions/pci-dss-compliance.md)<br>[Veeam](solutions/veeam.md) |  |

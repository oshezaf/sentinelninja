...
Reference for MAWindowsBuildInfo table in Azure Monitor Logs.
...
- [MAWindowsBuildInfo Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/mawindowsbuildinfo)

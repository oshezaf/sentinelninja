...
|:------------|:-----|:------------|
| AverageDurationDays | real | Average duration in days for observations. |
...
| ObservationCount | int | Total number of observations for this risk vector in the measurement period. |

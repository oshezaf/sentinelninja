...
Reference for AmlPipelineEvent table in Azure Monitor Logs.
...
- [AmlPipelineEvent Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/amlpipelineevent)

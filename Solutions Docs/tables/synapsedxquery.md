...
Reference for SynapseDXQuery table in Azure Monitor Logs.
...
- [SynapseDXQuery Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/synapsedxquery)

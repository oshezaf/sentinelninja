...
- [PowerPlatformAdminActivity Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerplatformadminactivity)
...
| [Power Apps - Bulk sharing of Power Apps to newly created guest users](../content/microsoft-business-applications-power-apps-bulk-sharing-of-power-apps-to-newly-created-guest-users-943acfa0-9285-4eb0-a9c0-42e36177ef19-41b30b81.md) | `EventOriginalType == "PowerAppPermissionEdited"` |
...
| [Power Platform - Connector added to a sensitive environment](../content/microsoft-business-applications-power-platform-connector-added-to-a-sensitive-environment-886a5655-3d12-42f1-8927-4095789c575e-025af1bc.md) | `EventOriginalType == "PutConnection"` |
...
**In solution [Microsoft Business Applications](../solutions/microsoft-business-applications.md):** `EventOriginalType == "PowerAppPermissionEdited"`<br>`SourceSystem == "Azure AD"`
...
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `EventOriginalType == "PowerAppPermissionEdited"` | - | 1 | - | - | **1** |
| `EventOriginalType == "PutConnection"` | - | 1 | - | - | **1** |
| `EventOriginalType == "PowerAppPermissionEdited"`<br>`SourceSystem == "Azure AD"` | - | 1 | - | - | **1** |
| **Total** | **0** | **3** | **0** | **0** | **3** |

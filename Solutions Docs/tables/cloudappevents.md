...
## Selection Criteria Summary (25 criteria, 65 total references)
...
| `ActionType == "FileMalwareDetected"` | - | 5 | - | - | **5** |
...
| `ActionType == "Set-AtpPolicyForO365"` | - | 1 | - | - | **1** |
...
| `ActionType in "Added users and/or groups to shared file/folder,Invited user to Dropbox`<br>`added them to shared file/folder"` | - | 1 | - | - | **1** |
| `ActionType in "AddedToSecureLink,SecureLinkCreated"` | - | 1 | - | - | **1** |

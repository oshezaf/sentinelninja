...
**Source:** [Azure Monitor documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/cloudappevents)
...
## Content Items Using This Table (182)
...
| [ATP policy status check](../content/github-only-atp-policy-status-check-518e6938-10ef-4165-af19-82f1287141bc-7b521f21.md) | `ActionType == "Set-AtpPolicyForO365"`<br>`Application == "Microsoft Exchange Online"` |
| [Add uncommon credential type to application [Nobelium]](../content/github-only-add-uncommon-credential-type-to-application-[nobelium]-63a191f4-a0ad-4ed7-b994-24ffc89b3596-aff5bb4b.md) | `ActionType in "Add service principal credentials.,Update application - Certificates`<br>`secrets management"`<br>`Application == "Office 365"` |
...
| [BEC - File sharing tactics - Dropbox](../content/github-only-bec-file-sharing-tactics-dropbox-6e056084-8951-460d-93f9-525880062de9-871269e7.md) | `ActionType in "Added users and/or groups to shared file/folder,Invited user to Dropbox`<br>`added them to shared file/folder"`<br>`Application == "Dropbox"`<br>`ObjectType == "File"` |
| [BEC - File sharing tactics - OneDrive or SharePoint](../content/github-only-bec-file-sharing-tactics-onedrive-or-sharepoint-cf8d2c27-8310-4b13-b135-1ba59ae0a3a2-fbbd5245.md) | `ActionType in "AddedToSecureLink,SecureLinkCreated"`<br>`Application in "Microsoft OneDrive for Business,Microsoft SharePoint Online"` |
...
| [Copilot Studio AI Agents - Dormant Author Authentication Connection](../content/github-only-copilot-studio-ai-agents-dormant-author-authentication-connection-2a5b8c1d-4e7f-0a1b-2c3d-4e5f6a7b8c9d-3500cbed.md) | `ActionType == "CopilotInteraction"` |
| [Copilot Studio AI Agents - Published Dormant (30d)](../content/github-only-copilot-studio-ai-agents-published-dormant-30d-5e8f1a2b-3c4d-5e6f-7a8b-9c0d1e2f3a4b-bdb68b50.md) | `ActionType == "CopilotInteraction"` |
| [CredentialsAddAfterAdminConsentedToApp[Nobelium]](../content/github-only-credentialsaddafteradminconsentedtoapp[nobelium]-0d49b34e-ac5a-441f-a79f-672ad045870e-006b3161.md) | `ActionType in "Add service principal credentials.,Consent to application.,Update application - Certificates`<br>`secrets management"`<br>`Application == "Office 365"` |
...
| [File Malware by Top Malware Families (Safe Attachments)](../content/github-only-file-malware-by-top-malware-families-safe-attachments-afd90d9e-f8f5-41c7-823a-616907392503-682bc828.md) | `ActionType == "FileMalwareDetected"`<br>`UserAgent == "MS Scanner ATP"` |
...
| [Identify acting user for reported phish](../content/github-only-identify-acting-user-for-reported-phish-a5888069-ad78-4ac5-9241-5ee83eb19d5d-a6696a99.md) |  |
...
| [MailItemsAccessedTimeSeries[Solarigate]](../content/github-only-mailitemsaccessedtimeseries[solarigate]-148de00b-e647-4767-9201-c3cbf51befb1-67d44b1f.md) | `ActionType == "MailItemsAccessed"`<br>`Application has "Exchange"` |
...
| [Multiple Entra ID Admin Removals](../content/github-only-multiple-entra-id-admin-removals-7ffb31ee-f164-4613-a9a7-4d04d0dba5d7-8058f067.md) | `ActionType in "Remove eligible member from role.,Remove member from role."`<br>`ApplicationId == "11161"` |
...
| [OAuth Apps accessing user mail via GraphAPI [Nobelium]](../content/github-only-oauth-apps-accessing-user-mail-via-graphapi-[nobelium]-19cbed50-3554-44ed-b8de-90f275b69c8a-0abcf539.md) | `ActionType == "MailItemsAccessed"`<br>`RawEventData has "00000003-0000-0000-c000-000000000000"`<br>`RawEventData has "ClientAppId"` |
...
| [ServicePrincipalAddedToRole [Nobelium]](../content/github-only-serviceprincipaladdedtorole-[nobelium]-ca7c93e0-49d3-44ff-b07e-ae117ba13c9a-529dc696.md) | `ActionType == "Add member to role."`<br>`Application == "Office 365"` |
...
| [UpdateStsRefreshToken[Solorigate]](../content/github-only-updatestsrefreshtoken[solorigate]-634dfbd6-0a42-40da-854e-2161cf137f14-89e3d513.md) | `ActionType == "Update StsRefreshTokenValidFrom Timestamp."`<br>`RawEventData !has "Directorysync"` |
...
| [DoDZeroTrustWorkbook](../content/github-only-dodzerotrustworkbook-844294c8.md) | `ActionType in "Add member to role,Add service principal.,Add user,InteractiveLogon,LogonSuccess,RemoteInteractiveLogon,Reset user password,ResourceAccess,Sign-in,Update user"` |
| [MicrosoftSentinelDeploymentandMigrationTracker](../content/github-only-microsoftsentineldeploymentandmigrationtracker-1aa72202.md) |  |
| [ZeroTrustStrategyWorkbook](../content/github-only-zerotruststrategyworkbook-cd80dc2b.md) | `ActionType in "Add member to role,Add service principal.,Add user,InteractiveLogon,LogonSuccess,RemoteInteractiveLogon,Reset user password,ResourceAccess,Sign-in,Update user"` |

## Selection Criteria Summary (40 criteria, 143 total references)

References by type: 0 connectors, 143 content items, 0 ASIM parsers, 0 other parsers.

| Selection Criteria | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `ActionType == "AdminSubmissionSubmitted"` | - | 30 | - | - | **30** |
| `ActionType == "UserSubmission"` | - | 24 | - | - | **24** |
| `ActionType == "FileMalwareDetected"` | - | 8 | - | - | **8** |
| `ActionType == "AdminSubmissionSubmitted"`<br>`ActionType contains "Submission"` | - | 8 | - | - | **8** |
| `ActionType == "MailItemsAccessed"` | - | 7 | - | - | **7** |
...
| `ActionType == "Set-AtpPolicyForO365"`<br>`Application == "Microsoft Exchange Online"` | - | 2 | - | - | **2** |
...
| `ActionType in "Added users and/or groups to shared file/folder,Invited user to Dropbox`<br>`added them to shared file/folder"`<br>`Application == "Dropbox"`<br>`ObjectType == "File"` | - | 2 | - | - | **2** |
| `ActionType in "AddedToSecureLink,SecureLinkCreated"`<br>`Application in "Microsoft OneDrive for Business,Microsoft SharePoint Online"` | - | 2 | - | - | **2** |
| `ActionType contains "Set-InboxRule"` | - | 2 | - | - | **2** |
| `ActionType == "FileMalwareDetected"`<br>`UserAgent == "MS Scanner ATP"` | - | 2 | - | - | **2** |
...
| `ActionType == "MailItemsAccessed"`<br>`Application has "Exchange"` | - | 1 | - | - | **1** |
...
| `ActionType == "Update StsRefreshTokenValidFrom Timestamp."`<br>`RawEventData !has "Directorysync"` | - | 1 | - | - | **1** |
| `ActionType == "MailItemsAccessed"`<br>`RawEventData has "00000003-0000-0000-c000-000000000000"`<br>`RawEventData has "ClientAppId"` | - | 1 | - | - | **1** |
| `ActionType in "Add service principal credentials.,Update application - Certificates`<br>`secrets management"` | - | 1 | - | - | **1** |
| `ActionType in "Add service principal credentials.,Consent to application.,Update application - Certificates`<br>`secrets management"`<br>`Application == "Office 365"` | - | 1 | - | - | **1** |
| `ActionType in "Remove eligible member from role.,Remove member from role."`<br>`ApplicationId == "11161"` | - | 1 | - | - | **1** |
...
| `ActionType in "Add service principal credentials.,Update application - Certificates`<br>`secrets management"`<br>`Application == "Office 365"` | - | 1 | - | - | **1** |
| `ActionType == "Add member to role."`<br>`Application == "Office 365"` | - | 1 | - | - | **1** |
| `ActionType in "AdminSubmissionSubmitted,AttackSimUserSubmission,ClickBlocked,FileMalwareDetected,Malware ZAP,Phish ZAP,Spam ZAP,SubmissionNotification,UserSubmission"`<br>`ActionType == "Automated Remediation"`<br>`ActionType contains "AdminSubmission"`<br>`ActionType contains "AdminSubmissionTriage"`<br>`ActionType contains "Submission"`<br>`ActionType contains "UserSubmission"`<br>`ActionType contains "UserSubmissionTriage"`<br>`ActionType contains "ZAP"`<br>`ActionType has "Malware ZAP"`<br>`ActionType has "Phish ZAP"`<br>`ActionType has "Spam ZAP"`<br>`ActionType has "ZAP"`<br>`ActionType has_any "ClickAllowed"`<br>`ActionType has_any "ClickBlocked"`<br>`ActionType has_any "UrlErrorPage"`<br>`ActionType has_any "UrlScanInProgress"`<br>`UserAgent == "MS Scanner ATP"` | - | 1 | - | - | **1** |
| **Total** | **0** | **143** | **0** | **0** | **143** |
...
|:------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `Office 365` | - | 3 | - | - | **3** |
| `Microsoft Exchange Online` | - | 2 | - | - | **2** |
| `Dropbox` | - | 2 | - | - | **2** |
| `Microsoft OneDrive for Business` | - | 2 | - | - | **2** |
| `Microsoft SharePoint Online` | - | 2 | - | - | **2** |
| `has Exchange` | - | 1 | - | - | **1** |
...
| Value | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `!has Directorysync` | - | 1 | - | - | **1** |
| `has 00000003-0000-0000-c000-000000000000` | - | 1 | - | - | **1** |
| `has ClientAppId` | - | 1 | - | - | **1** |

...
Reference for DHOSCrashData table in Azure Monitor Logs.
...
- [DHOSCrashData Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/dhoscrashdata)

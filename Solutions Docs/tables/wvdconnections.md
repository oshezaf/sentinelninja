...
Reference for WVDConnections table in Azure Monitor Logs.
...
- [WVDConnections Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/wvdconnections)

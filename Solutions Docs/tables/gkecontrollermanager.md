...
| **Source Product** | Kubernetes Engine *(basis: projected)* |
...
- [GKEControllerManager Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/gkecontrollermanager)

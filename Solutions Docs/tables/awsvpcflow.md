...
| **Source Product** | S3, S3 VPC Flow *(basis: projected)* |
| **Event Type** | Logs |
...
- [AWSVPCFlow Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/awsvpcflow)

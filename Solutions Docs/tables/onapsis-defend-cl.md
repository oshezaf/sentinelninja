...
| **Collector Vendor** | Onapsis *(basis: projected)* |
...
**Source:** [Data Collection Rule definition](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Onapsis%20Defend/Data%20Connectors/Onapsis_PUSH_CCP/Onapsis_DCR.json)

| Column Name | Type |
|:------------|:-----|
| action | string |
| alarm_name | string |
| alarm_profile_id | real |
| alarm_profile_matches | string |
| anomaly_score | real |
| asset_name | string |
| category | string |
| client | string |
...
| downloaded_table | string |
| dst | string |
| erp_event_source | string |
| erp_host | string |
| erp_time | datetime |
| event_id | real |
| event_type | string |
...
| reason | string |
| result | string |
| rolecollection_name | string |
| root_cause | string |
| sap_sec_notes | string |
| severity | string |
| sid | string |
| solution | string |
| source_port | string |

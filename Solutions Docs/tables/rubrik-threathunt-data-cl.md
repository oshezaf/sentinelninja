...
| **Source Product** | Security Cloud *(basis: projected)* |
...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Rubrik_ThreatHunt_Data_CL.json)
...
| custom_details_errorCode_s | string |
| custom_details_errorId_s | string |
| custom_details_errorReason_s | string |

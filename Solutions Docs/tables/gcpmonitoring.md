...
| **Source Product** | Cloud Platform Cloud Monitoring *(basis: projected)* |
...
- [GCPMonitoring Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/gcpmonitoring)

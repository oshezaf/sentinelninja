...
Reference for VCoreMongoRequests table in Azure Monitor Logs.
...
- [VCoreMongoRequests Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/vcoremongorequests)

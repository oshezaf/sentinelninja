...
Reference for ASRv2JobEvents table in Azure Monitor Logs.
...
- [ASRv2JobEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/asrv2jobevents)

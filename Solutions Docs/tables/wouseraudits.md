...
Reference for WOUserAudits table in Azure Monitor Logs.
...
- [WOUserAudits Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/wouseraudits)

...
> **Internal Use Table:** This table is created and used internally by the [Network Session Essentials](../solutions/network-session-essentials.md) solution. It is written to by playbooks for solution-specific data storage.
...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/NetworkCustomAnalytics_protocol_CL.json)

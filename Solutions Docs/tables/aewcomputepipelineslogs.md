...
Reference for AEWComputePipelinesLogs table in Azure Monitor Logs.
...
- [AEWComputePipelinesLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/aewcomputepipelineslogs)

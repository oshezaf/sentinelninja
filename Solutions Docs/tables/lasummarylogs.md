...
Reference for LASummaryLogs table in Azure Monitor Logs.
...
- [LASummaryLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/lasummarylogs)

...
- [AADManagedIdentitySignInLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/aadmanagedidentitysigninlogs)
...
| Workbook | Selection Criteria |
|:-------------|:-------------------|
| [AADManagedIdentitySignInLogs](../content/github-only-aadmanagedidentitysigninlogs-e106dbaf.md) | `ResultType == "0"`<br>`ResultType != "0"` |

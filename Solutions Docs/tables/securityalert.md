...
- [SecurityAlert Schema Reference](https://learn.microsoft.com/en-us/azure/sentinel/security-alert-schema)
...
## Selection Criteria Summary (36 criteria, 47 total references)

References by type: 0 connectors, 47 content items, 0 ASIM parsers, 0 other parsers.

| Selection Criteria | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `ProviderName == "IPC"` | - | 4 | - | - | **4** |
| `ProviderName == "IoTSecurity"` | - | 4 | - | - | **4** |
| `ProviderName == "MDATP"` | - | 2 | - | - | **2** |
...
| `Azure Active Directory Identity Protection` | - | 6 | - | - | **6** |
| `Azure Security Center for IoT` | - | 4 | - | - | **4** |
| `Microsoft Cloud App Security` | - | 3 | - | - | **3** |
| `Microsoft Defender Advanced Threat Protection` | - | 3 | - | - | **3** |
| `Azure Sentinel` | - | 2 | - | - | **2** |
| `!= Azure Sentinel` | - | 1 | - | - | **1** |

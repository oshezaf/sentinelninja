...
Reference for MAApplicationInstanceReadiness table in Azure Monitor Logs.
...
- [MAApplicationInstanceReadiness Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/maapplicationinstancereadiness)

...
Reference for ADFActivityRun table in Azure Monitor Logs.
...
- [ADFActivityRun Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/adfactivityrun)

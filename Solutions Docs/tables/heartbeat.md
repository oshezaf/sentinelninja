...
- [Heartbeat Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/heartbeat)
...
**In solution [Windows Firewall](../solutions/windows-firewall.md):** `Solutions contains "windowsFirewall"`
...
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `Solutions contains "windowsFirewall"` | - | 1 | - | - | **1** |
| **Total** | **0** | **1** | **0** | **0** | **1** |

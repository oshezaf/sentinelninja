...
Reference for AZMSArchiveLogs table in Azure Monitor Logs.
...
- [AZMSArchiveLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/azmsarchivelogs)

...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/TrendMicroTippingPoint.json)
...
| TippingPointFilterMessageParms | string |
| TippingPointPacketTrace | int |
| TippingPointPolicyUUID | string |
| TippingPointProfileName | string |
| TippingPointSignatureUUID | string |
| TippingPointSMSName | string |
| TippingPointTaxonomy | int |
| TippingPointVLAN | int |
| TippingPointZoneNames | string |
| Type | string |

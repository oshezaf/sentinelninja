...
Reference for UAProposedActionPlan table in Azure Monitor Logs.
...
- [UAProposedActionPlan Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/uaproposedactionplan)

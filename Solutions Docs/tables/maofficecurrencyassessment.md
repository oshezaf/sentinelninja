...
Reference for MAOfficeCurrencyAssessment table in Azure Monitor Logs.
...
- [MAOfficeCurrencyAssessment Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/maofficecurrencyassessment)

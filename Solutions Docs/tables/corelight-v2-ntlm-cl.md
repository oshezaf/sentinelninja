...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_ntlm_CL.json)
...
| id_resp_h_s | string |
| id_resp_p_d | real |
| server_dns_computer_name_s | string |
| server_nb_computer_name_s | string |
| server_tree_name_s | string |
| success_b | bool |
...
|:-------|:---------|:-------------------|
| [corelight_ntlm](../parsers/corelight-ntlm.md) | [Corelight](../solutions/corelight.md) |  |

...
Reference for AZMSVnetConnectionEvents table in Azure Monitor Logs.
...
- [AZMSVnetConnectionEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/azmsvnetconnectionevents)

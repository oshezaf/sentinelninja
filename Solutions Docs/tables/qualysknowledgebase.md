...
| **Source Product** | Knowledge Base, VM KnowledgeBase *(basis: projected)* |
...
- [QualysKnowledgeBase Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/qualysknowledgebase)

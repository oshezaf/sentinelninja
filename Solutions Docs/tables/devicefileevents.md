...
| [MicrosoftDefenderForEndPoint](../content/github-only-microsoftdefenderforendpoint-ac005534.md) | `ActionType in "AntivirusDetection,FileCreated,UsbDriveMounted"` |
...
## Selection Criteria Summary (43 criteria, 55 total references)

References by type: 0 connectors, 54 content items, 1 ASIM parsers, 0 other parsers.
...
| `ActionType == "AntivirusDetection"` | - | 1 | - | - | **1** |

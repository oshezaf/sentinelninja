...
| **Source Product** | Threat intelligence - TAXII Export *(basis: projected)* |
...
- [ThreatIntelExportOperation Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/threatintelexportoperation)

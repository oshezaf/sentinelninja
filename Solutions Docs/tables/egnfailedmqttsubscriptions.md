...
Reference for EGNFailedMqttSubscriptions table in Azure Monitor Logs.
...
- [EGNFailedMqttSubscriptions Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/egnfailedmqttsubscriptions)

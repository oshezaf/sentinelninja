...
Reference for DevOpsOperationsAudit table in Azure Monitor Logs.
...
| **Azure Monitor Tables Reference** | [View Documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/devopsoperationsaudit) |
...
**Source:** [Azure Monitor documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/devopsoperationsaudit)
...
| DatabaseTransactionId | int | Database Transaction ID. |
...
| ServerInstanceName | string | The Server Instance Name. |
...
- [DevOpsOperationsAudit Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/devopsoperationsaudit)

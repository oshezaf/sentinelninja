...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_mqtt_connect_CL.json)
...
| client_id_s | string |
| connect_status_s | string |
| id_orig_h_s | string |
| id_orig_p_d | real |
| id_resp_h_s | string |
| id_resp_p_d | real |
| proto_name_s | string |
| proto_version_s | string |
| TimeGenerated | datetime |
| ts_t | datetime |
| uid_s | string |
| will_payload_s | string |
| will_topic_s | string |
...
|:-------|:---------|:-------------------|
| [corelight_mqtt_connect](../parsers/corelight-mqtt-connect.md) | [Corelight](../solutions/corelight.md) |  |

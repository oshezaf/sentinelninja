...
Reference for StorageMoverCopyLogsFailed table in Azure Monitor Logs.
...
- [StorageMoverCopyLogsFailed Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/storagemovercopylogsfailed)

...
Reference for ANFTopFileReadIOPS table in Azure Monitor Logs.
...
- [ANFTopFileReadIOPS Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/anftopfilereadiops)

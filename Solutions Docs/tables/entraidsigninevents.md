...
- [EntraIdSignInEvents Schema Reference (Defender XDR)](https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-entraidsigninevents-table)
...
|:-------------|:-------------------|
| [Automated email notifications and suspicious sign-in activity](../content/github-only-automated-email-notifications-and-suspicious-sign-in-activity-a7acfaf4-e03e-409d-a16e-dcde33f7dba3-fb7feb7d.md) | `RiskLevelDuringSignIn == "100"` |
...
| [Risky Sign-in with ElevateAccess](../content/github-only-risky-sign-in-with-elevateaccess-158b565b-411b-4dec-81de-2d2bcaf0c34c-455b10c6.md) | `ErrorCode == "0"`<br>`RiskLevelDuringSignIn in "100,50"` |
...
| [Risky sign-in attempt from a non-managed device](../content/github-only-risky-sign-in-attempt-from-a-non-managed-device-8d298b5c-feca-4add-bd42-e43e0a317a88-78c04c24.md) | `ClientAppUsed == "Browser"`<br>`IsCompliant != "1"`<br>`IsManaged != "1"`<br>`RiskLevelDuringSignIn in "100,50"` |
...
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `ErrorCode == "0"`<br>`RiskLevelDuringSignIn in "100,50"` | - | 1 | - | - | **1** |
| `RiskLevelDuringSignIn == "100"` | - | 1 | - | - | **1** |
| `ClientAppUsed == "Browser"`<br>`IsCompliant != "1"`<br>`IsManaged != "1"`<br>`RiskLevelDuringSignIn in "100,50"` | - | 1 | - | - | **1** |
| **Total** | **0** | **3** | **0** | **0** | **3** |

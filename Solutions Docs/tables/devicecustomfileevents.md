...
Reference for DeviceCustomFileEvents table in Azure Monitor Logs.
...
- [DeviceCustomFileEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/devicecustomfileevents)

...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_known_names_CL.json)
...
|:-------|:---------|:-------------------|
| [corelight_known_names](../parsers/corelight-known-names.md) | [Corelight](../solutions/corelight.md) |  |

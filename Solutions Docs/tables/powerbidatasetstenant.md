...
Reference for PowerBIDatasetsTenant table in Azure Monitor Logs.
...
- [PowerBIDatasetsTenant Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerbidatasetstenant)

...
- [DeviceLogonEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/devicelogonevents)
- [DeviceLogonEvents Schema Reference (Defender XDR)](https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-devicelogonevents-table)
...
| Hunting Query | Selection Criteria |
|:-------------|:-------------------|
| [Account brute force](../content/github-only-account-brute-force-ab619659-ab7c-4ca4-be0c-ca71a07bf4cd-13940f40.md) | `AccountName !endswith "$"`<br>`RemoteIPType == "Public"` |
...
| [Device Logons from Unknown IPs](../content/github-only-device-logons-from-unknown-ips-a6d76204-efb2-4ccd-a068-d5a9e6876236-62ddb799.md) | `RemoteIPType == "Public"` |
| [Events surrounding alert](../content/github-only-events-surrounding-alert-a4dfa95d-eb8a-4d71-b669-dcb6dcfcf37a-e671473f.md) | `LogonType == "Network"` |
| [Events surrounding alert (1)](../content/github-only-events-surrounding-alert-1-55a29d46-2cd5-44af-80aa-20d0ac4c86f8-fa59386c.md) | `LogonType == "Network"` |
| [Events surrounding alert (2)](../content/github-only-events-surrounding-alert-2-683549f4-4f4a-4cc8-becf-ff5b91dc6f07-78e30d23.md) | `LogonType == "Network"` |
| [Events surrounding alert (3)](../content/github-only-events-surrounding-alert-3-c4955324-02ff-46fa-a642-64952334482d-11006aac.md) | `LogonType == "Network"` |
| [Failed Logon Attempt](../content/github-only-failed-logon-attempt-95d68a9c-91d3-41ce-ab9f-f1baadc74f8a-5ac66053.md) | `DeviceName in "DeviceName1,DeviceName2"` |
| [ImpersonatedUserFootprint](../content/github-only-impersonateduserfootprint-aeb65be9-7a40-409e-a227-56ebbcf33de4-ee8b7da4.md) | `LogonType == "Network"` |
| [Network Logons with Local Accounts](../content/github-only-network-logons-with-local-accounts-95a44d0f-b717-4e34-902f-2fad4d6fcbe3-eb5d3cb9.md) | `RemoteIP !in "::1,-,0.0.0.0"`<br>`RemoteIP !startswith "127."` |
...
| [insider-threat-detection-queries](../content/github-only-insider-threat-detection-queries-d69ccf9a-4592-41db-a78f-f24108fea06e-bfaa02b6.md) | `InitiatingProcessAccountName != "system"`<br>`IsLocalAdmin == "0"` |
| [insider-threat-detection-queries (15)](../content/github-only-insider-threat-detection-queries-15-659e686d-850e-4240-a339-b24928f95e90-614419df.md) | `InitiatingProcessAccountName != "system"` |
...
| [localAdminAccountLogon](../content/github-only-localadminaccountlogon-2211b57b-7d13-435d-89a9-40f333249605-83bc8635.md) | `IsLocalAdmin == "1"` |
...
| Workbook | Selection Criteria |
|:-------------|:-------------------|
| [DoDZeroTrustWorkbook](../content/github-only-dodzerotrustworkbook-844294c8.md) | `IsLocalAdmin in "false,true"` |
...
| [ZeroTrustStrategyWorkbook](../content/github-only-zerotruststrategyworkbook-cd80dc2b.md) | `IsLocalAdmin in "false,true"` |
...
## Selection Criteria Summary (9 criteria, 14 total references)

References by type: 0 connectors, 14 content items, 0 ASIM parsers, 0 other parsers.

| Selection Criteria | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `LogonType == "Network"` | - | 5 | - | - | **5** |
| `AccountName !endswith "$"`<br>`RemoteIPType == "Public"` | - | 2 | - | - | **2** |
| `LogonType != "Unlock"`<br>`RemoteIPType != "Loopback"` | - | 1 | - | - | **1** |
| `DeviceName in "DeviceName1,DeviceName2"` | - | 1 | - | - | **1** |
| `InitiatingProcessAccountName != "system"` | - | 1 | - | - | **1** |
| `InitiatingProcessAccountName != "system"`<br>`IsLocalAdmin == "0"` | - | 1 | - | - | **1** |
| `RemoteIPType == "Public"` | - | 1 | - | - | **1** |
| `RemoteIP !in "::1,-,0.0.0.0"`<br>`RemoteIP !startswith "127."` | - | 1 | - | - | **1** |
| `IsLocalAdmin == "1"` | - | 1 | - | - | **1** |
| **Total** | **0** | **14** | **0** | **0** | **14** |

...
Reference for MAApplicationHealthIssues table in Azure Monitor Logs.
...
- [MAApplicationHealthIssues Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/maapplicationhealthissues)

...
Reference for MAOfficeAddinReadiness table in Azure Monitor Logs.
...
- [MAOfficeAddinReadiness Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/maofficeaddinreadiness)

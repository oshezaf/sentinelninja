...
**Source:** [Azure Monitor documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/asimregistryeventlogs) · [Data Collection Rule definition](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/VMware%20Carbon%20Black%20Cloud/Data%20Connectors/VMwareCarbonBlackCloud_ccp/CarbonBlack_DCR.json)
...
| ActingProcessCommandLine | string | The command line used to run the process. | Azure Monitor docs |
| ActingProcessGuid | string | A generated unique identifier of the acting process. | Azure Monitor docs |
| ActingProcessId | string | The process ID of the acting process. | Azure Monitor docs |
| ActingProcessName | string | The file name of the acting process image file. | Azure Monitor docs |
| action | string |  | DCR |
| action_s | string |  | DCR |
| ActorOriginalUserType | string | The original actor user type, if provided by the source. | Azure Monitor docs |
...
| ActorUserId | string | A unique ID of the Actor. | Azure Monitor docs |
| ActorUserIdType | string | The type of the ID stored in the ActorUserId field. | Azure Monitor docs |
| ActorUsername | string | The user name of the user who initiated the event. | Azure Monitor docs |
...
| EventEndTime | datetime | The time in which the event ended. If the source supports aggregation and the record represents multiple events, the time when the last event was generated. If not provided by the source record, this field aliases the TimeGenerated field. | Azure Monitor docs |
...
| EventOriginalType | string | A unique ID of the original record, if provided by the source. | Azure Monitor docs |
| EventOriginalUid | string | . | Azure Monitor docs |
...
| EventSchema | string | The name of the schema. | Azure Monitor docs |
...
| EventStartTime | datetime | The time in which the event started. If the source supports aggregation and the record represents multiple events, the time when the first event was generated. If not provided by the source record, this field aliases the TimeGenerated field. | Azure Monitor docs |
...
| ParentProcessCommandLine | string | The command line used to run the process. | Azure Monitor docs |
| ParentProcessGuid | string | A generated unique identifier of the parent process. | Azure Monitor docs |
| ParentProcessId | string | The process ID of the parent process. | Azure Monitor docs |
| ParentProcessName | string | The file name of the parent process image file. | Azure Monitor docs |
...
| RegistryKey | string | The registry key associated with the operation, normalized to standard root key naming conventions. | Azure Monitor docs |
| RegistryPreviousKey | string | For operations that modify the registry, the original registry key, normalized to standard root key naming. | Azure Monitor docs |
| RegistryPreviousValue | string | For operations that modify the registry, the original value type, normalized to the standard form. | Azure Monitor docs |
| RegistryPreviousValueData | string | The original registry data, for operations that modify the registry. | Azure Monitor docs |
| RegistryPreviousValueType | string | For operations that modify the registry, the original value type. | Azure Monitor docs |
| RegistryValue | string | The registry value associated with the operation. | Azure Monitor docs |
| RegistryValueData | string | The data stored in the registry value. | Azure Monitor docs |
| RegistryValueType | string | The type of registry value, normalized to standard form. | Azure Monitor docs |

...
| [ASimAuthenticationSu](../asim/asimauthenticationsu.md) | Authentication | su | `ProcessName == "su"`<br>`SyslogMessage has_all "pam_unix(su"`<br>`SyslogMessage startswith "Successful su for"` |

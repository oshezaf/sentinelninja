...
- [Syslog Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/syslog)
...
- [Cisco Secure Cloud Analytics](../solutions/cisco-secure-cloud-analytics.md)
- [Cisco UCS](../solutions/cisco-ucs.md)
- [CiscoMeraki](../solutions/ciscomeraki.md)
- [CiscoWSA](../solutions/ciscowsa.md)
...
- [Ivanti Unified Endpoint Management](../solutions/ivanti-unified-endpoint-management.md)
- [Juniper SRX](../solutions/juniper-srx.md)
- [MaturityModelForEventLogManagementM2131](../solutions/maturitymodelforeventlogmanagementm2131.md)
- [McAfee Network Security Platform](../solutions/mcafee-network-security-platform.md)
- [McAfee ePolicy Orchestrator](../solutions/mcafee-epolicy-orchestrator.md)
- [Microsoft Sysmon For Linux](../solutions/microsoft-sysmon-for-linux.md)
- [MicrosoftPurviewInsiderRiskManagement](../solutions/microsoftpurviewinsiderriskmanagement.md)
- [NISTSP80053](../solutions/nistsp80053.md)
- [Nasuni](../solutions/nasuni.md)
- [OpenVPN](../solutions/openvpn.md)
- [OracleDatabaseAudit](../solutions/oracledatabaseaudit.md)
...
|:----------|:-------------------|
| [[Deprecated] Barracuda CloudGen Firewall](../connectors/barracudacloudfirewall.md) | `ProcessName == "box_Firewall_Activity"` |
| [[Deprecated] Blackberry CylancePROTECT](../connectors/blackberrycylanceprotect.md) | `SyslogMessage contains "AuditLog"`<br>`SyslogMessage contains "Device,"`<br>`SyslogMessage contains "DeviceControl"`<br>`SyslogMessage contains "ScriptControl"`<br>`SyslogMessage contains "Threat"` |
| [CTERA Syslog](../connectors/ctera.md) | `ProcessName == "gw-audit"`<br>`SyslogMessage contains "gw-audit[-]:"`<br>`SyslogMessage contains "portal portal[-]:"` |
| [[Deprecated] Cisco Application Centric Infrastructure](../connectors/ciscoaci.md) | `SyslogMessage contains "SYSTEM_MSG"`<br>`SyslogMessage contains "%LOG_LOCAL"` |
| [[Deprecated] Cisco Identity Services Engine](../connectors/ciscoise.md) | `ProcessName has_any "CISE,CSCO"` |
...
| [[Deprecated] Cisco Web Security Appliance](../connectors/ciscowsa.md) | `ProcessName == "cisco_wsa"` |
| [[Deprecated] Citrix ADC (former NetScaler)](../connectors/citrixadc.md) |  |
| [[Deprecated] Digital Guardian Data Loss Prevention](../connectors/digitalguardiandlp.md) | `SyslogMessage contains "managed_device_id"`<br>`SyslogMessage contains "number_of_incidents"` |
| [[Deprecated] ESET PROTECT](../connectors/esetprotect.md) | `ProcessName == "ERAServer"` |
| [[Deprecated] Exabeam Advanced Analytics](../connectors/exabeam.md) | `ProcessName contains "Exabeam"` |
| [Forescout](../connectors/forescout.md) |  |
| [[Deprecated] GitLab](../connectors/gitlab.md) | `Facility == "local7"`<br>`ProcessName in "GitLab-Access-Logs,GitLab-Application-Logs,GitLab-Audit-Logs"`<br>`SyslogMessage contains "HTTP"`<br>`SyslogMessage has_any "DELETE,GET,PATCH,POST,PUT"` |
| [[Deprecated] ISC Bind](../connectors/iscbind.md) | `SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` |
| [[Deprecated] Infoblox NIOS](../connectors/infobloxnios.md) | `SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` |
| [[Deprecated] Ivanti Unified Endpoint Management](../connectors/ivantiuem.md) | `SyslogMessage has_all "Alert"` |
| [[Deprecated] Juniper SRX](../connectors/junipersrx.md) | `ProcessName == "RT_FLOW"`<br>`ProcessName in "RT_IDS,sshd"`<br>`ProcessName !in "sshd,RT_IDS,RT_FLOW"` |
| [[Deprecated] McAfee Network Security Platform](../connectors/mcafeensp.md) | `ProcessName == "SyslogAlertForwarderNSP"` |
| [[Deprecated] McAfee ePolicy Orchestrator (ePO)](../connectors/mcafeeepo.md) | `ProcessName contains "EPOEvents"`<br>`SyslogMessage contains "<EPOevent>"`<br>`SyslogMessage contains "<UpdateEvents>"` |
| [[Deprecated] Microsoft Sysmon For Linux](../connectors/microsoftsysmonforlinux.md) | `ProcessName == "sysmon"` |
| [[Deprecated] Nasuni Edge Appliance](../connectors/nasuniedgeappliance.md) | `Facility != "cron"` |
| [[Deprecated] OpenVPN Server](../connectors/openvpn.md) | `ProcessName == "openvpn"` |
| [[Deprecated] Oracle Database Audit](../connectors/oracledatabaseaudit.md) | `SyslogMessage contains "Oracle Unified Audit"` |
| [[Deprecated] Pulse Connect Secure](../connectors/pulseconnectsecure.md) | `Facility == "local7"` |
| [[Deprecated] RSA® SecurID (Authentication Manager)](../connectors/rsasecuridam.md) |  |
| [SAP LogServ (RISE), S/4HANA Cloud private edition](../connectors/saplogserv.md) | `CollectorHostName == "SAPLogServ"` |
| [[Deprecated] Sophos XG Firewall](../connectors/sophosxgfirewall.md) | `Facility == "local0"` |
| [[Deprecated] Cisco Secure Cloud Analytics](../connectors/stealthwatch.md) | `SyslogMessage has "Stealthwatch"` |
| [[Deprecated] Symantec Endpoint Protection](../connectors/symantecendpointprotection.md) | `ProcessName == "SymantecServer"` |
| [[Deprecated] Symantec ProxySG](../connectors/symantecproxysg.md) | `Facility == "local0"` |
| [[Deprecated] Symantec VIP](../connectors/symantecvip.md) | `Facility == "local5"` |
| [Syslog via Legacy Agent](../connectors/syslog.md) | `Facility != "cron"` |
| [Syslog via AMA](../connectors/syslogama.md) | `Facility != "cron"` |
| [[Deprecated] VMware ESXi](../connectors/vmwareesxi.md) | `ProcessName has_any "hostd-probe,vmkwarning,vpxd-main"` |
| [[Deprecated] WatchGuard Firebox](../connectors/watchguardfirebox.md) |  |

---

## Content Items Using This Table (389)
...
| [CTERA Mass Deletions Detection Analytic](../content/ctera-ctera-mass-deletions-detection-analytic-5365f294-0c67-432a-bacf-b1282a3b6c46-6fc626fe.md) | `ProcessName == "gw-audit"` |
| [CTERA Mass Permissions Changes Detection Analytic](../content/ctera-ctera-mass-permissions-changes-detection-analytic-90502ac9-19a2-41f0-ba81-e352de90b61b-15e26af2.md) | `ProcessName == "gw-audit"` |
| [Ransom Protect Detected a Ransomware Attack](../content/ctera-ransom-protect-detected-a-ransomware-attack-7a075edf-1cf2-4038-ba9c-c354db6409de-549c8616.md) | `SyslogMessage contains "Ransomware incident detected"` |
| [Ransom Protect User Blocked](../content/ctera-ransom-protect-user-blocked-d5d4766b-e547-44da-9d85-48ff393db201-202e085b.md) | `SyslogMessage contains "Ransom Protect mechanism blocked"` |
...
| [CiscoISE - Backup failed](../content/cisco-ise-ciscoise-backup-failed-4eddd44a-25e4-41af-930d-0c17218bec74-dd752ff2.md) |
| [CiscoISE - Certificate has expired](../content/cisco-ise-ciscoise-certificate-has-expired-6107cba5-2974-4c22-8222-2a6f7bbea664-913fdd0f.md) |
| [CiscoISE - Command executed with the highest privileges by new user](../content/cisco-ise-ciscoise-command-executed-with-the-highest-privileges-by-new-user-e71890a2-5f61-4790-b1ed-cf1d92d3e398-d03faf37.md) |
| [CiscoISE - Device PostureStatus changed to non-compliant](../content/cisco-ise-ciscoise-device-posturestatus-changed-to-non-compliant-548a2eda-d3eb-46cc-8d4b-1601551629e4-a16c86d6.md) |
| [CiscoISE - Device changed IP in last 24 hours](../content/cisco-ise-ciscoise-device-changed-ip-in-last-24-hours-0c509e9b-121e-4951-9f9b-43722e052b4f-a93bc32e.md) |
| [CiscoISE - ISE administrator password has been reset](../content/cisco-ise-ciscoise-ise-administrator-password-has-been-reset-e63b4d90-d0a8-4609-b187-babfcc7f86d7-e3ab1e37.md) |
| [CiscoISE - Log collector was suspended](../content/cisco-ise-ciscoise-log-collector-was-suspended-ce171782-1643-4f21-bbb7-fa954b1e6897-5fbb472c.md) |
| [CiscoISE - Log files deleted](../content/cisco-ise-ciscoise-log-files-deleted-21d3be4c-6088-4e76-b6eb-d25479019cb9-d4137662.md) |
...
| [Cisco WSA - Multiple attempts to download unwanted file](../content/ciscowsa-cisco-wsa-multiple-attempts-to-download-unwanted-file-46b6c6fc-2c1a-4270-be10-9d444d83f027-c3b3d95a.md) |
| [Cisco WSA - Multiple errors to URL](../content/ciscowsa-cisco-wsa-multiple-errors-to-url-1db49647-435c-41ad-bf8c-7130ba75429d-e0440300.md) |
| [Cisco WSA - Multiple errors to resource from risky category](../content/ciscowsa-cisco-wsa-multiple-errors-to-resource-from-risky-category-ebf9db0c-ba7b-4249-b9ec-50a05fa7c7c9-c9d41318.md) |
| [Cisco WSA - Multiple infected files](../content/ciscowsa-cisco-wsa-multiple-infected-files-93186e3d-5dc2-4a00-a993-fa1448db8734-31d6d3c5.md) |
| [Cisco WSA - Suspected protocol abuse](../content/ciscowsa-cisco-wsa-suspected-protocol-abuse-6f756792-4888-48a5-97cf-40d9430dc932-4baf9484.md) |
| [Cisco WSA - Unexpected URL](../content/ciscowsa-cisco-wsa-unexpected-url-010644fd-2830-4451-9e0e-606cc192f2e7-b38bbadd.md) |
| [Cisco WSA - Unexpected file type](../content/ciscowsa-cisco-wsa-unexpected-file-type-8e9d1f70-d529-4598-9d3e-5dd5164d1d02-7ddbfd79.md) |
| [Cisco WSA - Unexpected uploads](../content/ciscowsa-cisco-wsa-unexpected-uploads-32c460ad-2d40-43e9-8ead-5cdd1d7a3163-56bd9766.md) |
| [Cisco WSA - Unscannable file or scan error](../content/ciscowsa-cisco-wsa-unscannable-file-or-scan-error-9b61a945-ebcb-4245-b6e4-51f3addb5248-11903546.md) |
...
| [Digital Guardian - Exfiltration to online fileshare](../content/digital-guardian-data-loss-prevention-digital-guardian-exfiltration-to-online-fileshare-f7b6ddef-c1e9-46f0-8539-dbba7fb8a5b8-696301bd.md) |
| [Digital Guardian - Exfiltration to private email](../content/digital-guardian-data-loss-prevention-digital-guardian-exfiltration-to-private-email-edead9b5-243a-466b-ae78-2dae32ab1117-71788af9.md) |
| [Digital Guardian - Exfiltration using DNS protocol](../content/digital-guardian-data-loss-prevention-digital-guardian-exfiltration-using-dns-protocol-39e25deb-49bb-4cdb-89c1-c466d596e2bd-9c7b7098.md) |
| [Digital Guardian - Incident with not blocked action](../content/digital-guardian-data-loss-prevention-digital-guardian-incident-with-not-blocked-action-07bca129-e7d6-4421-b489-32abade0b6a7-499ad258.md) |
| [Digital Guardian - Multiple incidents from user](../content/digital-guardian-data-loss-prevention-digital-guardian-multiple-incidents-from-user-e8901dac-2549-4948-b793-5197a5ed697a-e1d240c6.md) |
| [Digital Guardian - Possible SMTP protocol abuse](../content/digital-guardian-data-loss-prevention-digital-guardian-possible-smtp-protocol-abuse-a374a933-f6c4-4200-8682-70402a9054dd-001679b1.md) |
| [Digital Guardian - Sensitive data transfer over insecure channel](../content/digital-guardian-data-loss-prevention-digital-guardian-sensitive-data-transfer-over-insecure-channel-b52cda18-c1af-40e5-91f3-1fcbf9fa267e-0175d970.md) |
| [Digital Guardian - Unexpected protocol](../content/digital-guardian-data-loss-prevention-digital-guardian-unexpected-protocol-a14f2f95-bbd2-4036-ad59-e3aff132b296-acbf8917.md) |
...
| [GitLab - User Impersonation](../content/gitlab-gitlab-user-impersonation-0f4f16a2-b464-4c10-9a42-993da3e15a40-bad32e25.md) | `Facility == "local7"`<br>`ProcessName == "GitLab-Audit-Logs"` |
...
| [McAfee ePO - Deployment failed](../content/mcafee-epolicy-orchestrator-mcafee-epo-deployment-failed-155243f4-d962-4717-8a7b-b15b6d112660-667499dd.md) |
| [McAfee ePO - Error sending alert](../content/mcafee-epolicy-orchestrator-mcafee-epo-error-sending-alert-1e3bcd0f-10b2-4fbd-854f-1c6f33acc36a-ac2b2d79.md) |
| [McAfee ePO - File added to exceptions](../content/mcafee-epolicy-orchestrator-mcafee-epo-file-added-to-exceptions-b9d9fdfe-bc17-45ce-a70d-67a5cfd119f4-bdad79ac.md) |
| [McAfee ePO - Firewall disabled](../content/mcafee-epolicy-orchestrator-mcafee-epo-firewall-disabled-bd3cedc3-efba-455a-85bd-0cf9ac1b0727-52f5823f.md) |
| [McAfee ePO - Logging error occurred](../content/mcafee-epolicy-orchestrator-mcafee-epo-logging-error-occurred-0c9243d6-d2ec-48e1-8593-e713859c8f3c-9205c165.md) |
| [McAfee ePO - Multiple threats on same host](../content/mcafee-epolicy-orchestrator-mcafee-epo-multiple-threats-on-same-host-f53e5168-afdb-4fad-b29a-bb9cb71ec460-48b44b93.md) |
| [McAfee ePO - Scanning engine disabled](../content/mcafee-epolicy-orchestrator-mcafee-epo-scanning-engine-disabled-5223c1b8-75ef-4019-9076-a19b1ef3e5d1-6db57ca1.md) |
| [McAfee ePO - Spam Email detected](../content/mcafee-epolicy-orchestrator-mcafee-epo-spam-email-detected-ffc9052b-3658-4ad4-9003-0151515fde15-ea55c50d.md) |
| [McAfee ePO - Task error](../content/mcafee-epolicy-orchestrator-mcafee-epo-task-error-3e397e31-7964-417e-a3e0-0acfaa2056f4-25f3e295.md) |
| [McAfee ePO - Threat was not blocked](../content/mcafee-epolicy-orchestrator-mcafee-epo-threat-was-not-blocked-6d70a26a-c119-45b7-b4c6-44ac4fd1bcb7-299c7a2f.md) |
| [McAfee ePO - Unable to clean or delete infected file](../content/mcafee-epolicy-orchestrator-mcafee-epo-unable-to-clean-or-delete-infected-file-9860e89f-72c8-425e-bac9-4a170798d3ea-aa3ef2fa.md) |
| [McAfee ePO - Update failed](../content/mcafee-epolicy-orchestrator-mcafee-epo-update-failed-4f0c91c3-1690-48f0-b538-4282dd5417a4-9c8f9364.md) |
...
| [OracleDBAudit - Multiple tables dropped in short time](../content/oracledatabaseaudit-oracledbaudit-multiple-tables-dropped-in-short-time-b3aa0e5a-75a2-4613-80ec-93a1be3aeb8f-1c483121.md) |
| [OracleDBAudit - New user account](../content/oracledatabaseaudit-oracledbaudit-new-user-account-cca7b348-e904-4a7a-8f26-d22d4d477119-9b9b7968.md) |
| [OracleDBAudit - Query on Sensitive Table](../content/oracledatabaseaudit-oracledbaudit-query-on-sensitive-table-d7fdcad5-ce96-4db6-9a5e-4a86a5166e5e-f6002111.md) |
| [OracleDBAudit - SQL injection patterns](../content/oracledatabaseaudit-oracledbaudit-sql-injection-patterns-ab352f0d-7c55-4ab2-a22e-b1c2d995e193-8f05d17d.md) |
| [OracleDBAudit - Shutdown Server](../content/oracledatabaseaudit-oracledbaudit-shutdown-server-27cc2cdc-ba67-4906-a6ef-ecbc9c284f4e-30f74874.md) |
| [OracleDBAudit - Unusual user activity on multiple tables](../content/oracledatabaseaudit-oracledbaudit-unusual-user-activity-on-multiple-tables-75024e1c-26e7-4e73-821d-95e5decdd8db-dbe1e2fb.md) |
| [OracleDBAudit - User activity after long inactivity time](../content/oracledatabaseaudit-oracledbaudit-user-activity-after-long-inactivity-time-5e93a535-036b-4570-9e58-d8992f30e1ae-1821ecca.md) |
| [OracleDBAudit - User connected to database from new IP](../content/oracledatabaseaudit-oracledbaudit-user-connected-to-database-from-new-ip-39a0995e-f4a9-4869-a0ae-36d6d9049bfd-fe409afd.md) |
...
| [Pure Failed Login](../content/pure-storage-pure-failed-login-ed32b115-5001-43a7-a2bb-f53026db4d97-7948e1d0.md) | `SyslogMessage has "invalid username or password"`<br>`SyslogMessage has "purity.alert"` |

**In solution [SAP LogServ](../solutions/sap-logserv.md):** `CollectorHostName == "SAPLogServ"`<br>`SourceSystem == "HANADB"`
...
**In solution [SymantecProxySG](../solutions/symantecproxysg.md):** `Computer == "datasource"`<br>`Facility == "local0"`
...
| [SFTP File transfer above threshold](../content/syslog-sftp-file-transfer-above-threshold-bb6a74c8-889d-4c6e-8412-7d5efe33f4ed-7f06d2d2.md) | `ProcessName has "sftp"`<br>`SyslogMessage has "bytes read"`<br>`SyslogMessage has "close"`<br>`SyslogMessage has "session opened for"` |
| [SFTP File transfer folder count above threshold](../content/syslog-sftp-file-transfer-folder-count-above-threshold-7355434e-09d5-4401-b56d-e03e9379dfb1-648b0cfd.md) | `ProcessName has "sftp"`<br>`SyslogMessage has "bytes read"`<br>`SyslogMessage has "close"`<br>`SyslogMessage has "session opened for"` |
| [SSH - Potential Brute Force](../content/syslog-ssh-potential-brute-force-e1ce0eab-10d1-4aae-863f-9a383345ba88-08e1a5a9.md) | `ProcessName == "sshd"`<br>`SyslogMessage contains "Failed password for invalid user"` |
| [Squid proxy events for ToR proxies](../content/syslog-squid-proxy-events-for-tor-proxies-90d3f6ec-80fb-48e0-9937-2c70c9df9bad-1bd82f05.md) | `ProcessName contains "squid"` |
| [Squid proxy events related to mining pools](../content/syslog-squid-proxy-events-related-to-mining-pools-80733eb7-35b2-45b6-b2b8-3c51df258206-05fb1303.md) | `ProcessName contains "squid"` |
...
| Analytic Rule | Selection Criteria |
|:-------------|:-------------------|
| [TI Map Domain entity to Syslog](../content/threat-intelligence-new-ti-map-domain-entity-to-syslog-cd19434e-10f2-4e2f-b3c1-ce6f08ac5357-130e8485.md) |  |
...
| [VMware SD-WAN Edge - Network Anomaly Detection - RPF Check Failure](../content/vmware-sase-vmware-sd-wan-edge-network-anomaly-detection-rpf-check-failure-840b050f-842b-4264-8973-d4f9b65facb5-9ddc97bd.md) | `SyslogMessage contains "Reverse path forwarding check fail"`<br>`SyslogMessage contains "VCF Drop"` |
...
| [Configuration Backup Job Failed](../content/veeam-configuration-backup-job-failed-18833d01-703a-438d-8ac6-84faa82e9b52-9600efc4.md) |
...
| [Possible Linux attack toolkit detected via Syslog data](../content/apache-log4j-vulnerability-detection-possible-linux-attack-toolkit-detected-via-syslog-data-09e45ec6-ac42-4b5a-be69-54623c4aa062-48341e65.md) | `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"` |
| [Possible exploitation of Apache log4j component detected](../content/apache-log4j-vulnerability-detection-possible-exploitation-of-apache-log4j-component-detected-38cc38c3-bd6c-470e-ae1a-3136a9ded97f-aa82fa46.md) | `SyslogMessage has "AUOMS_EXECVE"`<br>`SyslogMessage has "jndi"`<br>`SyslogMessage has_any "corba,dns,iiop,ldap,nds,nis,rmi"` |
| [Suspicious Base64 download activity detected](../content/apache-log4j-vulnerability-detection-suspicious-base64-download-activity-detected-78882f9a-f3ef-4010-973c-3f6336f5bef7-90a64218.md) | `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"` |
| [Suspicious Shell script detected](../content/apache-log4j-vulnerability-detection-suspicious-shell-script-detected-3e43fe23-c6c0-45ca-b680-263e8afada95-d9c4f52e.md) | `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"` |
| [Suspicious manipulation of firewall detected via Syslog data](../content/apache-log4j-vulnerability-detection-suspicious-manipulation-of-firewall-detected-via-syslog-data-e178baf5-3cf3-4960-8ca4-8da6d90d8206-be0d2edd.md) | `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"` |
...
| [CiscoISE - Dynamic authorization failed](../content/cisco-ise-ciscoise-dynamic-authorization-failed-98d1384d-5aef-430c-875c-3b4434afb003-25854703.md) |
...
| [CiscoISE - Failed authentication events](../content/cisco-ise-ciscoise-failed-authentication-events-9cb9ef9e-4f4d-4437-8abe-249589e72931-e378436d.md) |
| [CiscoISE - Failed login attempts via SSH CLI (users)](../content/cisco-ise-ciscoise-failed-login-attempts-via-ssh-cli-users-64b63d2d-a867-4451-bf74-f2310398498e-eaeb0a3d.md) |
| [CiscoISE - Guest authentication failed](../content/cisco-ise-ciscoise-guest-authentication-failed-3935b084-2fa1-461a-b920-1e20c1acff7b-43fc9aa4.md) |
| [CiscoISE - Guest authentication succeeded](../content/cisco-ise-ciscoise-guest-authentication-succeeded-377a4eb8-ced4-4e2b-a2f5-731db8f78275-d48bc131.md) |
| [CiscoISE - Rare or new useragent](../content/cisco-ise-ciscoise-rare-or-new-useragent-32abe28a-c1c8-4eb4-adfb-858abdbacbfe-fd92f37c.md) |
| [CiscoISE - Sources with high number of 'Failed Authentication' events](../content/cisco-ise-ciscoise-sources-with-high-number-of-'failed-authentication'-events-4fb45425-b758-41d8-80bc-843b5b0f119e-4f32de58.md) |
...
| [Cisco WSA - Rare URL with error](../content/ciscowsa-cisco-wsa-rare-url-with-error-88edb5d8-3ad9-4004-aefa-43c289483935-b66ea2f1.md) |
| [Cisco WSA - Rare aplications](../content/ciscowsa-cisco-wsa-rare-aplications-686ec2d3-fdbb-4fa2-b834-ff1d0f2486fb-ba5bc5d5.md) |
| [Cisco WSA - Top URLs](../content/ciscowsa-cisco-wsa-top-urls-aaf6ba04-7a00-401e-a650-06e213f3bfbc-0cb5da27.md) |
| [Cisco WSA - Top aplications](../content/ciscowsa-cisco-wsa-top-aplications-6d4d7689-5e1d-4687-b1fc-eb0b7340c9a3-4c669894.md) |
| [Cisco WSA - URL shorteners](../content/ciscowsa-cisco-wsa-url-shorteners-04582ef2-42be-4371-9ecf-635337c92ddb-7234b2bf.md) |
| [Cisco WSA - Uncategorized URLs](../content/ciscowsa-cisco-wsa-uncategorized-urls-deddf5e8-8fee-4ec5-9121-415eb954c34d-f9f36aaa.md) |
| [Cisco WSA - Uploaded files](../content/ciscowsa-cisco-wsa-uploaded-files-9d08418d-e21e-4fd6-b9bc-d80ce786d2da-f56bd319.md) |
| [Cisco WSA - User errors](../content/ciscowsa-cisco-wsa-user-errors-77ec347d-db28-4556-8a5a-dbc2ec7c9461-9488ff9c.md) |
...
| [Digital Guardian - Insecure file transfer sources](../content/digital-guardian-data-loss-prevention-digital-guardian-insecure-file-transfer-sources-196930a4-bd79-4800-b2bb-582a8f1c8dd4-173dbc52.md) |
| [Digital Guardian - Inspected files](../content/digital-guardian-data-loss-prevention-digital-guardian-inspected-files-e459b709-55f7-48b6-8afc-0ae1062d3584-7b579b48.md) |
| [Digital Guardian - New incidents](../content/digital-guardian-data-loss-prevention-digital-guardian-new-incidents-ae482a2c-b4e7-46fc-aeb7-744f7aad27ea-17962b79.md) |
| [Digital Guardian - Rare Urls](../content/digital-guardian-data-loss-prevention-digital-guardian-rare-urls-b9a69da9-1ca0-4e09-a24f-5d88d57e0402-94010434.md) |
| [Digital Guardian - Rare destination ports](../content/digital-guardian-data-loss-prevention-digital-guardian-rare-destination-ports-82cba92e-fe2f-4bba-9b46-647040b24090-ebe03fc4.md) |
| [Digital Guardian - Rare network protocols](../content/digital-guardian-data-loss-prevention-digital-guardian-rare-network-protocols-8ab2f0db-baa1-495c-a8dd-718b81d0b8c7-37c677d6.md) |
| [Digital Guardian - Urls used](../content/digital-guardian-data-loss-prevention-digital-guardian-urls-used-310433ca-67aa-406d-bbdf-c167a474b0a0-6a1b384a.md) |
| [Digital Guardian - Users' incidents](../content/digital-guardian-data-loss-prevention-digital-guardian-users'-incidents-83d5652c-025c-4cee-9f33-3bc114648859-8c54f914.md) |
...
| [McAfee ePO - Email Treats](../content/mcafee-epolicy-orchestrator-mcafee-epo-email-treats-851b63f1-cc5d-44d5-b505-9444a5e87076-d091dc76.md) |
| [McAfee ePO - Infected Systems](../content/mcafee-epolicy-orchestrator-mcafee-epo-infected-systems-2e7a56fb-ffff-491c-bdee-e772f83c47e2-d206daf3.md) |
| [McAfee ePO - Infected files by source](../content/mcafee-epolicy-orchestrator-mcafee-epo-infected-files-by-source-e83b72a0-60dd-4d65-b1c2-582766f2f181-692fcc32.md) |
| [McAfee ePO - Long term infected systems](../content/mcafee-epolicy-orchestrator-mcafee-epo-long-term-infected-systems-a65e4129-d936-4165-bc08-699f9151aa26-808b025f.md) |
| [McAfee ePO - Objects not scanned](../content/mcafee-epolicy-orchestrator-mcafee-epo-objects-not-scanned-5be4adb7-52ee-4416-b39d-0c03cf0fb661-b8471301.md) |
| [McAfee ePO - Scan Errors](../content/mcafee-epolicy-orchestrator-mcafee-epo-scan-errors-901e6982-39ed-4759-9451-de1a3826182f-f01964b9.md) |
| [McAfee ePO - Sources with multiple threats](../content/mcafee-epolicy-orchestrator-mcafee-epo-sources-with-multiple-threats-1ef23489-a840-4b43-b33d-a921da24c85c-b0e3a338.md) |
| [McAfee ePO - Threats detected and not blocked, cleaned or deleted](../content/mcafee-epolicy-orchestrator-mcafee-epo-threats-detected-and-not-blocked,-cleaned-or-deleted-80c5904d-6a36-4b7c-82d4-180023a1f8b4-c8a11efd.md) |
...
| [OracleDBAudit - Active Users](../content/oracledatabaseaudit-oracledbaudit-active-users-859c26cc-a779-4259-b981-6c6bc8f6402b-701e81f8.md) |
| [OracleDBAudit - Audit large queries](../content/oracledatabaseaudit-oracledbaudit-audit-large-queries-ba5e1a88-2054-4bda-a6e0-20008148ae6e-b8eed56b.md) |
| [OracleDBAudit - Dropped Tables](../content/oracledatabaseaudit-oracledbaudit-dropped-tables-e74b944a-c438-4949-b4d0-cdfe3a9354c9-0dd5f3b4.md) |
| [OracleDBAudit - Inactive Users](../content/oracledatabaseaudit-oracledbaudit-inactive-users-2c7bbbe1-17cb-44ec-be63-fbb37b609403-632ec36a.md) |
| [OracleDBAudit - Top tables queries](../content/oracledatabaseaudit-oracledbaudit-top-tables-queries-b8fcb5b8-254c-4d49-865e-403b8453f487-bdf84abe.md) |
| [OracleDBAudit - Users Privileges Review](../content/oracledatabaseaudit-oracledbaudit-users-privileges-review-46bbb4e9-fdeb-45dc-b4df-e4cee0f90ef0-ccae9e98.md) |
| [OracleDBAudit - Users connected to databases during non-operational hours.](../content/oracledatabaseaudit-oracledbaudit-users-connected-to-databases-during-non-operational-hours.-48fa6c2c-6e30-49e1-bc94-744212f99bfe-9ab227bc.md) |
| [OracleDBAudit - Users with new privileges](../content/oracledatabaseaudit-oracledbaudit-users-with-new-privileges-6be9634e-6661-4bff-98f1-4a743d7231a5-119d0684.md) |
...
| [Editing Linux scheduled tasks through Crontab](../content/syslog-editing-linux-scheduled-tasks-through-crontab-6f0f1821-5981-408a-930b-8b2ca60e9e6c-5de4e857.md) | `Facility == "cron"`<br>`ProcessName == "crontab"`<br>`SeverityLevel == "info"` |
| [Linux scheduled task Aggregation](../content/syslog-linux-scheduled-task-aggregation-eb09da09-6f6c-4502-bf74-f7b9f1343539-ae42cc38.md) | `Facility == "cron"`<br>`ProcessName in "CRON,CROND"`<br>`SyslogMessage contains "CMD"` |
...
| [SCX Execute RunAs Providers](../content/syslog-scx-execute-runas-providers-0d298a1d-1a08-4f4b-8b28-687bfe0012e8-bc82896d.md) | `SyslogMessage has "AUOMS_EXECVE"` |
| [Squid commonly abused TLDs](../content/syslog-squid-commonly-abused-tlds-7aaa7675-1580-47d8-a404-039cb7284279-58ed2cc3.md) | `ProcessName contains "squid"` |
| [Squid data volume timeseries anomalies](../content/syslog-squid-data-volume-timeseries-anomalies-e472c490-4792-4f12-8b6b-6ab3e0404d35-8dc40325.md) | `ProcessName contains "squid"` |
| [Squid malformed requests](../content/syslog-squid-malformed-requests-edbeec9f-86b9-475d-8a42-cc7b95ad2baa-73064f82.md) | `ProcessName contains "squid"` |
| [Suspicious crytocurrency mining related threat activity detected](../content/syslog-suspicious-crytocurrency-mining-related-threat-activity-detected-005d6e3c-7453-46f6-aef3-f59695594545-4f6cf014.md) | `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"` |
...
| [ASimAuthenticationCiscoDNAC](../asim/asimauthenticationciscodnac.md) | Authentication | Cisco DNAC | `ProcessName == "DNAC"`<br>`SyslogMessage has "LOGIN_USER_EVENT"`<br>`SyslogMessage has "LOGOFF_USER_EVENT"` |
| [ASimAuthenticationCiscoFTD](../asim/asimauthenticationciscoftd.md) | Authentication | Cisco FTD | `SyslogMessage has "Accepted password"`<br>`SyslogMessage has "Failed password"`<br>`SyslogMessage startswith "%FTD-5-199017"` |
| [ASimAuthenticationCiscoIOS](../asim/asimauthenticationciscoios.md) | Authentication | Cisco IOS | `SyslogMessage has "%SEC_LOGIN-4-LOGIN_FAILED"`<br>`SyslogMessage has "%SEC_LOGIN-5-LOGIN_SUCCESS"`<br>`SyslogMessage has "%SYS-6-LOGOUT"` |
| [ASimAuthenticationCiscoISE](../asim/asimauthenticationciscoise.md) | Authentication | Cisco ISE | `ProcessName has_any "CISE,CSCO"` |
| [ASimAuthenticationCiscoISEAdministrator](../asim/asimauthenticationciscoiseadministrator.md) | Authentication | Cisco ISE Administrator | `ProcessName has "CISE_Administrative_and_Operational_Audit"`<br>`SyslogMessage has "Administrator-Login"` |
| [ASimAuthenticationCiscoMerakiSyslog](../asim/asimauthenticationciscomerakisyslog.md) | Authentication | Cisco Meraki |  |
| [ASimAuthenticationPaloAltoPrismaCloud](../asim/asimauthenticationpaloaltoprismacloud.md) | Authentication | Palo Alto Prisma Cloud Compute | `ProcessName == "Twistlock-Console"` |
| [ASimAuthenticationSshd](../asim/asimauthenticationsshd.md) | Authentication | OpenSSH | `ProcessName == "sshd"`<br>`SyslogMessage has "Failed"`<br>`SyslogMessage has "but this does not map back to the address"`<br>`SyslogMessage has "key RSA"`<br>`SyslogMessage has "publickey"`<br>`SyslogMessage startswith "Accepted"`<br>`SyslogMessage startswith "Failed"`<br>`SyslogMessage startswith "Invalid user"`<br>`SyslogMessage startswith "Nasty PTR record"`<br>`SyslogMessage startswith "Timeout"`<br>`SyslogMessage startswith "message repeated"`<br>`SyslogMessage startswith "reverse mapping checking getaddrinfo for"` |
| [ASimAuthenticationSu](../asim/asimauthenticationsu.md) | Authentication | su | `ProcessName == "su"`<br>`SyslogMessage has_all "pam_unix(su"`<br>`SyslogMessage startswith "FAILED SU"`<br>`SyslogMessage startswith "Successful su for"` |
| [ASimAuthenticationSudo](../asim/asimauthenticationsudo.md) | Authentication | sudo | `ProcessName == "sudo"`<br>`SyslogMessage has "COMMAND="`<br>`SyslogMessage has "TTY="`<br>`SyslogMessage has "USER="`<br>`SyslogMessage has "incorrect password attempts"`<br>`SyslogMessage has "session closed for user"`<br>`SyslogMessage has "user NOT in sudoers"` |
| [ASimDnsInfobloxNIOS](../asim/asimdnsinfobloxnios.md) | Dns | Infoblox NIOS | `ProcessName == "named"`<br>`SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` |
| [ASimFileEventLinuxSysmonFileCreated](../asim/asimfileeventlinuxsysmonfilecreated.md) | FileEvent | Microsoft Sysmon for Linux | `SyslogMessage has_all "<Provider Name="` |
| [ASimFileEventLinuxSysmonFileDeleted](../asim/asimfileeventlinuxsysmonfiledeleted.md) | FileEvent | Microsoft Sysmon for Linux | `SyslogMessage has "<Provider Name="`<br>`SyslogMessage has_any "<EventID>23</EventID>,<EventID>26</EventID>"` |
| [ASimNetworkSessionAppGateSDP](../asim/asimnetworksessionappgatesdp.md) | NetworkSession | AppGate SDP | `ProcessName in "cz-sessiond,cz-vpnd"`<br>`SyslogMessage has_all "[AUDIT]"`<br>`SyslogMessage has_any ":"` |
| [ASimNetworkSessionCiscoISE](../asim/asimnetworksessionciscoise.md) | NetworkSession | Cisco ISE | `ProcessName has_any "CISE,CSCO"` |
| [ASimNetworkSessionCiscoMerakiSyslog](../asim/asimnetworksessionciscomerakisyslog.md) | NetworkSession | Cisco Meraki | `Computer == "CiscoMeraki"` |
| [ASimNetworkSessionLinuxSysmon](../asim/asimnetworksessionlinuxsysmon.md) | NetworkSession | Sysmon for Linux | `SyslogMessage has_all "<Provider Name="` |
| [ASimNetworkSessionWatchGuardFirewareOS](../asim/asimnetworksessionwatchguardfirewareos.md) | NetworkSession | WatchGuard Fireware OS | `SyslogMessage !has "3000-0151"`<br>`SyslogMessage !has "icmp"`<br>`SyslogMessage !has "igmp"`<br>`SyslogMessage !has "msg="`<br>`SyslogMessage has "3000-0151"`<br>`SyslogMessage has "icmp"`<br>`SyslogMessage has "igmp"`<br>`SyslogMessage has_any "msg_id="` |
| [ASimProcessCreateLinuxSysmon](../asim/asimprocesscreatelinuxsysmon.md) | ProcessEvent | Sysmon for Linux | `SyslogMessage has_all "<Provider Name="` |
| [ASimProcessTerminateLinuxSysmon](../asim/asimprocessterminatelinuxsysmon.md) | ProcessEvent | Sysmon for Linux | `SyslogMessage has_all "<Provider Name="` |
| [ASimUserManagementCiscoISE](../asim/asimusermanagementciscoise.md) | UserManagement | Cisco ISE | `ProcessName has_any "CISE,CSCO"` |
| [ASimUserManagementLinuxAuthpriv](../asim/asimusermanagementlinuxauthpriv.md) | UserManagement | Microsoft | `Computer == "LinuxAuthpriv"`<br>`Facility == "authpriv"`<br>`ProcessName in "gpasswd,groupadd,groupdel,groupmod,useradd,userdel,usermod"` |

### Other Parsers (75)

| Parser | Solution | Selection Criteria |
|:-------|:---------|:-------------------|
| [CGFWFirewallActivity](../parsers/cgfwfirewallactivity.md) | [Barracuda CloudGen Firewall](../solutions/barracuda-cloudgen-firewall.md) | `ProcessName == "box_Firewall_Activity"` |
| [CGFWFirewallActivity](../parsers/cgfwfirewallactivity.md) | [Barracuda CloudGen Firewall](../solutions/barracuda-cloudgen-firewall.md) ⚠️ | `ProcessName == "box_Firewall_Activity"` |
| [CiscoACIEvent](../parsers/ciscoacievent.md) | [Cisco ACI](../solutions/cisco-aci.md) | `SyslogMessage contains "SYSTEM_MSG"`<br>`SyslogMessage contains "%LOG_LOCAL"` |
| [CiscoISEEvent](../parsers/ciscoiseevent.md) | [Cisco ISE](../solutions/cisco-ise.md) | `ProcessName has_any "CISE,CSCO"` |
| [CiscoMeraki](../parsers/ciscomeraki.md) | [CiscoMeraki](../solutions/ciscomeraki.md) |  |
| [CiscoSyslogFW6LogSummary](../parsers/ciscosyslogfw6logsummary.md) | [Cisco SD-WAN](../solutions/cisco-sd-wan.md) ⚠️ | `SyslogMessage has "%FW-6-LOG_SUMMARY:"` |
| [CiscoSyslogUTD](../parsers/ciscosyslogutd.md) | [Cisco SD-WAN](../solutions/cisco-sd-wan.md) ⚠️ |  |
| [CiscoUCS](../parsers/ciscoucs.md) | [Cisco UCS](../solutions/cisco-ucs.md) |  |
| [CiscoWSAEvent](../parsers/ciscowsaevent.md) | [CiscoWSA](../solutions/ciscowsa.md) | `ProcessName == "cisco_wsa"` |
| [CitrixADCEvent](../parsers/citrixadcevent.md) | [Citrix ADC](../solutions/citrix-adc.md) |  |
| [CylancePROTECT](../parsers/cylanceprotect.md) | [Blackberry CylancePROTECT](../solutions/blackberry-cylanceprotect.md) | `SyslogMessage contains "AuditLog"`<br>`SyslogMessage contains "Device,"`<br>`SyslogMessage contains "DeviceControl"`<br>`SyslogMessage contains "ScriptControl"`<br>`SyslogMessage contains "Threat"` |
| [CylancePROTECT](../parsers/cylanceprotect.md) | [Blackberry CylancePROTECT](../solutions/blackberry-cylanceprotect.md) ⚠️ | `SyslogMessage contains "AuditLog"`<br>`SyslogMessage contains "Device,"`<br>`SyslogMessage contains "DeviceControl"`<br>`SyslogMessage contains "ScriptControl"`<br>`SyslogMessage contains "Threat"` |
| [CylancePROTECT-old](../parsers/cylanceprotect-old.md) | [Blackberry CylancePROTECT](../solutions/blackberry-cylanceprotect.md) ⚠️ |  |
| [CylancePROTECT-old](../parsers/cylanceprotect-old.md) | [Blackberry CylancePROTECT](../solutions/blackberry-cylanceprotect.md) ⚠️ |  |
| [DigitalGuardianDLPEvent](../parsers/digitalguardiandlpevent.md) | [Digital Guardian Data Loss Prevention](../solutions/digital-guardian-data-loss-prevention.md) | `SyslogMessage contains "managed_device_id"`<br>`SyslogMessage contains "number_of_incidents"` |
| [ESETPROTECT](../parsers/esetprotect.md) | [ESETPROTECT](../solutions/esetprotect.md) | `ProcessName == "ERAServer"` |
| [ESETPROTECT](../parsers/esetprotect.md) | [ESETPROTECT](../solutions/esetprotect.md) ⚠️ | `ProcessName == "ERAServer"` |
| [ExabeamEvent](../parsers/exabeamevent.md) | [Exabeam Advanced Analytics](../solutions/exabeam-advanced-analytics.md) | `ProcessName contains "Exabeam"` |
| [ExabeamEvent](../parsers/exabeamevent.md) | [Exabeam Advanced Analytics](../solutions/exabeam-advanced-analytics.md) ⚠️ | `ProcessName contains "Exabeam"` |
| [ForescoutEvent](../parsers/forescoutevent.md) | [Forescout (Legacy)](../solutions/forescout-legacy.md) |  |
| [GitLabAccess](../parsers/gitlabaccess.md) | [GitLab](../solutions/gitlab.md) | `Facility == "local7"`<br>`ProcessName == "GitLab-Access-Logs"`<br>`SyslogMessage contains "HTTP"`<br>`SyslogMessage has_any "DELETE,GET,PATCH,POST,PUT"` |
| [GitLabApp](../parsers/gitlabapp.md) | [GitLab](../solutions/gitlab.md) | `Facility == "local7"`<br>`ProcessName == "GitLab-Application-Logs"` |
| [GitLabAudit](../parsers/gitlabaudit.md) | [GitLab](../solutions/gitlab.md) | `Facility == "local7"`<br>`ProcessName == "GitLab-Audit-Logs"` |
| [ISCBind](../parsers/iscbind.md) | [ISC Bind](../solutions/isc-bind.md) | `SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` |
| [IllumioSyslogAuditEvents](../parsers/illumiosyslogauditevents.md) | [IllumioSaaS](../solutions/illumiosaas.md) | `SyslogMessage has "illumio_pce/agent"` |
| [IllumioSyslogNetworkTrafficEvents](../parsers/illumiosyslognetworktrafficevents.md) | [IllumioSaaS](../solutions/illumiosaas.md) | `SyslogMessage has "illumio_pce/collector"` |
| [InfobloxNIOS](../parsers/infobloxnios.md) | *(Legacy)* | `Facility == "local6"`<br>`ProcessName in "dhcpd,named"`<br>`ProcessName !in "dhcp,named"` |
| [Infoblox_allotherdhcpdTypes](../parsers/infoblox-allotherdhcpdtypes.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has_any "AccessRight,Added,AdminGroup,AdminMember,Created Role,DHCPACK,DHCPDISCOVER,DHCPEXPIRE,DHCPINFORM,DHCPOFFER,DHCPRELEASE,Login_Allowed,Login_Denied,Option,Removed,balanced,balancing,bind,delegatedzone,failover,forwardzone,r-l-e"` |
| [Infoblox_allotherdnsTypes](../parsers/infoblox-allotherdnstypes.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has_any "client,gss_accept_sec_context"` |
| [Infoblox_allotherlogTypes](../parsers/infoblox-allotherlogtypes.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) |  |
| [Infoblox_dhcpack](../parsers/infoblox-dhcpack.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage startswith "DHCPACK"` |
| [Infoblox_dhcpadded](../parsers/infoblox-dhcpadded.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "Added"` |
| [Infoblox_dhcpbindupdate](../parsers/infoblox-dhcpbindupdate.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "bind"` |
| [Infoblox_dhcpdiscover](../parsers/infoblox-dhcpdiscover.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage startswith "DHCPDISCOVER"` |
| [Infoblox_dhcpexpire](../parsers/infoblox-dhcpexpire.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "DHCPEXPIRE"` |
| [Infoblox_dhcpinform](../parsers/infoblox-dhcpinform.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "DHCPINFORM"` |
| [Infoblox_dhcpoffer](../parsers/infoblox-dhcpoffer.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "DHCPOFFER"` |
| [Infoblox_dhcpoption](../parsers/infoblox-dhcpoption.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "Option"` |
| [Infoblox_dhcpother](../parsers/infoblox-dhcpother.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has_any "AccessRight,AdminGroup,AdminMember,Created Role,Login_Allowed,Login_Denied,balanced,balancing,delegatedzone,failover,forwardzone"` |
| [Infoblox_dhcprelease](../parsers/infoblox-dhcprelease.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "DHCPRELEASE"` |
| [Infoblox_dhcpremoved](../parsers/infoblox-dhcpremoved.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "Removed"` |
| [Infoblox_dhcprequest](../parsers/infoblox-dhcprequest.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "DHCPREQUEST"` |
| [Infoblox_dhcpsession](../parsers/infoblox-dhcpsession.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "r-l-e"` |
| [Infoblox_dnsclient](../parsers/infoblox-dnsclient.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` |
| [Infoblox_dnsgss](../parsers/infoblox-dnsgss.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "gss_accept_sec_context"` |
| [Infoblox_dnszone](../parsers/infoblox-dnszone.md) | [Infoblox NIOS](../solutions/infoblox-nios.md) | `SyslogMessage has "zone"` |
| [IvantiUEMEvent](../parsers/ivantiuemevent.md) | [Ivanti Unified Endpoint Management](../solutions/ivanti-unified-endpoint-management.md) | `SyslogMessage has_all "Alert"` |
| [JuniperSRX](../parsers/junipersrx.md) | [Juniper SRX](../solutions/juniper-srx.md) | `ProcessName == "RT_FLOW"`<br>`ProcessName in "RT_IDS,sshd"`<br>`ProcessName !in "sshd,RT_IDS,RT_FLOW"` |
| [JuniperSRX](../parsers/junipersrx.md) | [Juniper SRX](../solutions/juniper-srx.md) ⚠️ |  |
| [McAfeeEPOEvent](../parsers/mcafeeepoevent.md) | [McAfee ePolicy Orchestrator](../solutions/mcafee-epolicy-orchestrator.md) | `ProcessName contains "EPOEvents"`<br>`SyslogMessage contains "<EPOevent>"`<br>`SyslogMessage contains "<UpdateEvents>"` |
| [McAfeeNSPEvent](../parsers/mcafeenspevent.md) | [McAfee Network Security Platform](../solutions/mcafee-network-security-platform.md) | `ProcessName == "SyslogAlertForwarderNSP"` |
| [OpenVpnEvent](../parsers/openvpnevent.md) | [OpenVPN](../solutions/openvpn.md) | `ProcessName == "openvpn"` |
| [OracleDatabaseAuditEvent](../parsers/oracledatabaseauditevent.md) | [OracleDatabaseAudit](../solutions/oracledatabaseaudit.md) | `SyslogMessage contains "Oracle Unified Audit"` |
| [OracleDatabaseAuditEvent](../parsers/oracledatabaseauditevent.md) | [OracleDatabaseAudit](../solutions/oracledatabaseaudit.md) ⚠️ | `SyslogMessage contains "Oracle Unified Audit"` |
| [PulseConnectSecure](../parsers/pulseconnectsecure.md) | [Pulse Connect Secure](../solutions/pulse-connect-secure.md) | `Facility == "local7"` |
| [PureStorageFlashArrayParserV1](../parsers/purestorageflasharrayparserv1.md) | [Pure Storage](../solutions/pure-storage.md) | `SyslogMessage has "purity.alert"` |
| [PureStorageFlashBladeParserV1](../parsers/purestorageflashbladeparserv1.md) | [Pure Storage](../solutions/pure-storage.md) | `SyslogMessage has "purity.alert"` |
| [RSASecurIDAMEvent](../parsers/rsasecuridamevent.md) | [RSA SecurID](../solutions/rsa-securid.md) |  |
| [SophosXGFirewall](../parsers/sophosxgfirewall.md) | [Sophos XG Firewall](../solutions/sophos-xg-firewall.md) | `Facility == "local0"` |
| [StealthwatchEvent](../parsers/stealthwatchevent.md) | [Cisco Secure Cloud Analytics](../solutions/cisco-secure-cloud-analytics.md) | `SyslogMessage has "Stealthwatch"` |
| [SymantecEndpointProtection](../parsers/symantecendpointprotection.md) | [Symantec Endpoint Protection](../solutions/symantec-endpoint-protection.md) | `ProcessName == "SymantecServer"` |
| [SymantecProxySG](../parsers/symantecproxysg.md) | *(Legacy)* | `Computer == "datasource"`<br>`Facility == "local0"` |
| [SymantecProxySG](../parsers/symantecproxysg.md) | [SymantecProxySG](../solutions/symantecproxysg.md) | `Facility == "local0"` |
| [SymantecVIP](../parsers/symantecvip.md) | [Symantec VIP](../solutions/symantec-vip.md) | `Facility == "local5"` |
| [SyslogEventTypeData](../parsers/syslogeventtypedata.md) | *(Legacy)* |  |
| [SyslogExecve](../parsers/syslogexecve.md) | *(Legacy)* |  |
| [SyslogSyscall](../parsers/syslogsyscall.md) | *(Legacy)* |  |
| [SyslogUserErr](../parsers/syslogusererr.md) | *(Legacy)* |  |
| [VMwareESXi](../parsers/vmwareesxi.md) | [VMWareESXi](../solutions/vmwareesxi.md) | `ProcessName has_any "hostd-probe,vmkwarning,vpxd-main"` |
| [Veeam_GetFinishedConfigurationBackupSessions](../parsers/veeam-getfinishedconfigurationbackupsessions.md) | [Veeam](../solutions/veeam.md) | `SyslogMessage has "instanceId"` |
| [Veeam_GetJobFinished](../parsers/veeam-getjobfinished.md) | [Veeam](../solutions/veeam.md) | `SyslogMessage has "instanceId"` |
| [Veeam_GetSecurityEvents](../parsers/veeam-getsecurityevents.md) | [Veeam](../solutions/veeam.md) | `SyslogMessage has "instanceId"` |
| [Veeam_GetVeeamONEAlarms](../parsers/veeam-getveeamonealarms.md) | [Veeam](../solutions/veeam.md) | `SyslogMessage has "predefined_alarm_id"` |
| [WatchGuardFirebox](../parsers/watchguardfirebox.md) | [Watchguard Firebox](../solutions/watchguard-firebox.md) ⚠️ |  |
| [WatchGuardFirebox](../parsers/watchguardfirebox.md) | [Watchguard Firebox](../solutions/watchguard-firebox.md) |  |
...
## Selection Criteria Summary (101 criteria, 451 total references)

References by type: 30 connectors, 340 content items, 22 ASIM parsers, 59 other parsers.
...
| `SyslogMessage has "The Filer has detected a new ransomware attack"` | - | 1 | - | - | **1** |
| `SyslogMessage has "The Filer has enforced the mitigation policy on volume"` | - | 1 | - | - | **1** |
| `SyslogMessage has "invalid username or password"`<br>`SyslogMessage has "purity.alert"` | - | 1 | - | - | **1** |
| `Facility == "authpriv"`<br>`SyslogMessage has "authentication failure"`<br>`SyslogMessage has "uid=0"`<br>`SyslogMessage has "user unknown"` | - | 1 | - | - | **1** |
| `ProcessName == "sshd"`<br>`SyslogMessage contains "Failed password for invalid user"` | - | 1 | - | - | **1** |
...
| `Facility == "cron"`<br>`ProcessName == "crontab"`<br>`SeverityLevel == "info"` | - | 1 | - | - | **1** |
| `SyslogMessage has "AUOMS_EXECVE"` | - | 1 | - | - | **1** |
| `Facility == "user"`<br>`SyslogMessage has "AUOMS_EXECVE"`<br>`SyslogMessage has "jndi"`<br>`SyslogMessage has_any "corba,dns,iiop,ldap,nds,nis,rmi"` | - | 1 | - | - | **1** |
| `ProcessName == "gw-audit"`<br>`SyslogMessage contains "ctera_audit"`<br>`SyslogMessage contains "op=delete"` | - | 1 | - | - | **1** |
| `SyslogMessage has "disk=Policy"`<br>`SyslogMessage has "disk=Traffic"`<br>`SyslogMessage has "illumio_pce/system_health"`<br>`SyslogMessage has "src=collector"`<br>`SyslogMessage has "src=disk_latency"`<br>`SyslogMessage has "src=flow_analytics"` | - | 1 | - | - | **1** |
...
| `ProcessName has "CISE_Administrative_and_Operational_Audit"`<br>`SyslogMessage has "Administrator-Login"` | - | - | 1 | - | **1** |
| `ProcessName == "Twistlock-Console"` | - | - | 1 | - | **1** |
...
| `ProcessName == "sudo"`<br>`SyslogMessage has "COMMAND="`<br>`SyslogMessage has "TTY="`<br>`SyslogMessage has "USER="`<br>`SyslogMessage has "incorrect password attempts"`<br>`SyslogMessage has "session closed for user"`<br>`SyslogMessage has "user NOT in sudoers"` | - | - | 1 | - | **1** |
| `ProcessName == "named"`<br>`SyslogMessage !has "response:"`<br>`SyslogMessage has_all "client"` | - | - | 1 | - | **1** |
| `SyslogMessage has "<Provider Name="`<br>`SyslogMessage has_any "<EventID>23</EventID>,<EventID>26</EventID>"` | - | - | 1 | - | **1** |
| `ProcessName in "cz-sessiond,cz-vpnd"`<br>`SyslogMessage has_all "[AUDIT]"`<br>`SyslogMessage has_any ":"` | - | - | 1 | - | **1** |
| `Computer == "CiscoMeraki"` | - | - | 1 | - | **1** |
...
|  | `Twistlock-Console` | - | - | 1 | - | **1** |
|  | `su` | - | - | 1 | - | **1** |
|  | `sudo` | - | - | 1 | - | **1** |
|  | `named` | - | - | 1 | - | **1** |
|  | `cz-sessiond` | - | - | 1 | - | **1** |
|  | `cz-vpnd` | - | - | 1 | - | **1** |
| `authpriv` | `gpasswd` | - | - | 1 | - | **1** |
| `authpriv` | `groupadd` | - | - | 1 | - | **1** |
| `authpriv` | `groupdel` | - | - | 1 | - | **1** |
| `authpriv` | `groupmod` | - | - | 1 | - | **1** |
| `authpriv` | `useradd` | - | - | 1 | - | **1** |
| `authpriv` | `userdel` | - | - | 1 | - | **1** |
| `authpriv` | `usermod` | - | - | 1 | - | **1** |
| `local6` | `dhcpd` | - | - | - | 1 | **1** |
| `local6` | `named` | - | - | - | 1 | **1** |
| `local6` | `!= dhcp` | - | - | - | 1 | **1** |
| `local6` | `!= named` | - | - | - | 1 | **1** |
...
| `contains managed_device_id` | 1 | 21 | - | 1 | **23** |
...
| `contains VCF Alert` | - | 2 | - | - | **2** |
| `contains VCF Drop` | - | 2 | - | - | **2** |
| `has jndi` | - | 2 | - | - | **2** |
| `has_any corba` | - | 2 | - | - | **2** |
| `has_any dns` | - | 2 | - | - | **2** |
| `has_any iiop` | - | 2 | - | - | **2** |
...
| `has_any Created Role` | - | - | - | 2 | **2** |
| `has_any Login_Allowed` | - | - | - | 2 | **2** |
| `has_any Login_Denied` | - | - | - | 2 | **2** |
| `has_any balanced` | - | - | - | 2 | **2** |
| `has_any balancing` | - | - | - | 2 | **2** |
| `has_any delegatedzone` | - | - | - | 2 | **2** |
| `has_any failover` | - | - | - | 2 | **2** |
| `has_any forwardzone` | - | - | - | 2 | **2** |
| `contains gw-audit[-]:` | 1 | - | - | - | **1** |
| `contains portal portal[-]:` | 1 | - | - | - | **1** |
| `contains found an infected file` | - | 1 | - | - | **1** |
| `contains Ransomware incident detected` | - | 1 | - | - | **1** |
| `contains Ransom Protect mechanism blocked` | - | 1 | - | - | **1** |
| `has The Filer has detected a new ransomware attack` | - | 1 | - | - | **1** |
| `has The Filer has enforced the mitigation policy on volume` | - | 1 | - | - | **1** |
| `has invalid username or password` | - | 1 | - | - | **1** |
| `has authentication failure` | - | 1 | - | - | **1** |
| `has uid=0` | - | 1 | - | - | **1** |
| `has user unknown` | - | 1 | - | - | **1** |
...
| `has disk=Policy` | - | 1 | - | - | **1** |
| `has disk=Traffic` | - | 1 | - | - | **1** |
| `has illumio_pce/system_health` | - | 1 | - | - | **1** |
| `has src=collector` | - | 1 | - | - | **1** |
| `has src=disk_latency` | - | 1 | - | - | **1** |
| `has src=flow_analytics` | - | 1 | - | - | **1** |
| `contains runas` | - | 1 | - | - | **1** |
| `contains sudo` | - | 1 | - | - | **1** |
| `has_any ALTER TABLE` | - | 1 | - | - | **1** |
| `has_any CREATE TABLE` | - | 1 | - | - | **1** |
| `has_any DROP TABLE` | - | 1 | - | - | **1** |
| `has_any database modified` | - | 1 | - | - | **1** |
| `has_any schema change` | - | 1 | - | - | **1** |
| `has_any auditd stopped` | - | 1 | - | - | **1** |
| `has_any logging stopped` | - | 1 | - | - | **1** |
| `has_any rsyslog stopped` | - | 1 | - | - | **1** |
| `has_any syslog stopped` | - | 1 | - | - | **1** |
| `has_any edit` | - | 1 | - | - | **1** |
| `has_any registry` | - | 1 | - | - | **1** |
| `has_any checksum mismatch` | - | 1 | - | - | **1** |
| `has_any file deleted` | - | 1 | - | - | **1** |
| `has_any file modified` | - | 1 | - | - | **1** |
| `has_any file tamper` | - | 1 | - | - | **1** |
| `contains ACTION=VCF` | - | 1 | - | - | **1** |
| `has LOGIN_USER_EVENT` | - | - | 1 | - | **1** |
| `has LOGOFF_USER_EVENT` | - | - | 1 | - | **1** |
| `has Accepted password` | - | - | 1 | - | **1** |
| `has Failed password` | - | - | 1 | - | **1** |
| `startswith %FTD-5-199017` | - | - | 1 | - | **1** |
| `has %SEC_LOGIN-4-LOGIN_FAILED` | - | - | 1 | - | **1** |
| `has %SEC_LOGIN-5-LOGIN_SUCCESS` | - | - | 1 | - | **1** |
| `has %SYS-6-LOGOUT` | - | - | 1 | - | **1** |
| `has Administrator-Login` | - | - | 1 | - | **1** |
| `has Failed` | - | - | 1 | - | **1** |
| `has but this does not map back to the address` | - | - | 1 | - | **1** |
| `has key RSA` | - | - | 1 | - | **1** |
| `has publickey` | - | - | 1 | - | **1** |
| `startswith Accepted` | - | - | 1 | - | **1** |
| `startswith Failed` | - | - | 1 | - | **1** |
| `startswith Invalid user` | - | - | 1 | - | **1** |
| `startswith Nasty PTR record` | - | - | 1 | - | **1** |
| `startswith Timeout` | - | - | 1 | - | **1** |
| `startswith message repeated` | - | - | 1 | - | **1** |
| `startswith reverse mapping checking getaddrinfo for` | - | - | 1 | - | **1** |
| `has_all pam_unix(su` | - | - | 1 | - | **1** |
| `startswith FAILED SU` | - | - | 1 | - | **1** |
| `startswith Successful su for` | - | - | 1 | - | **1** |
| `has COMMAND=` | - | - | 1 | - | **1** |
| `has TTY=` | - | - | 1 | - | **1** |
| `has USER=` | - | - | 1 | - | **1** |
| `has incorrect password attempts` | - | - | 1 | - | **1** |
| `has session closed for user` | - | - | 1 | - | **1** |
| `has user NOT in sudoers` | - | - | 1 | - | **1** |
| `has <Provider Name=` | - | - | 1 | - | **1** |
| `has_any <EventID>23</EventID>` | - | - | 1 | - | **1** |
| `has_any <EventID>26</EventID>` | - | - | 1 | - | **1** |
| `has_all [AUDIT]` | - | - | 1 | - | **1** |
| `has_any :` | - | - | 1 | - | **1** |
| `!has 3000-0151` | - | - | 1 | - | **1** |
| `!has icmp` | - | - | 1 | - | **1** |
...
| `has_any Added` | - | - | - | 1 | **1** |
| `has_any DHCPACK` | - | - | - | 1 | **1** |
| `has_any DHCPDISCOVER` | - | - | - | 1 | **1** |
| `has_any DHCPEXPIRE` | - | - | - | 1 | **1** |
| `has_any DHCPINFORM` | - | - | - | 1 | **1** |
| `has_any DHCPOFFER` | - | - | - | 1 | **1** |
| `has_any DHCPRELEASE` | - | - | - | 1 | **1** |
| `has_any Option` | - | - | - | 1 | **1** |
| `has_any Removed` | - | - | - | 1 | **1** |
| `has_any bind` | - | - | - | 1 | **1** |
| `has_any r-l-e` | - | - | - | 1 | **1** |

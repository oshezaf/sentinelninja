...
Reference for AppServiceAuditLogs table in Azure Monitor Logs.
...
- [AppServiceAuditLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/appserviceauditlogs)

...
|:----------|:------|
| **Category** | Normalized |
| **Source Vendor** | CrowdStrike, Synqly *(basis: projected)* |
| **Source Product** | Falcon Data Replicator, Integration *(basis: projected)* |
...
- [ASimUserManagementActivityLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/asimusermanagementactivitylogs)
...
|:-------|:-------|:--------|:-------------------|
| [ASimUserManagementNative](../asim/asimusermanagementnative.md) | UserManagement | Native |  |

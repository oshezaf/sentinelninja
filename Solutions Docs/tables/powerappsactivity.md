...
Reference for PowerAppsActivity table in Azure Monitor Logs.
...
| **Azure Monitor Tables Reference** | [View Documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerappsactivity) |

## Schema (19 columns)

**Source:** [Azure Monitor documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerappsactivity)
...
| AdditionalInfo | dynamic | Additional information if any (e.g. the environment name) |
...
- [PowerAppsActivity Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerappsactivity)

...
| EventCategory | string | Audit category of this event. <code>ResourceManagement</code> stands for management plane operations, <code>ApplicationManagement</code> stands for data plane operations. |
...
- [AACAudit Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/aacaudit)

...
| EventCategory | string | Audit category of this event.ResourceManagementstands for management plane operations,ApplicationManagementstands for data plane operations. |

...
| **Source Product** | AC, ASA, ASA/FTD, Admin Console, Apex Central, Apex One, Auditor, Awake Security, CASB, ClearPass, Core, Cortex Data Lake, Cortex XDR, DLP, Data Connector, DataStream for Microsoft Sentinel, DataStream for Microsoft Sentinel data lake, Deep Security, Director Proxy, ESA_CONSOLIDATED_LOG_EVENT, Elements, Email, FalconHost, Firepower, Firewall, FortiWeb Web Application Firewall, Fortigate, Fortiweb, Identity Platform, IronDefense, IronDome, LF, N2OS, NGFW, NSSAuditlog, NSSCasbactivitylog, NSSCasbcloudstoragelog, NSSCasbcollablog, NSSCasbcrmlog, NSSCasbemaillog, NSSCasbfilesharinglog, NSSCasbitsmlog, NSSCasbrepolog, NSSDNSlog, NSSEmaildlplog, NSSEndpointdlplog, NSSFWlog, NSSTunnellog, NSSWeblog, NetScaler, Network Security, Networks, OSP, PAN-OS, Reveal, SPS, Secret Server, Secure Email Gateway, Threat Intelligence Platforms, TippingPoint, Vault, Votiro cloud, WAF Gateway, Web, Web Application Firewall, WireX NFP, X Series, akamai_siem, iSID, illusive, xDome |

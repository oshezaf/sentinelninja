...
|:----------|:------|
| **Category** | Syslog/CEF |
| **Source Vendor** | Akamai, Any, Arista Networks, Aruba Networks, Barracuda, Cisco, Citrix, Claroty, Contrast Security, CrowdStrike, CyberArk, Darktrace, Delinea, ExtraHop, F5, FireEye, Forcepoint, ForgeRock, Fortinet, Illumio, Imperva, Infoblox, IronNet, Microsoft, Netwrix, Nozomi Networks, OSSEC, Onapsis, One Identity, Palo Alto Networks, Ping Identity, Radiflow, RidgeSecurity, Silverfort, SonicWall, Symantec, Trend Micro, Vectra, VirtualMetric, Votiro, WireX Systems, WithSecure, Zscaler, iboss, illusive, vArmour *(basis: projected)* |
| **Source Product** | AC, ASA, ASA/FTD, Admin Console, Apex Central, Apex One, Auditor, Awake Security, CASB, ClearPass, Cloud, Core, Cortex Data Lake, Cortex XDR, DLP, DataStream, Deep Security, Director Proxy, Elements, Email, Enterprise Password Vault, Falcon Endpoint Protection, Firepower, Firewall, FortiWeb Web Application Firewall, Fortigate, Fortiweb, Identity Platform, IronDefense, IronDome, LF, N2OS, NGFW, NSSAuditlog, NSSCasbactivitylog, NSSCasbcloudstoragelog, NSSCasbcollablog, NSSCasbcrmlog, NSSCasbemaillog, NSSCasbfilesharinglog, NSSCasbitsmlog, NSSCasbrepolog, NSSDNSlog, NSSEmaildlplog, NSSEndpointdlplog, NSSFWlog, NSSTunnellog, NSSWeblog, NetScaler, Network Security, Networks, OSP, PAN-OS, Privilege Access Manager, Reveal, SOC Insight, SPS, Secret Server, Secure Email Gateway, Threat Intelligence Platforms, TippingPoint, Votiro cloud, WAF Gateway, Web, Web Application Firewall, WireX NFP, X Series, akamai_siem, iSID, illusive, xDome *(basis: projected)* |
| **Event Type** | Logs, Security Events |

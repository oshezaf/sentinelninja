...
| **Source Product** | AC, ASA, ASA/FTD, Admin Console, Apex Central, Apex One, Auditor, Awake Security, CASB, ClearPass, Cloud, Core, Cortex Data Lake, Cortex XDR, DLP, DataStream, Deep Security, Director Proxy, Elements, Email, Enterprise Password Vault, Falcon Endpoint Protection, Federate, Firepower, Firewall, FortiWeb Web Application Firewall, Fortigate, Fortiweb, Identity Platform, IronDefense, IronDome, LF, N2OS, NGFW, NSSAuditlog, NSSCasbactivitylog, NSSCasbcloudstoragelog, NSSCasbcollablog, NSSCasbcrmlog, NSSCasbemaillog, NSSCasbfilesharinglog, NSSCasbitsmlog, NSSCasbrepolog, NSSDNSlog, NSSEmaildlplog, NSSEndpointdlplog, NSSFWlog, NSSTunnellog, NSSWeblog, NetScaler, Network Security, Networks, OSP, PAN-OS, Privilege Access Manager, Protect, Reveal, SOC Insight, SPS, Secret Server, Secure Email Gateway, Threat Intelligence Platforms, TippingPoint, Votiro cloud, WAF Gateway, Web, Web Application Firewall, WireX NFP, X Series, iSID, illusive, xDome *(basis: projected)* |
| **Event Type** | Events |

...
## Content Items Using This Table (266)
...
## Selection Criteria Summary (153 criteria, 380 total references)

References by type: 83 connectors, 232 content items, 30 ASIM parsers, 35 other parsers.
...
| `DeviceVendor == "Palo Alto Networks"` | - | 3 | - | - | **3** |

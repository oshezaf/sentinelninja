...
Reference for AutoscaleScaleActionsLog table in Azure Monitor Logs.
...
- [AutoscaleScaleActionsLog Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/autoscalescaleactionslog)

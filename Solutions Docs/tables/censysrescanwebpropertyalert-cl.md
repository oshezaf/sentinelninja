...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/CensysRescanWebPropertyAlert_CL.json)
...
| resource_cert_ct_entries_comodo_mammoth_2026_h1_s | string |
| resource_cert_ct_entries_comodo_sabre_2026_h1_s | string |
| resource_cert_ct_entries_google_argon_2026_h1_s | string |
| resource_cert_ct_entries_google_xenon_2026_h1_s | string |
| resource_cert_ct_entries_letsencrypt_ct_oak_2026_h1_s | string |
| resource_cert_ct_entries_letsencrypt_ct_sycamore_2026_h2_s | string |
| resource_cert_ct_entries_letsencrypt_ct_willow_2026_h2_s | string |
...
| resource_cert_ever_seen_in_scan_b | bool |
...
| resource_cert_parsed_serial_number_hex_g | string |
...
| resource_cert_parsed_signature_valid_b | bool |
...
| resource_cert_revocation_ocsp_reason_s | string |
...
| resource_cert_validation_apple_ever_valid_b | bool |
| resource_cert_validation_apple_had_trusted_path_b | bool |
| resource_cert_validation_apple_has_trusted_path_b | bool |
| resource_cert_validation_apple_is_valid_b | bool |
...
| resource_cert_validation_chrome_ever_valid_b | bool |
| resource_cert_validation_chrome_had_trusted_path_b | bool |
| resource_cert_validation_chrome_has_trusted_path_b | bool |
| resource_cert_validation_chrome_is_valid_b | bool |
...
| resource_cert_validation_microsoft_ever_valid_b | bool |
| resource_cert_validation_microsoft_had_trusted_path_b | bool |
| resource_cert_validation_microsoft_has_trusted_path_b | bool |
| resource_cert_validation_microsoft_is_valid_b | bool |
...
| resource_cert_validation_nss_ever_valid_b | bool |
| resource_cert_validation_nss_had_trusted_path_b | bool |
| resource_cert_validation_nss_has_trusted_path_b | bool |
| resource_cert_validation_nss_is_valid_b | bool |
| resource_cert_validation_nss_parents_s | string |
| resource_cert_validation_nss_type_s | string |
| resource_cert_zlint_errors_present_b | bool |
| resource_cert_zlint_failed_lints_s | string |
| resource_cert_zlint_notices_present_b | bool |

...
Reference for AppPlatformSystemLogs table in Azure Monitor Logs.
...
- [AppPlatformSystemLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/appplatformsystemlogs)

...
| activity_uuid_s | string |
| id_orig_h_s | string |
| id_orig_p_d | real |
| id_resp_h_s | string |
| id_resp_p_d | real |
| interface_uuid_s | string |
| object_uuid_s | string |
| operation_s | string |
| packet_type_d | real |
| server_boot_time_d | real |
...
|:-------|:---------|:-------------------|
| [corelight_profinet_dce_rpc](../parsers/corelight-profinet-dce-rpc.md) | [Corelight](../solutions/corelight.md) |  |

...
Reference for UAIESiteDiscovery table in Azure Monitor Logs.
...
- [UAIESiteDiscovery Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/uaiesitediscovery)

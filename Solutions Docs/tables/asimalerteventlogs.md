...
Reference for ASimAlertEventLogs table in Azure Monitor Logs.
...
- [ASimAlertEventLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/asimalerteventlogs)

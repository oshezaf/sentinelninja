...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_socks_CL.json)
...
| id_resp_p_d | real |
| password_s | string |
| request_host_s | string |
| request_name_s | string |
| request_p_d | real |
| status_s | string |
...
|:-------|:---------|:-------------------|
| [corelight_socks](../parsers/corelight-socks.md) | [Corelight](../solutions/corelight.md) |  |

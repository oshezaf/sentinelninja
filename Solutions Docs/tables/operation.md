...
- [Operation Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/operation)
...
| Workbook | Selection Criteria |
|:-------------|:-------------------|
| [DataCollectionHealthMonitoring](../content/github-only-datacollectionhealthmonitoring-360bf8be.md) | `OperationStatus in "Error,Failed,Failure,Warning"` |
...
| [WorkspaceUsage](../content/github-only-workspaceusage-97e7cfa7.md) | `OperationCategory in "Data Collection Status,Workspace Configuration"` |

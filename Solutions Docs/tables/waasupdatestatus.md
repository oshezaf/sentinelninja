...
Reference for WaaSUpdateStatus table in Azure Monitor Logs.
...
- [WaaSUpdateStatus Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/waasupdatestatus)

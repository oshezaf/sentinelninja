...
|:------------|:-----|
| action | int |
| digest_assignedTo | string |
| digest_criticalResourceName | string |
| digest_org | string |
| digest_resourceLabel | string |
| digest_resourceType | string |
| digest_severityCategory | string |
| digest_status | string |
| digest_ticketKeyDescription | string |
| digest_ticketKeyName | string |
| digest_ticketSrn | string |
| digest_title | string |

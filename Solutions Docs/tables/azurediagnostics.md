...
**In solution [AzureSecurityBenchmark](../solutions/azuresecuritybenchmark.md):** `Category in "All,AzureFirewallNetworkRule,NetworkSecurityGroupRuleCounter"`<br>`ResourceProvider == "MICROSOFT.KEYVAULT"`<br>`ResourceType == "AZUREFIREWALLS"`
...
| [AzureOpenAIMonitoring](../content/github-only-azureopenaimonitoring-99c696c7.md) | `Category == "RequestResponse"`<br>`ResourceProvider in "MICROSOFT.COGNITIVESERVICES,MICROSOFT.LOGIC"` |
...
| [PlaybookHealth](../content/github-only-playbookhealth-6ce06262.md) | `ResourceProvider == "MICROSOFT.LOGIC"` |
...
## Selection Criteria Summary (38 criteria, 79 total references)

References by type: 14 connectors, 64 content items, 0 ASIM parsers, 1 other parsers.

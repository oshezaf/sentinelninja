...
Reference for RetinaNetworkFlowLogs table in Azure Monitor Logs.
...
- [RetinaNetworkFlowLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/retinanetworkflowlogs)

...
| Hunting Query | Selection Criteria |
|:-------------|:-------------------|
| [Process accessed LSASS from unbacked memory](../content/standalone-content-process-accessed-lsass-from-unbacked-memory-a1b305af-363b-4b70-a3be-ca54ad3a088c-a8385b0e.md) | `EventData has "UNKNOWN"`<br>`EventData has "lsass.exe"`<br>`EventID == "10"`<br>`Provider == "Microsoft-Windows-Sysmon"` |
...
## Selection Criteria Summary (32 criteria, 36 total references)

References by type: 0 connectors, 24 content items, 12 ASIM parsers, 0 other parsers.
...
| `EventData has "UNKNOWN"`<br>`EventData has "lsass.exe"`<br>`EventID == "10"`<br>`Provider == "Microsoft-Windows-Sysmon"` | - | 1 | - | - | **1** |
...
| Value | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `Microsoft-Windows-Sysmon` | - | 1 | 6 | - | **7** |

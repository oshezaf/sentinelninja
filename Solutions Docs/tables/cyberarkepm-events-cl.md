...
| Attribute | Value |
|:----------|:------|
| **Source Vendor** | CyberArk *(basis: projected)* |
...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/CyberArkEPM_Events_CL.json)

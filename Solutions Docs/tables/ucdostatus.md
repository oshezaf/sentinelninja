...
Reference for UCDOStatus table in Azure Monitor Logs.
...
- [UCDOStatus Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/ucdostatus)

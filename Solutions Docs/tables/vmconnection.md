...
- [VMConnection Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/vmconnection)
...
| [VirtualMachinesInsights](../content/github-only-virtualmachinesinsights-20d3646a.md) | `Computer in "ADE-Linux1,ADE-Linux2,DockerTest,FortiCEF,FortiWin,LoginTest,PaloAltoEF,Romeo-GoldenBox,TianderCEF,WIN01,mor-dns-test"`<br>`Direction == "inbound"` |

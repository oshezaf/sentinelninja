...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/DataminrPulse_relAlerts_CL.json)

| Column Name | Type |
|:------------|:-----|
| alert_relatedTo | string |

...
| MessageSubtype | string | Subtype of the message |
...
| ThreadName | string | Name of the thread that the message is part of |
| ThreadSubType | string | Indicates the channel type, possible values: None, PrivateChannel |
| ThreadType | string | Type of the thread that the message is part of |
...
- [MessageEvents Schema Reference (Defender XDR)](https://learn.microsoft.com/en-us/defender-xdr/advanced-hunting-messageevents-table)

...
| **Source Product** | Cloud Security, Umbrella *(basis: projected)* |
...
**Source:** [Connector definition](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/CiscoUmbrella%5CData%20Connectors%5CCiscoUmbrella_CCP/CiscoUmbrellaAdminAudit_table.json)
...
| Email | string | The email of the user that triggered the event. |

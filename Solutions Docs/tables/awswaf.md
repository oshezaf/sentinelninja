...
| **Source Product** | S3 WAF *(basis: projected)* |
...
- [AWSWAF Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/awswaf)

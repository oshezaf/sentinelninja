...
Reference for MAOfficeBuildInfo table in Azure Monitor Logs.
...
- [MAOfficeBuildInfo Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/maofficebuildinfo)

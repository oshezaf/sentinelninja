...
Reference for AppMetrics table in Azure Monitor Logs.
...
- [AppMetrics Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/appmetrics)

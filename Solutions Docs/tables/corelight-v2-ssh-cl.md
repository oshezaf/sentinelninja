...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_ssh_CL.json)
...
|:-------|:---------|:-------------------|
| [corelight_ssh](../parsers/corelight-ssh.md) | [Corelight](../solutions/corelight.md) |  |

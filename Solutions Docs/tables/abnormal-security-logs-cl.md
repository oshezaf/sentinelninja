...
**Source:** [Connector definition](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/AbnormalSecurity/Data%20Connectors/AbnormalSecurity_CCF/AbnormalSecurity_table_AbnormalSecurityLogs.json)

| Column Name | Type | Description |
|:------------|:-----|:------------|
| abx_body | string | Generic Abnormal Security event payload (fallback for unrecognized event types) |

...
Reference for PowerPlatformDlpActivity table in Azure Monitor Logs.
...
| **Azure Monitor Tables Reference** | [View Documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerplatformdlpactivity) |

## Schema (19 columns)

**Source:** [Azure Monitor documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerplatformdlpactivity)
...
| PolicyName | string | Name of the DLP policy. |
...
- [PowerPlatformDlpActivity Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/powerplatformdlpactivity)

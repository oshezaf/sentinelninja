...
| **Source Product** | S3 DNS Route53 *(basis: projected)* |
...
- [AWSRoute53Resolver Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/awsroute53resolver)

...
## Selection Criteria Summary (8 criteria, 17 total references)
...
| `InitiatingProcessCommandLine has "rundll32.exe"`<br>`InitiatingProcessFileName == "rundll32.exe"` | - | 1 | - | - | **1** |

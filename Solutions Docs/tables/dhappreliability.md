...
Reference for DHAppReliability table in Azure Monitor Logs.
...
- [DHAppReliability Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/dhappreliability)

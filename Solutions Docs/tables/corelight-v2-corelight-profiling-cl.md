...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_corelight_profiling_CL.json)
...
| node_s | string |
| prof_core_stack_s | string |
| prof_sched_wait_ns_d | real |
| prof_script_stack_s | string |
...
|:-------|:---------|:-------------------|
| [corelight_corelight_profiling](../parsers/corelight-corelight-profiling.md) | [Corelight](../solutions/corelight.md) |  |

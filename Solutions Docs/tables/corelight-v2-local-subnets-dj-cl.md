...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_local_subnets_dj_CL.json)
...
|:-------|:---------|:-------------------|
| [corelight_local_subnets_dj](../parsers/corelight-local-subnets-dj.md) | [Corelight](../solutions/corelight.md) |  |

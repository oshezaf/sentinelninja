...
Reference for HDInsightSparkExtraEvents table in Azure Monitor Logs.
...
- [HDInsightSparkExtraEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/hdinsightsparkextraevents)

...
| **Source Product** | Cloud Platform Compute Engine *(basis: projected)* |
...
- [GCPComputeEngine Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/gcpcomputeengine)

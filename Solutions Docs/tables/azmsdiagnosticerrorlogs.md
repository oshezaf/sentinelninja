...
Reference for AZMSDiagnosticErrorLogs table in Azure Monitor Logs.
...
- [AZMSDiagnosticErrorLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/azmsdiagnosticerrorlogs)

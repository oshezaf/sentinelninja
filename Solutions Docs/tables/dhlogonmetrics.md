...
Reference for DHLogonMetrics table in Azure Monitor Logs.
...
- [DHLogonMetrics Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/dhlogonmetrics)

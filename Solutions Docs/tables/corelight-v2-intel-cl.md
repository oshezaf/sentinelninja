...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_intel_CL.json)
...
| id_resp_p_d | real |
| matched_s | string |
| seen_indicator_s | string |
| seen_indicator_type_s | string |
| seen_where_s | string |
| sources_s | string |
...
|:-------|:---------|:-------------------|
| [corelight_intel](../parsers/corelight-intel.md) | [Corelight](../solutions/corelight.md) |  |

...
Reference for AGWPerformanceLogs table in Azure Monitor Logs.
...
- [AGWPerformanceLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/agwperformancelogs)

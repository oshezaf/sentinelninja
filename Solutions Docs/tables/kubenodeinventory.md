...
Reference for KubeNodeInventory table in Azure Monitor Logs.
...
- [KubeNodeInventory Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/kubenodeinventory)

...
Reference for ASRv2HealthEvents table in Azure Monitor Logs.
...
- [ASRv2HealthEvents Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/asrv2healthevents)

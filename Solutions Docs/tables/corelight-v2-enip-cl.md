...
**Source:** [KQL validation test schema](https://github.com/Azure/Azure-Sentinel/blob/master/.script/tests/KqlvalidationsTests/CustomTables/Corelight_v2_enip_CL.json)
...
| length_d | real |
| options_s | string |
| sender_context_s | string |
| session_handle_s | string |
| status_s | string |
...
|:-------|:---------|:-------------------|
| [corelight_enip](../parsers/corelight-enip.md) | [Corelight](../solutions/corelight.md) |  |

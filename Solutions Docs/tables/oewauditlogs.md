...
Reference for OEWAuditLogs table in Azure Monitor Logs.
...
- [OEWAuditLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/oewauditlogs)

...
| [files-from-malicious-sender](../content/github-only-files-from-malicious-sender-43625c12-5712-44df-8741-c334746aeccc-a436fe47.md) | `SenderFromAddress == "MaliciousSender@example.com"` |
...
|:-------------------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `SenderFromAddress == "MaliciousSender@example.com"` | - | 1 | - | - | **1** |
...
| Value | Connectors | Content Items | ASIM Parsers | Other Parsers | Total |
|:------|:----------:|:-------------:|:------------:|:-------------:|:-----:|
| `MaliciousSender@example.com` | - | 1 | - | - | **1** |

...
Reference for AHDSDicomAuditLogs table in Azure Monitor Logs.
...
- [AHDSDicomAuditLogs Schema Reference (Azure Monitor)](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/ahdsdicomauditlogs)
